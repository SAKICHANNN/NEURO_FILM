...
| FilmMatch identity-residual sigmoid | BL1/BL2 capacity retained; BL3/BL4 OOD policies closed | Direct BL1 reaches `3.095%` new boundary pixels. AO6-base analytical composition removes all boundary pixels and retains `99.998%` residual energy, but its P95 safety-limited share is `17.996% > 10%`. No visual review or retuning; next test a strict-interior fitted equation. |
