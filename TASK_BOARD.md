...
| Physical image formation | P5M closes full stacking; P5N ready | Full measured-total × legacy double-counts by up to `.22462`. Correct B/G/R→RGB mapping shows a positive residual is only mathematically possible, not proved. Compile/test the simplest finite positive residual next; scanner stays separate. |
