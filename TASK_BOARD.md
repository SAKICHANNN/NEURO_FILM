...
CURRENT 2026-09-20 USER REJECTION / NEW GOAL ACTIVE: User rejected ALL current A/B/C options: "这些option全都差别太小，看起来根本没抓住那个胶片特性。" User deleted the old Goal and authorized a new corrected Goal and continuation. Complete recognizable film appearance is the outcome; paired data is not a universal prerequisite, and the old blocked status is superseded. Root reserves AGENTS.md, this board, docs/planning/FABLE_LAYERED_PIVOT_20260913.json and docs/drpt/AGENT_LOG.md for state correction. Existing Astra high real_reference_adoption_high performs read-only bounded next-experiment adjudication. No A/B/C refit or strength sweep; no CDFE/fixed96 restart.

HISTORICAL USER CORRECTION: Show existing generated results and collect user votes FIRST. Paired before/after data is not a universal prerequisite. Neutral voting page: outputs/fable_real_reference_review_v1/index.html?vote=1 (localhost8771). Four scenes, original/A-simple/B-full/C-tone-only;53images loaded, votes unselected and stored locally. Preserve old model judgments but do not treat them as human preference. No rerender/refit.

CURRENT 2026-09-20 GOAL BLOCKED: Tool confirmed blocked after three consecutive occurrences of missing treatment-level supervision. Need owned/licensed aligned preferred before/after example or approved-source pointer. No completion claim; all previous outputs and stop decisions retained.
...
CURRENT 2026-09-20 OWNERSHIP: Same Astra high real_reference_adoption_high owns src/color_match/research/fable_reference_response.py, configs/fable_real_reference_conditional_v1.json, tests/test_fable_reference_response.py, scripts/run_fable_real_reference_conditional.py and outputs/fable_real_reference_conditional_v1. Baseline runner/config complete and unlocked; preserve its failed outputs. Root owns docs/evidence/bridge and scripts/render_fable_real_reference_review.py plus outputs/fable_real_reference_review_v1 comparison UI. No held/CDFE changes.
...
CURRENT 2026-09-20 ALIGNMENT AUDIT DONE (codex; files unlocked): Fable layered direction and AFTER+N retained; product goal clarified in docs/planning/FABLE_LAYERED_PIVOT_20260913.json. CDFE68 remains a frozen unfinished synthetic diagnostic, not a universal prerequisite or the default next run. Future project work targets a real-reference/multi-source development candidate; method not yet selected/admitted. Old cache-first instructions below are historical and superseded. Evidence docs/evidence/FABLE_GOAL_ALIGNMENT_20260920.json includes medium independent review and exact paused Goal snapshot. Final Goal read returned null after an initial paused snapshot; this audit made no Goal mutations. Research stays user-paused; no automatic goal creation, worker, cache/code/config/assessment change or model promotion.

HISTORICAL SHUTDOWN 2026-09-15: cache9500 stopped, 54/256 donor receipts saved, writer lock released. Recovery command retained in outputs/fable_cdfe68_computation_v1/shutdown_pause_20260915.json only for a specifically resumed CDFE diagnostic. That command is no longer the automatic project next step; the 2026-09-20 correction above controls. Existing single-run protocol and all evidence remain unchanged.
...
CURRENT 2026-09-14: root reserves src/preprocess/fable_raw_eligibility.py and tests/test_fable_raw_eligibility.py. Independent numeric metadata admission checks; existing renderer/lock unchanged. Medium read-only review pending.
...
CURRENT 2026-09-14: root reserves scripts/build_fable_cdfe_history_graph.py and tests/test_fable_cdfe_history_graph.py. Join existing pilot metadata and conservative same-camera/day restrictions; no new acquisition or admission.
...
CURRENT 2026-09-14: root reserves scripts/build_fable_cdfe_exposure_ledger.py for reproducible history/exposure join. Preserve all recorded lineage; unknown history is not fresh. No acquisition, role assignment or training.
...
CURRENT 2026-09-14: root reserves src/preprocess/fable_render_lock.py, tests/test_fable_render_lock.py, configs/fable_cdfe68_render_lock_v1.json. Add separate locked rendering entry preserving prior audit code; verify runtime/files/config before RAW open, test drift rejection. No new RAW/training. Rollback scoped commit.
...
CURRENT 2026-09-14: root RAW engineering reservation src/preprocess/fable_canonical_raw.py, configs/fable_cdfe68_raw_v1.json, tests/test_fable_canonical_raw.py, scripts/audit_fable_cdfe68_raw.py. Plan: explicit metadataWB,adjust_maximum_thr0,no_auto_brightTrue,linear16+explicit sRGB,Q8; fixed2consumedfixtures a0005/a0064 repeat/native-dim checks andmemory-onlyhalf-exposurediagnostic onzero-blackNikon; no newdata/nooptimizer. OfficialLibRaw0.22source inspected, genericoldloader unchanged. Commitafterverification; rollback scopedcommit.
...
CURRENT 2026-09-14: CDFE68-M1 bridge retrieved/validated (result SHA84678d54c6eae5aa72b8e97451b25ea1b7bac21f555aa284184243a6c3806f51). Root+medium conditionally adopt consumed development/fresh68, camera/day conservative blocking, bounded metadata-first acquisition, native-statistics-before-C-resize; no source admission yet. ROI keeps historical pooling perROI/conjunction acrossROIs, percase saturation; medium retracted case×ROI overinterpretation. Root reserves src/eval/fable_canonical_inference.py, tests/test_fable_canonical_inference.py, configs/fable_cdfe68_native_v1.json for native adapter. Plan: preserve128interface -> fullstats/clippedC then area128 -> synthetic order/stats/variable-size tests -> commit; no training/download. Rollback scoped commit.

CURRENT 2026-09-14: development-reuse6Pro request verified live, still thinking at same tab4; no resubmission. Existing576metadata rows inventoried (29modelstrings,8missingdates,no serialvalues), diagnostic only. See docs/evidence/FABLE_DEVELOPMENT_REUSE_BRIDGE_20260914.json. NEXT same-tab completed-result extraction/adoption; no new source/fit.
...
CURRENT 2026-09-14: canonical CNN engineering implementation IN_PROGRESS; root reserves src/models/canonical_photometry.py, src/eval/fable_canonical_inference.py, tests/test_fable_canonical_inference.py, configs/fable_canonical_cnn_v1.json. Existing measure/decoder remain unchanged to preserve historical pins. Plan: fixed CNN -> AFTER-only adapter with explicit target normalization -> synthetic forward/batch/serialization/gradient checks -> scoped commit. No training entry or optimizer run until separately admitted protocol. Rollback: revert scoped commit; retain old evidence. New development-reuse bridge request sent once using verified Latest/6 Pro; WAITING while local engineering proceeds. Terminal source attempt remains closed.
...
CURRENT 2026-09-14:6Pro resultDOMretrieved pairPASS SHA9e091086...;medium adoption allows ONLY pure numerical canonical-statistics module +historicalsmoke, nottraining/download324. Root owns src/eval/fable_canonical_prior.py tests/test_fable_canonical_prior.py scripts/smoke_fable_canonical_prior.py configs/fable_canonical_prior_smoke_v1.json. Agent complete/unlocked.
...
CURRENT 2026-09-14: fresh320AFTER+4identityfeatures and three frozen-model predictions DONE11.74s, no refit. Root owns scripts/prepare_fable_contrast_fresh.py and scripts/render_fable_contrast_visuals.py/logs; medium fable_photometry_adoption owns scripts/assess_fable_paired_contrast.py and its tests. Visual32case render active; assessment not run. Model/config/draws unchanged.
...
ACTIVE:medium fable_photometry_adoption owns ONLY src/eval/fable_photometry_metrics.py and tests/test_fable_photometry_metrics.py. Rootowns heldfeature/assessment runners. Models/draws frozen; no refit.
...
CURRENT IMPLEMENTATION: medium fable_photometry_adoption owns ONLY src/eval/fable_photometry_ridge.py and tests/test_fable_photometry_ridge.py (active). Root owns src/eval/fable_reference_photometry.py,matchingtest,experimentconfig,runner,andboard. 6Pro adopted boundedmechanism; config/draws frozen beforefit. Puretransform/Q8/dequantization/canonicalization4testsPASS. Do not touch agentowned files.

CURRENT 2026-09-13:6Pro photometry reply RETRIEVED oneCopy clipboardchanged21983chars, result/pairVALID. outputs/fable_photometry_science_bridge_v1/result.md; receipt incomplete pendingadoption/rootmodelunverified. Medium agent fable_photometry_adoption active read-only localadoption. Advice32fit+32heldantithetictransforms,576extractions,quantized/dequantizedcanonical128refs,crossedridgeCV,analyticprior/no-refmeanrendercontrols,16pair sign tests; notyetadopted. Next agentresult then implement. No more browserCopy/Send. Rootlight/complexmedium/6Proscience;old96paused.

CURRENT 2026-09-13:6Pro photometry reply STILL LIVE stop1/copy0 at sameURL6aa66718-d104-83ec-927a-9a4a56066e64;oneSend/zeroCopy, browser1tab2 photoScienceTab, markedhandoff. Fit-source feature extraction COMPLETE6x30stats+6x3968VGG, CPU3.209s; nohead/noheldfeatures. outputs/fable_fit_source_features_v1/report.json; docs/evidence/FABLE_FIT_FEATURES_20260913.json. Next sleepthen sameresponseCopyonce whencomplete,validate,mediumadoption. Rootlight/mediumcomplex/6Proscience. No localworker;old96paused.
...
CURRENT 2026-09-13 layered Goal: NLM known-signal controls COMPLETE60 cases (6scenes,2noise families,5methods), report outputs/fable_nlm_controls_v1/report.json; source/config pinned. For correlatednoise edge, relativeMSE Gaussian2=5.6722 vsNLM=.0580/.0429; texture NLM=.5729/.7492, not universal success. No claim real-grain labels obtained. BlueNeg metadata hashes verified; existing8bit lanes cannot support nativegrain. Readiness outputs/fable_layered_pivot_v1/blueneg_metadata_readiness.json. Next execute same72native patches under NLM; resolve oldlocal split before naturalDNG acquisition. Old96 remainsPAUSED69, no localworker ortraining.
...
Current 2026-09-13 cursor69:48FAIL(including5insufficientchange)/19UNCERTAIN/2PASS_CURATOR_ONLY/27remaining. Queue67 harsh teal-orange portraitFAIL;queue68 orange wash portraitFAIL;both actual overview+native seen/ingested,other stages unviewed. Recovery adapter continues successfully;no photo/GPU worker. Web6Pro scientific review of user Fable proposal SUBMITTED ONCE and Pro thinking observed: https://chatgpt.com/c/6aa65406-2f70-83ec-ba65-3e7f337015ae ; outputs/fable_physics_science_bridge_v1 packet.md/request.txt/transport_state.json. No response Copy yet; use visible Copy once then proTab.clipboard.readText(), never DOM response extraction. Current CUA proTab browser1/tab1; reselect by liveinventory if needed. Scientific response not yet retrieved or adopted. Continue fixed96 using recovery adapter while awaiting science via sleep. Main scope after-onlyreference+N, not stock-physics substitution.

Current 2026-09-13 finite96 v3 cursor67:46FAIL(including5insufficientchange)/19UNCERTAIN/2PASS_CURATOR_ONLY/29remaining. P restored. Queue66 all5 sheets actually reviewed, only2/4rich; terminal FAIL_INSUFFICIENT_COMFORTABLE_RICH_CHANGE. Attempt0230 pre-worker relative-path failure retained and explicitly adjudicated by outputs/tst_crossed_photo_review_v3/recovery/attempt0230_adjudication.json. Root46 recovery+frozen tests PASS; root real absolute ingest exit0, cursor67 confirmed. No live worker/training. Use scripts/recover_tst_photo_attempt_0230.py for all subsequent preflight/run/ingest/audit; original v3 entry rejects retained0230 by design. Adapter SHA2918a05893019fa47e5fede894f3fe1c295e2d370d974be7ee836e9d0115374d; do not edit afterreceipt. Frozen protocol unchanged. Next fixed candidate portrait. User Fable advice under scientific review, not adopted.
Model policy: root medium ordinary work; high subagents only substantial independent/complex work; web6Pro via bridge deep science. No predetermined LUT/generative architecture.

Current 2026-09-13 recovery IN_PROGRESS: P storage restored; frozen v3 preflight matched cursor66 pending lowkey review. Root actually viewed lowkey sheet and verified all5 artifact hashes. Relative ingest was rejected before worker as attempt0230 (accounting SHA e79947212b32f65bac0476a460e6fd4a812e34b9c68e125ce0fad37ceb8e97c7); original failure and cost retained, no new review/terminal. High agent owns scripts/recover_tst_photo_attempt_0230.py and matching test; root owns this board and handoff. No live photo/GPU worker.
User model policy supersedes earlier: root medium handles ordinary decisions/implementation; raise delegation threshold, use high only for substantial independent review/complex work; web6Pro bridge remains scientific research. Architecture stays open.
Recovery plan: implement narrowly pinned adapter + rejection tests -> root review and validation -> explicit immutable adjudication -> absolute-path ingest -> continue unchanged fixed96; final audit must disclose0230. Before launch rollback is stop using adapter; after launch preserve all receipts and ledger, never erase failure or rewind. No model/training admission.
...
Current finite96 v3 cursor22:16FAIL(including1insufficientchange)/5UNCERTAIN/1PASS_CURATOR_ONLY/74remaining. Six new sheets actually viewed; weak pink treatment uncertain, cyan baby and magenta face FAIL. Evidence TST100K_CROSSED_DONOR96_FIRST_TWENTYTWO_20260909.json. No liveworker/training. Continue fixed v3 --run/view/ingest; strength1, no replacements.
...
Current finite96 v3 cursor11:8FAIL/3UNCERTAIN/85remaining. Three new portrait sheets actuallyviewed; unevenresidualcolor,olivecastFAIL,cyanfaceUNCERTAIN. Evidence TST100K_CROSSED_DONOR96_FIRST_ELEVEN_20260909.json. No liveworker/training. Continuev3 --run then actualview/ingest; final96audit+viabilitydecision only.
...
Current staged v2 cursor12;24completed/3432remaining. Effective1curatorPASS/21FAIL/2UNCERTAIN including c174 override. Thisturn5portrait sheets actuallyviewed:4FAIL/1UNCERTAIN. Evidence TST100K_CROSSED_STAGED_FIRST_TWELVE_20260909.json. Medium reviewing mainline necessity of full3456 before learned diagnostic; no policy change yet. No live renderer; frozenqueue continues --run if no newer adjudication.

Current staged v2 cursor7;19completed/3437remaining. Effective1curatorPASS/17FAIL/1UNCERTAIN disputed. c174 originalPASS preserved but independent medium uncertainty accepted as additive admission exclusion; see TST100K_CROSSED_C174_ADJUDICATION_20260909.json. Medium mapping final-admission override integration, no codewriter. Newtwo portraitFAIL. No live renderer; next v2 --run. Evidence TST100K_CROSSED_STAGED_FIRST_SEVEN_20260909.json.
...
2026-09-09 medium staged-photo READY_STOP_EDITING. Locks RELEASED: scripts/prepare_tst_crossed_photo_review_v2.py; configs/tst_crossed_photo_review_v2.json; tests/test_tst_crossed_photo_review_v2.py; outputs/tst_crossed_photo_review_v2/.22synthetic tests/Ruff PASS; preflight READY_TO_RENDER with3456keys/import12/3444remaining. Zero real new render. Current-stage hash checks; linear final historical audit required; no training admission. Root review before launch.
...
2026-09-09 medium READY_STOP_EDITING S2 implementation. Locks released to root review: scripts/run_tst_crossed_operators.py; configs/tst_crossed_operators_v1.json; tests/test_tst_crossed_operators.py; outputs/tst_crossed_operators_v1/. 10 synthetic tests PASS; metadata preflight READY;3494 frozen candidates (2754fit/188monitor/552constructed). Zero real P/R decode/fits. Root owns evidence/docs and launch review.

2026-09-09 medium READY_STOP_EDITING S0/S1 curation:12synthetic tests/Ruff PASS; header/source preflights WAIT_COMPLETED_RECEIPT; zero actualphoto headers/decodes. Create-time-bound wholeprocess-tree CPU/RSS supervision, cumulative attempt ledger, ICC/native16/JPEG, strict allowlists/resume and compact-only cache implemented. Locks RELEASED: scripts/prepare_tst_crossed_corpus.py; configs/tst_crossed_curation_v1.json; tests/test_tst_crossed_curation.py; outputs/tst_crossed_curation_v1/. Evidence outputs/tst_crossed_curation_v1/verification.json. Root review thenS0 only after completed download; near-duplicate/probe admission and training remain pending.

Current 2026-09-09 correspondence feasibility COMPLETE: all24 bounded BVLS channels pass original-objective KKT;8oldfitpairs only;20.90625CPU/18.359wall/310099968peakRSS. Root independent8pin/58artifact checks,40nativeTIFFx4096scipyinterpolation exact0. No learned model or photographic admission. See docs/evidence/TST100K_CORRESPONDENCE_FEASIBILITY_20260909.json. Metadata owner allocation4742rows12331paths,allcrosssplitX/Poverlap0;real128groups reserved unopened. Medium prepares staged public HEAD metadata, noGET/cloud/training. Earlier READY/RUNNING entries below historical.

2026-09-09 medium READY / LOCKS RELEASED: correspondence operator core, probe, config, tests and implementation_checks complete. 5 synthetic tests PASS; Ruff PASS; hash-bound preflight READY; zero real pairs fit. STOP_EDITING; root reviews before one bounded 8-pair probe.

Current scientific response RETRIEVED_VALID: Latest/6Pro one send/oneCopy,25334chars, resultSHA0360502830beaca89d44a631b4723641404052d89e9a5fa2c011f0e7b9ceb5ed, packet/pairPASS. See outputs/ai_paired_teacher_generalization_science_bridge_v1/result.md. Proposed correspondence-derived bounded operators/content-crossed afteronly training is NOT yet locally adopted; medium reviewing scope,split,human-assessment assumptions,and data/resource feasibility. No new acquisition/training/cloud start. Earlier RUNNING entry below historical.

Current scientific bridge RUNNING: one verified Latest/6Pro send, browser1/tab11 https://chatgpt.com/c/6aa041cb-e9dc-83ec-9304-c6f86d51f951 ; Stop1/Copy0 at latest timed observation. Packet/context/transport evidence outputs/ai_paired_teacher_generalization_science_bridge_v1/. Next observation10minutes after browser_evidence.last_observed_utc; all waits sleep, no resend/DOManswer extraction. Local metadata inventory leaves19889mapped unambiguous unconsumed-owner rows,nottrainingadmission; see outputs/tst_reference_scale_inventory_v1/inventory.json. No live training/GCP resources started.
...
2026-09-09 medium READY_STOP_EDITING: tst_reference_distillation core/entry/config/tests locks RELEASED;7synthetic tests/Ruff PASS, allphase preflights consistent, fit_features READY. 208required native inputs and59pair admission pinned. No real features/training.86fit features->5000T/S/S0/D updates->X/R-only96TIFFlock->32privilegeddev features->score;shared1789.84375CPU/1787.61wall,2threads2GiB. Root review before execution;old frozen files unchanged.

2026-09-09 medium COMPLETE_STOP_EDITING: prepare_tst_reference_pairs script/config/tests and outputs/tst_reference_pairs_v1 locks RELEASED. 59 pairs decoded, 219 endpoints audited; 0 decode/dimension failures or cross-split exact encoded/canonical collisions; all integer shifts zero. 16 diagnostic boards actually reviewed: no obvious geometry mismatch, aesthetic failures unchanged. 3 tests/Ruff PASS; CPU10.15625s, remaining shared study1789.84375CPU/1787.61wall; no features/training. Root owns 43 training visual reviews and merged admission.
...
2026-09-08 medium READY_STOP_EDITING:4tst_reference_kernel_recovery files complete,5tests/Ruff/preflightPASS; originalH/rhs/loss/kernel/rtol/maxiter unchanged,12newzero-init channels+3reusedfreegrid;3575.328125CPU/3573.484wallremaining. All4locks RELEASED; no realrecoveryrun. Original4files/failedexperiment unchanged.

2026-09-08 medium READY_STOP_EDITING: newtst_reference_kernel core/entry/config/tests complete;4synthetic checks/Ruff PASS;preflightREADY43fit/16consumeddevelopment. No realfit/featureforward/download. All4filelocks RELEASED,root reviewsbeforeone3600CPU/wall2thread4GiBrun. Old frozen files untouched.
...
2026-09-08 medium DONE_STOP_EDITING: frozen fit replay20pairs40targets COMPLETE; CPU2.703125s, remaining578.71875s; Cswitch1/20, B2/20; no fitting/tuning. scripts/run_tst_reference_fit_replay.py and outputs/tst_reference_fit_replay_v1 locks RELEASED. Evidence TST100K_REFERENCE_FIT_REPLAY_20260908.json.
...
Root acquisition/review DONE; script/config locks released. Root owns bridge evidence and current handoff; medium read-only offline feature preflight.
...
Current scoped tasks: course-correction, continuous-LUT diagnostic and bounded original-link recovery DONE. Latest user preference: prefer nontraditional learning beyond simple LUT; LUT superiority has not been established. Medium local-asset/metadata adjudication completed: no ready spatial checkpoint or evidenced cross-content same-processing groups in the two checked manifests. High is temporarily disabled. Latest role policy: medium owns codebase adjudication; bridge web 6 Pro owns deep science/algorithms/literature/computation. Bridge Doctor/consent READY, Latest/Pro 5 of 5 visibly verified, one packet sent; scientific result retrieved with explicit user-authorized answer-only DOM exception under outputs/ai_nonlut_science_bridge_v1; result/pair valid, medium admits only bounded CPU compatibility preflight of existing SA-LUT assets. Old Chrome blocker superseded. No new LUT tuning/projection follows automatically. Long-term Goal ACTIVE, not achieved. Foreign dirty files remain excluded.

Current photographic development: fixed reference 18 / nine consumed inputs COMPLETE_NOT_PROMOTED. Eight new pretrained forwards plus one exact cache completed in 86.53s, peak allocation 7.67 GiB; all 36 output hashes/dimensions verified. Root and Astra medium reviewed all nine comparison sheets, with full-size inspection on all nine: fruit/sunflower colour collapse and widespread grey/cyan rendering prevent a general photographic claim. Evidence: docs/evidence/AI_SINGLE_REFERENCE_BATCH_DEVELOPMENT_20260908.json. Implementation commit 2fc77b6af; 49 related tests and Ruff pass. The matched NCC follow-up is completed below. Latest user override temporarily forbids Astra high; all new delegation uses medium. CPU adaptation preflight COMPLETE: two 64px synthetic forwards, context/LUT/output exact dense/chunk parity. Evidence docs/evidence/SA_LUT_CPU_ADAPTATION_PREFLIGHT_20260908.json. Next original 512 protocol and photo comparison; no candidate promotion. First three SA-LUT photos COMPLETE_NOT_PROMOTED: all visibly changed/displayable after root+medium review; 3 CPU forwards/51.219s/2.816GB peak, 27 artifacts verified. Next freeze model/ref/settings and complete remaining six consumed sources3..8 with G0. Evidence docs/evidence/SA_LUT_THREE_PHOTO_REVIEW_20260908.json. Remaining six COMPLETE: 6 CPU forwards/87.75s/2.823GB peak,54 artifacts verified. All nine visibly changed/displayable; spatial superiority unproved. Next fixed0/1/2 reference02-vs18 ablation per medium, no tuning. Evidence docs/evidence/SA_LUT_NINE_PHOTO_REVIEW_20260908.json. Root owns reference02 response wrapper/config/evidence; medium read-only review. Reference02 run complete:3 forwards/44.203s/2.823GB,exit0; medium visual review finds sensitivity but only partial directional following. Root verified all27 reference02 artifacts and inspected three full-size outputs. Evidence docs/evidence/SA_LUT_REFERENCE_RESPONSE_20260908.json. Uniform strength preview complete:all27 hash/formula checked; root all9 and medium3/5/8 prefer provisional0.65. Gallery outputs/salut_strength_preview_v1/index.html. No inference active.

G1 COMPLETE:9 fits/27.015s/450MB;54 artifacts verified. Medium blinded all9: G0 leads7 including weak preferences, fruit all tied, sunflower G0/G1 tied. Stop further SA-LUT spatial tuning; no promotion. Root owns completed scripts/run_salut_g1_projection.py and evidence. No live process. Next medium scope: inspect first64 existing FiveK development sources for two suitable native-size portraits, plus rawpixls15 text card; at most3 fixed-reference G0 development forwards if assets qualify. Queue subsequently frozen/executed as current native-content entry below.
...
2026-09-08 medium READY_STOP_EDITING: Check8 four-phase entry/config frozen;3tests/Ruff PASS,prepare preflight READY,predict WAIT_PREPARE; no acquisition/run. Frozen fit files untouched. Root owns source-only crop and photographic review.
Locks released: scripts/run_tst_reference_check.py; configs/tst_reference_check_v1.json; tests/test_tst_reference_check.py.
...
| 1ew | U5.R2BZ0 | Test FedPAIE-style proxy-exploitation control on bounded explicit operators | complete: large mitigation, positive-gain gate fails | proxy-only true gain -61.44%; gap+L1 -5.16% after 94.04% excess reduction; trusted fixed control +34.55%. Next test hard trusted support, not coefficient rescue |
| 1ex | U5.R2BZ1 | Test hard trusted-support selection against K=1 | complete: K=1 retained | trusted oracle adds only +2.51 points; proxy-only +33.44% and gap+L1 +3.87% versus fixed +34.55%. Close router/scorer family |
