...
| 1q12 | SF2.5R | PROV digitised-negative/film-stock-register source reconnaissance | in progress: metadata-only contract frozen | VPRS 17684 has a large digitised collection and VPRS 17690 is described as its film-stock register; verify whether register contents are machine-accessible, without image requests |
...
| 1al | U5.R2B | Freeze and evaluate the strongest eligible global operator frontier | in progress: contract frozen | seven fixed same-renderer policies, 9 gold + 32 stress, automatic salience/non-basic/clipping screen then survivor visual veto; no fitting/routing |
