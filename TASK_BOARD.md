...
| Physical image formation | P0/P1/P4B pass; P3C/P4A/P4C1 closed; P4C2 ready | Naive LOD fails variance `.0875-1.8860` and B&W mean `.1743`; next development-only moment correction, with area-resolved fallback. Generic only; no display-RGB grain or calibration |
