...
| Measured scanner chain | P6H source pass; P6I equation family passes; P6J ready | Thirteen official scanner/software pipelines have measured same-target support but no device repeats across manufactured target sets. Per-device leave-one-slide-out common-power + positive 3x3 reaches median/p95 `7.303/24.133` Delta E76 with zero clipping. Compile an exact research-only inverse characterization bundle; independent-target/calibrated/product claims remain closed. |
