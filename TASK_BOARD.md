...
| 1dp | U5.R2AJ0C0 | Calibrate/conform the synthetic Hald structural evaluator without primary access | ready: frozen contract / implementation | analytic identity, N=17/33/144/256 reader semantics, RGB16 conformance, Jacobian/gradient/basic/strength/novelty controls and thresholds are fixed; archive and primary reads must be zero |
| 1dq | U5.R2AJ0C1 | Run the frozen per-Hald structural frontier | blocked on exact C0 pass and separate C1 contract | evaluate 194 primaries at native N=144/256 with per-candidate veto, strength collapse and cap-12 selection; no photograph/aesthetic review |
