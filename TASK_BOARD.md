...
| 1dq | U5.R2AJ0C0B | Run corrected controls-only Hald evaluator | ready: frozen v2 / implementation | legal N=4/36/144/256 parser controls, strict evidence, exact negatives and post-strength warm/cool novelty; archive and primary reads must be zero |
| 1dr | U5.R2AJ0C1 | Run the frozen per-Hald structural frontier | blocked on exact C0B pass and separate C1 contract | evaluate 194 primaries at native N=144/256 with per-candidate veto and fully frozen cap-12 selection; no photograph/aesthetic review |
