...
| 1da | U5.R2AD1 | Test spatial DIR on/off with the retained Ektar100 fixed-e0 control | in progress: contract frozen | exact runtime/defaults/gold inputs, nine RF2.C0 hashes, matched local-contrast nuisance and style/artifact gates frozen; restore isolated runtime then implement/run |
