...
| 1av | U5.R2G0 | Refit immutable ML LUT controls into a bounded explicit operator family | in progress: contract frozen | 81 synthetic-grid fits; monotone 9-knot curves + positive row-stochastic matrix; no photograph fitting/training/stock claim |
