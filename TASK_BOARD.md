...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A/U1.6B pass; U1.6 in progress | safe-Lab experimental tiling is byte-exact; effects, CLI integration, streaming/total memory, HDR/HEIF/wide-gamut and calibrated mapping remain pending |
