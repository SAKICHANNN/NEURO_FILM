...
| 1dz | U5.R2AN0 | Recover the existing positive-film operator from paired observations | ready: frozen synthetic known-truth contract | implement deterministic float64 fitter; compare held-group two-matrix candidate with one-matrix ablation; no real-film claim |
