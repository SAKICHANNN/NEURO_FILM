...
| 12 | U5.R1A/U4.1/U4.2 | Maintain chromatic ontology/look rubric and stress evidence as CT evaluation support | U5.R1A complete; R1B design ready | strict schema/3+3 aggregation/leakage/power tooling passes; current evidence remains A0-only and participants later require approval |
