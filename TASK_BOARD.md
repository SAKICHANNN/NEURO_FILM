...
| 1dl | U5.R2AI1 | Confirm the frozen composition on independent digital-photo/OOD inputs | ready: freeze contract before render | bind exact 17-row decision; unchanged operator/order/s0.50/margin and preregistered repeat + clipping/OOD + blind/full-res severe gates; no retuning |
