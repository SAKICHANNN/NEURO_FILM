...
| Triangular logit transport | BN4 development and BN5 disjoint confirmation pass; BN6 visual ready | BN5 is repeat-exact with zero leakage, 10.09% adaptive gain, 68.75% wins, improved P95/worst tails, .9467 style ratio and zero structural failures. Freeze unchanged; compare adaptive versus global at full resolution under fixed AO6 before any product claim. |
