...
| Complete fixed-bank Oracle | BH0 router closed; BH1S source pass; BH1 ready | BH0 selects fixed B0 as the best global arm but fails the frozen selector/router gates. BH1S now supplies 12 independent CC0 RAW sources from 12 makes with repeat-exact decoding, zero source-pool leakage and no confirmed severe source artifact. BH1 may compare only fixed B0 and fixed AO6 t15/c35, without fitting or retuning. |
