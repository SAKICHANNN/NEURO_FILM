...
| Physical image formation | P2P source pass; P2Q ready | The measured-MTF route remains closed. An exact first-party Kodak 250D graph trace passes source/axis/ink/monotonicity/visual gates in two identical audits; next compile the simplest bounded monotone characteristic prior without mapping digital RGB to layer exposure. |
