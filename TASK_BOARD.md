...
| 1do | U5.R2AJ0B2 | Confirm exact lane-aware Hald decode profiles | ready: separately frozen v2 correction | two new processes must reproduce SHA, 295 exact profiles, 194 primary paths and canonical evidence; no conversion, photograph render or aesthetic inspection |
