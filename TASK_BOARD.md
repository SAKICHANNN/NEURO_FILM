...
| 1di | U5.R2AH1D | Freeze and test one group-invariant O0-parameter predictor | contract required | local GPU allowed; operator recovery, identity, strength, content/nuisance and O0 structural gates are conjunctive |
