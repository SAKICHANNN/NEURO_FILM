...
| 1dy | U5.R2AM1 | Test bounded SO(3)-coordinate curve capacity | ready: frozen contract / implementation | config `2f081922...7e59`; 21-raw/18-effective candidate vs RGB curves, positive matrix+curves and K3 on two external-family project targets; exact structure/inverse/repeat gates, zero photos/data |
