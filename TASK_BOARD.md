...
| Controlled Velvia display-chain residual | BR0 chroma closed; BR1 neutral tone passes development | BR0's 2x2 chroma fit regresses global chroma by 6.48%. BR1's six-patch leave-one-out monotone tone residual is repeat-exact, reaches `2.215` mean / `5.524` max Delta L-star and improves 36.96% over gamma. Freeze one photographic stress; no sensitometry, stock-response or product claim. |
