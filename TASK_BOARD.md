...
| 1cd | U5.R2S1C | Confirm fixed query KDE .12 on untouched synthetic palettes | ready: confirmation contract frozen | seed 27012 now allowed once; all accuracy/retention/control/structure/permutation/repeat gates must pass, no bandwidth/model rescue |
