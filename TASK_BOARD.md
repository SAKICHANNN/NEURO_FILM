...
| 1ay | U5.R2H0A | Velvia 50 datasheet spectral witness numerical identifiability pilot | in progress: contract frozen | fixed status-density approximation, graph axes, 729-colour grid and metamer/effect gates; no visual tuning, real-film fitting, calibration or stock-response claim |
