...
| Controlled Velvia simulation residual | BR0 closed without capacity rescue | Exact KCI publication plots provide one controlled 24-patch real Velvia 50 versus digital Velvia/Vivid observation. Six-fold neutral-corrected 2x2 chroma fitting regresses global chroma by 6.48% (`11.9861` vs `11.2568` RMSE) and reaches `18.162` worst-fold RMSE. Retain as negative evidence; no nonlinear fitting or photo transfer. |
