...
| 1ea | U5.R2AN1 | Test robust recovery with noisy/corrupted chart pairs | ready: frozen confirmatory perturbations | implement exact runner for robust two-matrix versus linear and one-matrix controls |
