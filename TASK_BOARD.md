...
| Triangular logit transport | BN4/BN5 confirmed; BN6 visual pass; incumbent comparison next | BN6 is repeat-exact and severe-clean; adaptive beats its global counterpart in 2/3 rounds, `23/36` choices and eight source majorities. Retain only as a research Look Approximation challenger and compare unchanged adaptive output directly against AO6 before integration. |
