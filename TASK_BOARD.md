...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A-D numerical passes | freeze ordered safe-Lab/effect/encode integration or a truthful grain-context child; physical halation, streaming/total memory, HDR/HEIF/wide-gamut and calibrated mapping remain pending |
