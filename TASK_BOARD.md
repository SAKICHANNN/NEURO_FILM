...
| Physical image formation | P2U shared-template tail closed; P3Q ready | The shared VISION3 shape wins 8/9 LOSO rows and improves median RMSE 37.32%, but regresses P95 by 12.62%; no average-shape rescue. Next test a distinct energy-bounded base-return halation geometry after a primary-source gate. |
