...
| 1aq | U5.R2E0 | Build a clean-room density-domain explicit look primitive | in progress: contract frozen | linear RGB -> negative density/transmission -> print density/reflectance; five descriptive witnesses; property/diversity gates; no external teacher or stock claim |
