...
| 1di | U5.R2AH1D | Freeze and test one group-invariant O0-parameter predictor | contract frozen / implementation ready | <=150K hierarchical Deep Sets, 64 train/16 unseen directions, crossed groups and fixed 5K local-GPU run; all recovery/shortcut/identity/structure gates conjunctive |
