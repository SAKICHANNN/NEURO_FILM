...
| 1dc | U5.R2AE1 | Source-bound synthetic operator-bank structural diversity audit | in progress: contract frozen | eight exact chains; duplicate/strength negative controls; two-run replay, folding/range and within-family matched-basic diversity gates frozen before metrics |
