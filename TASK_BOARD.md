...
| Physical image formation | P5H visible-value contract ready | P5G is severe-clean but weak. P5H now requires exact encoded/edge concentration gates plus three unlabeled 9-pair blind rounds at 6/9 each; ties count against P5F. Failure keeps simpler P5C. |
