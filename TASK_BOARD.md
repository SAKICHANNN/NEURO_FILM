...
| Physical image formation | P5F synthetic pass; P5G contract ready | P5G now freezes unchanged P5C versus P5C+P5F on the 18-image/nine-make CC0 cohort, with exact combined-halo partitions, automatic severe gates, nine overviews and one-to-one worst-difference crops. |
