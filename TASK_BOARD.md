...
*Active parent: `ULT > RF stock-first real-film mainline` | SF1.3B and current conditioned-SCIS are closed; LSM1 remains ineligible; U1.4C2/U1.5B are closed without overclaim; next selection returns to an independent explicit U1 product/format gap; FSA/OWI remains sealed auxiliary | Integration owner: repository owner or explicitly assigned root agent*
