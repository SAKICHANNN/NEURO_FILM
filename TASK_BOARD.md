...
| Physical image formation | P5K reference pass; direct 4000-dpi closed; P5L ready | Positive 16000-dpi kernels match the analytic measured interval to `.00794`, preserve constants and have no ringing. Naive 4000-dpi compilation errs by `.05550`; next compare reference-render/downsample with bounded positive LOD compilers, not a direct product shortcut. |
