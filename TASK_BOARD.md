...
| 1an | U5.R2D | Audit statistics-to-explicit-LUT ML route without stock shortcuts | ready: freeze contract | StatLUT image branch only; synthetic known operators, shuffle invariance vs palette/content dependence, no generative text or closed stock data |
