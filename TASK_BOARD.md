...
| Measured scanner chain | P6F/P6G RGB routes closed; P6H data feasibility ready | Measured spectra fail absolute transfer gates. On four real scanner/software pipelines, a no-clip safe 3x3 improves median 44.71% but p90 `.12523` fails the frozen `.12` gate; the older clipped affine relies on negative coefficients and 119 out-of-range patches. Seek independent-target/repeat-scan connectivity, not more RGB capacity. |
