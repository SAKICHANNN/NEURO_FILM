...
| 1bc | U5.R2H0C3 | External measured-spectrum replication | contract frozen; implement/run next | USGS query-only, CAVE bank fixed at T=1; sample-group bootstrap and chapter controls preregistered before target rendering |
