...
| 1bq | U5.R2L1 | Replay the Oracle with a full-frame inference-time hard preflight | ready: contract frozen | exact density-cyan s0.65 trial, full-frame endpoint metric, hard s0.50 fallback; require 41/41 assignment and byte replay or close without threshold rescue |
