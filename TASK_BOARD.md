...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A/U1.6B/U1.6C pass; U1.6D frozen/ready | implement exact sparse-event dust tiling; physical/grain effects, integration, streaming/total memory, HDR/HEIF/wide-gamut and calibrated mapping remain pending |
