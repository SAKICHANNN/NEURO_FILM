...
| 1q7 | SF2.0C0 | NASA/JSC cross-mission exact-code roll-connectivity census | frozen/ready | six metadata requests max; mission×stock×roll aggregates only; no photo pages/pixels/fitting/training/LSM |
