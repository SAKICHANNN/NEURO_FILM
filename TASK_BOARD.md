...
| 1f | RF2.S0 | Gold archive-display matrix transplant falsification | ready, P0 | fit all-roll fixed matrix; test only as Look Approximation on existing digital gold/stress set against matched simple controls |
