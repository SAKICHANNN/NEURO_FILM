...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A frozen/ready after float, PNG/TIFF16, B&W and U1.5A passes | implement finite-support tile primitive first; global-state operators, actual HDR/HEIF/wide-gamut and calibrated scene-to-display remain pending |
