...
| 1cj | U5.R2U1D | Compare clean-room HCC pseudo-pairs using the bounded O0 flow | preregistered; pending repeated S4 | new seeds; correct/random/pooled/shuffled coupling controls; hidden operator and A/B stability mandatory, pair fit non-binding |
