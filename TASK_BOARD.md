...
| 1au | U5.R2F2 | Test data-independent bounded projection of predicted explicit LUTs | ready: freeze contract | reuse immutable F1 LUTs, no inference/training; preregister node projection + identity contraction, monotonicity/Jacobian audit and unchanged frontier gates |
