...
| 1cj | U5.R2U1D | Compare clean-room HCC pseudo-pairs using the bounded O0 flow | ready: repeated eligible S4 branch | isolated HCC/pair-fit/runner passes targeted tests; new seeds and correct/random/pooled/shuffled controls remain untouched; constructed pairs are never observed truth |
