...
| 1x | U1.6G4F | Audit explicit new-operator product value/safety | contract design ready | fresh confirmatory cases; legacy drift reported, not erased; no integration without separate gates |
