...
| 1bs | U6.2A | Audit clean-room Boolean/Poisson physical-inspired grain representation | frozen; implementation ready | fixed radii/.1-.9 flat fields/zoom4; require mean, midtone-variance, radius-correlation and exact repeat/partition/replay; no images/calibration/integration |
