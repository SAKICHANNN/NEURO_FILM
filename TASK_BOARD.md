...
| Measured scanner chain | P6J research bundle pass; calibrated route data-blocked | Thirteen identity-bound inverse operators compile and replay exactly; full-support median/p95 is `7.019/23.375` Delta E76 with no clipping. No scanner repeats across manufactured target sets, so same-target capacity work closes. Resume distinct film-image-formation/stock-look algorithms pending independent-target data. |
