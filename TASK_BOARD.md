...
| 1ar | U5.R2E1 | Evaluate bounded density witnesses on frozen gold/stress frontier | in progress: contract frozen | 5 witnesses x 4 strengths; unchanged R2B screen; one strength/witness and max-three shortlist; ID11/full-res severe veto; no production/stock claim |
...
| 1at | U5.R2F1 | Run bounded external CanonCGT E2E reference-bank safety pilot | conditional ready after E1 | freeze rights/hashes/references first; no training; audit two LUTs, clamp, sensitivity, gold veto and style/non-basic value |
