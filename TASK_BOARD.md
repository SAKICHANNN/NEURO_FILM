...
| FilmMatch identity-residual sigmoid | BL8 fresh preference closed; AO6 retained | BL5 remains boundary-clean and materially non-basic on 17 fresh CC0 photos (`8.323` median residual DeltaE76; `16/17` above 3.0), but wins `0/3` blind rounds, `16/51` choices and only `5/17` source majorities. This is a real operator-direction/preference failure, not a basic-adjustment or capacity failure. No strength/capacity rescue or promotion. |
