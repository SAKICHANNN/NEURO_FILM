...
| 1ao | U5.R2D1 | Benchmark bounded statistics-conditioned operators on known synthetic truth | in progress: contract frozen | 384 generated matrix/tone/combined operators; group splits, palette shift, mean/PCA-ridge/PCA-KNN and seven representations; no stock data or authenticity claim |
