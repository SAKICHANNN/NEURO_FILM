...
| 1at | U5.R2F1 | Run bounded external CanonCGT E2E reference-condition safety pilot | ready: freeze contract/reference manifest | no training; references are immutable A0 conditions, never stock truth; audit two LUTs, clamp, sensitivity, gold veto and style/non-basic value |
