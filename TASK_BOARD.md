...
| 1cs | U5.R2Z1 | Freeze asymmetric query/operator applicability audit for the ClassNeg Oracle gap | ready: contract not frozen | development-only simplest hard reranker vs shared/random/shuffled/failed photometric selectors; no confirmatory read, router, visual, final-628 or film claim before freeze |
