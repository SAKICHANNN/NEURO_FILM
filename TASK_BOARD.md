...
| Physical image formation | P0/P1 references and P4B compiler pass; P3C/P4A closed; P4C ready | P4B confirmatory ACF/NPS max `.05785/.19378`, exact repeat/partition in density/transmittance; next physical-scale LOD and severe-artifact evaluation. Generic only; no display-RGB grain or calibration |
