...
| 1dr | U5.R2AJ0C1 | Run the frozen per-Hald structural frontier | ready: frozen contract / implementation | exact 194-member RGB8 universe, native N=144/256 streaming, unchanged per-candidate vetoes, strongest safe component representatives and residual max-min cap-12; no photographs |
