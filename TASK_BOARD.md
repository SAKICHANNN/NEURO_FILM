...
| 1ei | U5.R2AO6 | Compose bounded combined-film residual with vivid B0 density path | ready | small predeclared residual bank; hard rails; compare against both parents; no model refit |
