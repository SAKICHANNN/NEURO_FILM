...
| 1av | U5.R2G0 | Refit immutable ML LUT controls into a bounded explicit operator family | next ready: freeze contract | synthetic colour-grid distillation only; no real-film fitting/training/stock claim; must beat uniform contraction without severe failure |
