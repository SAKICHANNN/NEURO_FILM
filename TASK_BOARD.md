...
| Physical image formation | P7F retains one generic 4000-dpi challenger; P7G fixed-resolution streaming exact, cross-resolution equivalence closed; P8A next | Neutral-gauged physical output is severe-clean and narrowly wins 2/3 blind rounds, while 28 tile/order cases are exact. Independent lower-resolution recomputation is not equivalent, chiefly because AO6/source-context and resize order do not commute. Compile a fixed-reference bundle only; no calibration or production promotion. |
