...
| Physical image formation | U6.P0 ready | typed exposure/density/transmittance/scan domains and reference simulator first; current display proxies, AO6/AO9 and procedural effects are not calibrated physics |
