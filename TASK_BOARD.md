...
| 1az | U5.R2H2 | Audit exact hard-1NN routed outputs visually and at full resolution | in progress: contract frozen | exact 37 predictions + four density fallbacks; all 41 severe inspection and all 10 interventions in three blind rounds; no model change |
