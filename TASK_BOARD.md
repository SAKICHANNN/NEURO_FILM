...
| Physical image formation | P5Q measured-MTF photo route closed; P2P ready | The minimax envelope keeps edges/texture but fails flat-region, isolated-excursion and local uncertainty gates. No visual rescue. Next trace first-party Kodak 250D characteristic curves as a distinct exposure/development source leaf. |
