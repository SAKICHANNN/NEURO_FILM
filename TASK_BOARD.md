...
| Physical image formation | P5G severe-clean but weak; P5H next | P5C+P5F is exact and severe-clean on 18 CC0 images, but max/P95 changes are only `.002843/.000157` and fixed visual review finds a weak effect. Require cost-and-visible-value evidence or keep simpler P5C. |
