...
| 1dl | U5.R2AI1 | Confirm the frozen composition on independent digital-photo/OOD inputs | contract frozen / implementation next | exact 17 rows; fixed parents+candidate; 80% retention/125% envelope/.25 parent gain/10 row/6 make gates, exact repeat, 2/3 blind wins and 0/17 severe; no retuning |
