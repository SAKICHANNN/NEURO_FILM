...
| Physical image formation | P5F cross-layer adjacency contract ready | P3L/P3M backing-return topology is closed. P5F now tests a distinct zero-sum interimage/DIR-inspired developed-density operator; it must preserve constants and the neutral axis, remain analytically bounded and exact under row partitions before any photographic audit. |
