...
| 1af | U1.4C0/U1.4C1 | Make the colour operator working-space aware | C1A math pass; shared kernel next | Lab primitives pass without widening legacy gate; exact legacy style parity precedes six-style Rec.2020 colour-only path |
