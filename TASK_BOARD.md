...
| Triangular logit transport | BN4 development pass; BN5 confirmation ready | Repeat-exact source-adaptive 14-parameter explicit transport improves global mean by 8.87-10.73% across AY0/AY3/AY6, with all value, tail, style, dose, inverse and structural gates passing. Freeze unchanged and run disjoint AY2 confirmation; no film or product claim. |
