...
| Physical image formation | P0/P1/P4B/P4C2/P4C3/P5C/P5D/P6A/P6B pass; P3C/P4A/P4C1/P5B closed; P6C ready | Scanner context makes 31/127/257-row execution byte-exact with 37/61-row halos and wrong-context rejection. Real repeat-scan calibration data remain absent. Next 24MP float32 compiler/performance. |
