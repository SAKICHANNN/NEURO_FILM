...
| 1cm | U5.R2W1D | Test fixed reference-look retrieval/regression across generated content | ready: repeated U1 decision available | fixed descriptor/bank, hard direction plus continuous-strength retrieval, single/multi ridge and activation/partition-gated runner pass twelve targeted / 946 full tests; exact tiny repeat covers single/four, seen/unseen, paired upper bound and `53/55/56`; formal seeds untouched |
