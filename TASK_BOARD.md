...
| 1bb | U5.R2H0C2 | Group-held-out simple measured-spectrum canonicalizer comparison | active: contract frozen | leave-one-scene-out hard Top-1, fixed distance frontier and smooth OOD fallback; known witness target only |
