...
| Physical image formation | P2T stock bank closed; P2U ready | Exact 50D/250D/500T traces yield no two-channel material pair after affine-gauge normalization; retain K=1/shared source shape. Next compile a leave-one-stock-out shared template and uncertainty envelope, still without RGB or photograph mapping. |
