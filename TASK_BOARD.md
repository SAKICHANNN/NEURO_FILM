...
| 1cn | U5.R2W2F0 | Test paired/global explainability of local FilmSet recipes | ready: paired-only W1 branch + source preflight | freeze bounded aligned-pair budget before pixels; compare identity/basic/shared/per-pair O0 and spatial residual. W2F1 output-only remains closed; no final-628 or film/stock claim |
