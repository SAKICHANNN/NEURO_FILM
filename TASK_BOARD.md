...
| FilmMatch / explicit reference-look challengers | BL8-BL13 closed; AO6 retained | BL5 is materially non-basic but fails fresh preference. Fixed semantic selection, luma/chroma transplant and faithful SA-LUT reproduction do not open. BL13 safely amplifies AO6's own non-basic chroma (`1.2186x` style; zero new boundary/severe) but blind `13/8/9` passes only 1/3 rounds. No same-population strength, threshold, selector or capacity rescue. |
