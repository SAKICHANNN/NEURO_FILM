...
| 1at | U5.R2F1 | Run bounded external CanonCGT E2E reference-condition safety pilot | in progress: contract/reference bank frozen | exact 9 refs x 9 gold; no training; references are immutable A0 conditions, never stock truth; audit two LUTs, replay, clamp, sensitivity and severe veto |
