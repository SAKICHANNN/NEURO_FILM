...
| FilmMatch identity-residual sigmoid | BL1/BL2 capacity retained; BL3 direct OOD closed | A fixed derivative floor improves reflective/emissive RMSE and the consumed scene is strongly stylized/severe-clean, but direct use on 12 CC0 RAWs reaches `3.095%` new code-boundary pixels on one source. No visual review or retuning; test only a separately frozen analytical safe-residual composition. |
