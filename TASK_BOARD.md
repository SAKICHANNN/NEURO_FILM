...
| Physical image formation | P5O placement unidentified; P5P ready | Fixed exposure/density/transmittance arms agree on constants/affine controls but differ by up to `.03940` density / `.01911` transmittance under nonlinear sensitometry. Build an analytical minimax envelope without claiming a physical domain. |
