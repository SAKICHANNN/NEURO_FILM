...
| 1dj | U5.R2AI0 | Test fixed composition of the anchor56 margin-4 and density-cyan B0 champions | contract frozen / implementation ready | two orders x inherited s.20/.35/.50 only; must gain >=.5 style and non-basic over E1, repeat exactly and survive ID11/full-res severe veto; no fitting/routing/production claim |
