...
| 1br | U5.R2M0 | Audit a bounded interval-Möbius explicit coupling flow | frozen; implementation ready | six analytic stages / 108 coefficients; fit only frozen synthetic controls, then require confirmation fidelity, inverse, positive/bounded Jacobian, exact replay and partition parity; no images/training |
