...
| 1ar | U5.R2E1 | Evaluate bounded density witnesses on frozen gold/stress frontier | ready: contract next | compare strengths under U5.R2B style/residual/clipping screen, ID11 regression and severe-artifact-first blinded visual review; no production/stock claim |
