...
| 1bb | U5.R2H0C2 | Group-held-out simple measured-spectrum canonicalizer comparison | next ready: freeze comparison | smooth reconstruction vs cross-scene hard retrieval; known witness target only, no film pixels/neural model/production |
