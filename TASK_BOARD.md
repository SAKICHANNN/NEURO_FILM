...
| 1an | U5.R2D | Audit statistics-to-explicit-LUT ML route without stock shortcuts | in progress: contract frozen | paper-compatible Lab descriptor; permutation vs palette dependence and absent-colour operator non-identifiability; no generative text/download/GPU/training |
