...
| 1ba | U5.R2H0C1 | CAVE integrity and conditional-support feasibility | active: contract frozen / acquisition | official central directory pinned; mirror bytes require exact official path/size/CRC; grouped radius-1 gates frozen before witness output |
