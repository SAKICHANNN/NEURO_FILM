...
| Physical image formation | P8W completes the Python canonical profile topology; P8X native CPU contract next | Fixed P7 identity remains exact. Attributed row/buffer reuse and a frozen 64/32-row grid select 32 rows and reduce 12MP peak from 1.79-1.88GiB to 717.14-717.15MB. Desktop Python reference memory passes; native/mobile runtime, calibration and production promotion remain closed. |
