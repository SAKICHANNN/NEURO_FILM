...
| 1cs | U5.R2Z1 | Test asymmetric query/operator applicability for the ClassNeg Oracle gap | implemented/frozen: formal run ready | 989 tests pass; separate query/operator PCA, leave-one-query-and-operator-out rank ladder, fold-local signature shuffles and OOD fallback implemented; fresh identities 17--32 remain sealed until development pass |
