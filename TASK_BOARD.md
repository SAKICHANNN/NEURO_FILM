...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A primitive pass; U1.6 in progress | finite-support tiled execution is exact/bounded per callback window; global-state operators, streaming/total memory, actual HDR/HEIF/wide-gamut and calibrated mapping remain pending |
