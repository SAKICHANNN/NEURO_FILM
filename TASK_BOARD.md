...
| Physical image formation | P5N closes residual composition; P5O ready | Positive FIRs fit held 1D response (`<=.00892`) but fail 2D charts (`.16269/.01404` max/mean). Measured total must replace generic film spatial stages. Next audit exposure/density/transmittance placement under fixed nonlinear response. |
