...
| Physical image formation | P0/P1/P4B/P4C2/P4C3/P5C/P5D/P6A/P6B/P6C pass; P3C/P4A/P4C1/P5B closed; P7A next | The 24MP float32 scanner keeps all stages, is partition-exact, differs from float64 by only `1.34e-7`, and passes at `14.71-20.15s`/`.92-1.44GiB`. This remains generic, not scanner-calibrated. Next freeze colour-only/physics-only/combined ablation. |
