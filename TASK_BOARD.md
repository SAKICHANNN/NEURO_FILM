...
| Physical image formation | P5L exact LOD pass; P5M ready | Under frozen zero-order-hold reconstruction, the positive 4000-dpi LOD reproduces the 16000-dpi reference to `4.44e-16` max error with a 6px halo and exact partitions. Next audit the joint film spatial budget; do not stack the measured total MTF on equivalent P3/P5C blur. |
