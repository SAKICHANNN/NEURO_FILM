...
| 1cp | U5.R2X0 | Collapse the 2025 automatic palette-transfer equations analytically | implemented/frozen; formal repeat ready | direct path must equal one affine RGB operator; valid negative-determinant and `[-2,3]` cube witnesses test missing structural guarantees; no image or CPLEX execution |
