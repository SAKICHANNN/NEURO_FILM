...
| FilmMatch identity-residual sigmoid | BL1/BL2 internal Look Approximation retained | A fixed 25% identity derivative floor improves reflective/emissive held-group RMSE, keeps zero OOG and raises minimum cube Jacobian to `.01071`. The fixed real-scene render is strongly stylized and severe-clean, but the scene is already consumed; seek genuinely independent paired evidence, not retuning or calibration claims. |
