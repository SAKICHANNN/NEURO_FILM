...
| 1dn | U5.R2AJ0B | Acquire and integrity-audit the exact HaldCLUT archive | ready: frozen bounded acquisition | published MD5, safe ZIP/CRC, all 295 image decodes and two byte-identical audits required before structural analysis; no photograph render |
