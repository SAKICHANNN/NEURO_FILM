...
| 1cb | U5.R2S0 | Combine analytic reference-palette score with cube-preserving flow | ready: synthetic oracle contract frozen | fixed three palettes and coefficient map must pass attraction/style/non-affine/reference/structure/inverse/repeat conjunction before histogram-score ML; no images |
