...
| 1ec | U5.R2AO1 | Explain real Velvia chart display proxy with explicit operators | ready | freeze six leave-one-row-out folds, source-sRGB EOTF, simple controls and boundary/overfit gates |
