...
| 1ay | U5.R2H0A | Velvia 50 datasheet spectral witness numerical identifiability pilot | next ready: frozen contract | synthetic-only graph overlay, smooth spectrum and metamer-sensitivity audit; no visual tuning, real-film fitting, calibration or stock-response claim |
