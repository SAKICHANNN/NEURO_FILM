...
Next: root owns G1 implementation/config/evidence. Medium frozen nine-photo global-control protocol in configs/salut_g1_projection_v1.json; not started, no inference live.
