...
| 1q14 | SF2.7R | Acquire same-slide multi-scanner nuisance control | in progress: contract frozen | exact 71,068,957-byte ColorReference Set 3 lane; internal research/no redistribution; no stock fitting/training/LSM |
...
| 1bk | U5.R2J1 | Run fixed positive-film bank on frozen real images | in progress: contract frozen | 25 fixed s0.10..0.35 candidates, inherited gates, safe-rich/R2E1 comparators; visual work only for automatic survivors |
