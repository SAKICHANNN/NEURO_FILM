...
| 1dy | U5.R2AM1 | Test bounded SO(3)-coordinate curve capacity | ready: corrected v2 contract / implementation | v2 `5c7a77eb...c9be` binds v1 and exact execution semantics; 21-raw/18-effective candidate vs RGB curves, positive matrix+curves and K3; zero photos/data |
