...
| Physical image formation | P5F synthetic pass; P5G next | The distinct zero-sum interimage operator is exact on constants/neutral, bounded at `.05/.006`, adds `6.80%` opponent-edge gradient and has exact finite-halo tiling. This is synthetic feasibility only; freeze photographic severe/OOD before combined use. |
