...
| 1dw | U5.R2AL1 | Freeze analytic chroma-sector curve capacity pilot | ready: contract | fix partition, curve budget, synthetic truths, controls, split/optimiser, Jacobian/inverse/replay/strength and relative-capacity gates before code |
