...
| 1de | U5.R2AF1 | Exact-checkpoint safe-LUT topology stress | implementation verified / formal run ready | 5 focused and 1024 full tests pass; execute two independent exact runs before metric inspection |
