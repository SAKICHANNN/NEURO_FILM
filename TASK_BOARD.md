...
| 1az | U5.R2H2 | Audit exact hard-1NN routed outputs visually and at full resolution | next ready: freeze contract | immutable H1 predictions and existing safe renders only; blind disagreement panel + all-41 severe inspection; no model change |
