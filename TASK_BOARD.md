...
| 1af | U1.4C0/U1.4C1 | Make the colour operator working-space aware | C0 audit complete; C1 contract frozen | exact legacy parity before six-style Rec.2020 colour-only path; no FilmFX/renderer/schema integration |
