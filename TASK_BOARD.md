...
| Tests | baseline passes | 505 CPU tests pass through U1.6G4C; v1 remains frozen and v2 is not effect-integrated |
...
| 1v | U1.6G4D | Bind G4A/G4C capabilities and freeze simplest density executor | ready | static binding first; preregister effect parity/resource/full-res visual gates before executor code |
