...
| Measured slide spectra | P6F RGB approximation closed; P6G data audit ready | On 8,640 Velvia 100F IT8 spectral rows, bounded 3x3 improves joint-held mean 9.86% but fails all absolute held-set/slide gates (`.07098/.20960` joint mean/p95). Keep spectral reference; audit existing multi-scanner same-target evidence before any real scanner fit. |
