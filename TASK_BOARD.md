...
| Physical image formation | U6.P0/P1A pass; P1B/P3 next | typed domains/profile/counter pass; float64 positive scatter reference repeats exactly with `5.44e-14` energy error. Generic reference only; current display proxies and procedural effects remain uncalibrated |
