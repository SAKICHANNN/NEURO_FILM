...
| Controlled film wedge sources | P2K downloading; P2L1 closed for sensitometry | Apollo 16 segment 05 is exact/CRC-clean historical Kodak 3401-associated raw scan, but contains only two endpoint-like levels rather than the frozen six-level minimum. Retain only endpoint/edge stress; no curve fit or further segment expansion. Apollo 7 SO-368 P2K remains an incomplete stream and partial bytes are not evidence. |
