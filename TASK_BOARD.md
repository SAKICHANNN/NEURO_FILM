...
| FilmMatch identity-residual sigmoid | BL5/BL6 high-priority internal challenger | Strict-interior fitting preserves paired capacity and eliminates BL3/BL4 boundary/safety-tail failures. Fixed BL6 is exact, boundary-clean and severe-clean; it wins all three autonomous blind rounds and `32/36` choices over AO6. Require genuinely fresh rights-cleared confirmation before incumbent replacement; no product/calibration/stock claim. |
