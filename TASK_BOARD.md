...
| 1ap | U5.R2D2 | Test imperfect canonicalizers and hard operator retrieval | ready: freeze contract | multiple neutralization hypotheses/reference pools; hard retrieval vs regression; instability means unidentified; generated truth only |
