...
| 1bd | U2.2A | Monotone exposure-to-layer-density sensitometry primitive | contract frozen; implement next | clean-room three-layer toe/mid/shoulder witness; analytic inverse/Jacobian, neutral anchor and fail-closed exposure domain; no stock claim |
