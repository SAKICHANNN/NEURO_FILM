...
| 1q8 | SF2.1A | Openverse exact-stock shared-creator metadata graph | frozen/ready | four colour stocks, strict licence/text/source graph, 48 API metadata requests max; no landing pages/pixels/fitting/training/LSM |
