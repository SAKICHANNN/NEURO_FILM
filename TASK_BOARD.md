...
| Physical image formation | P2Q research prior pass; P2R ready | Exact Kodak 250D curves compile into a bounded monotone research prior and differ materially from generic U2.2 shape. Next test a frozen shared-anchor gauge hypothesis; layer exposure, calibration and product claims remain closed. |
