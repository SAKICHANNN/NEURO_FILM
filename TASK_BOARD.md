...
| 1dy | U5.R2AM1 | Test bounded SO(3)-coordinate curve capacity | ready: corrected v3 / runner implementation | v3 `2ea192df...746c` binds v1/v2 and exact audit execution after 7 operator tests, before any exact AM1 fit; zero photos/data |
