...
| Complete fixed-bank Oracle | BH0S source pass / BH0 render ready | Ten eligible CC0 RAW rows from ten unseen makes pass two exact integrity runs after two retained no-replacement decode failures. Render the five frozen explicit arms and collect complete rankings; no fitting/router yet. |
