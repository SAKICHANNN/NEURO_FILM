...
| Physical image formation | P5P analytical envelope passes; P5Q ready | Pointwise transmittance midpoint is bounded, minimax and partition-exact with nonempty effect; retained half-range exposes placement uncertainty. Next frozen photo stress compares safety/value without a physical claim. |
