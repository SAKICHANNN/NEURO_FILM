...
| Compact explicit colour capacity | AS0 synthetic pass; real-pair use data-gated | Fixed eight-centre Gaussian log-odds residual improves four analytic held-sample witnesses by 8.96%-20.12% with in-cube, positive-Jacobian and exact-neutral behavior. AO9's 71-pair pool stays sealed; retain only for genuinely new controlled pairs. |
