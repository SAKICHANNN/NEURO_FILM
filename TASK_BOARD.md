...
| Physical image formation | P5J measured-MTF compiler pass; P5K ready | A preregistered positive PSF compiler selects B single/G delta+Gaussian/R two-Gaussian and cuts held-frequency RMSE to `.218x` of one-Gaussian baseline, with no extrapolation. Next prove discrete kernel/edge/partition/no-ringing invariants before photographic value work. |
