...
| 1dy | U5.R2AM1 | Test bounded SO(3)-coordinate curve capacity | ready: contract freeze | synthetic-only comparison against RGB curves, positive 3x3+curves and K3; exact cube/Jacobian/analytic inverse/replay gates before code or fit |
