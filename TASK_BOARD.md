...
| 1q18 | SF2.10R | Audit Color Precision comparison metadata, scanner topology and pixel rights | implemented/frozen; formal repeat ready | eight retained HTML responses only; 927 embedded image URLs must not be requested; filename labels remain weak metadata and pixel DoR requires rights plus replication |
