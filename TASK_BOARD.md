...
| 1ca | U5.R2R1 | Characterize all 41 published D-LUT trajectory steps | ready: post-exploratory contract frozen | exact hashes/parser plus trilinear/tetrahedral range, Jacobian, norm and byte-repeat gates; no training or real images; no structural survivor closes without rescue |
