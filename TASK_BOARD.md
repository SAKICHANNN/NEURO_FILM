...
| 1cs | U5.R2Z1 | Test asymmetric query/operator applicability for the ClassNeg Oracle gap | contract frozen: implementation ready | separate query/operator PCA; leave-one-query-and-operator-out rank-2 then rank-4 ridge; shared/medoid/random/shuffled/photometric controls and OOD fallback; fresh confirmatory identities 17--32 remain sealed until development pass |
