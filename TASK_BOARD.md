...
| 1dr | U5.R2AJ0C1 | Run the frozen per-Hald structural frontier | ready: contract design only | freeze all 194 primaries, native N=144/256 streaming, per-candidate veto, strength/duplicate collapse and cap-12 selection before any primary body or metric access |
