...
| Physical image formation | P0/P1/P4B/P4C2/P4C3 pass; P3C/P4A/P4C1 closed; P5A representation pass, P5B ready | Separate spatial stages are repeat-exact, but P5A exposes `.30894` adjacency undershoot and unbounded presampled-MTF reporting. Freeze severe-halo and Nyquist-aware P5B before any visual/runtime use. Generic only |
