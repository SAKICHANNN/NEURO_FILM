...
| 1de | U5.R2AF1 | Exact-checkpoint safe-LUT topology stress | contract frozen / implementation ready | eight safe analytic LUTs, exact CPU runtime/checkpoint and topology/fidelity controls fixed before execution |
