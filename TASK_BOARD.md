...
| 1dc | U5.R2AE1 | Source-bound synthetic operator-bank structural diversity audit | ready: freeze contract | de-duplicate exact chains, run twice on a fixed cube, reject instability/folding/basic-only separation; external comparator only |
