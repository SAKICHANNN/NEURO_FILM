...
| 14 | U1.2–U1.6/U2.5A | Color-state contract, 16-bit/ICC export, HDR/HEIF, B&W safety and tiled foundation | U1.6A/U1.6B pass; U1.6C frozen/ready | implement finite-support simple-halation composite parity; physical effects, CLI integration, streaming/total memory, HDR/HEIF/wide-gamut and calibrated mapping remain pending |
