...
| Physical image formation | P3L/P3M fixed backing-return combined route closed | Scene-linear input does not repair the topology. Frame support is the strongest failure association, but only 80.15%/80.57% versus the frozen 90% dominance gate; zero/highlight/shadow explanations also fail. No padding/strength/profile rescue. |
