...
| Physical image formation | P4H stationary global compiler retained; P4K-P4M exact reference/data infrastructure pass; P4N routing closed; P4O ready | Exact-area streaming repeats at about 465MB/61-65s and emits 48 leakage-free synthetic pairs. A development-only hard fallback improves sealed fidelity but loses the cost-aware objective by 7.44%, so no router capacity opens. Next is stationary global-P4H full-resolution performance only; no photograph, calibration or product claim. |
