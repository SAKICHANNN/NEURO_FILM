...
| 1eb | U5.R2AO0 | Acquire real Velvia 50/reference chart display-proxy pairs | ready: 2-download/600KB source gate frozen | verify exact official CC-BY-4.0 Figure 8 bytes and extract two uniform 4x6 patch grids; no fit before pass |
