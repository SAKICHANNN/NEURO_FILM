...
| 1dv | U5.R2AL0 | Audit clean-room analytic named-colour monotone curves | ready: source/method audit | isolate fixed color-selective curve representation from NamedCurves canonicalizer/attention/code/assets; synthetic-only DoR, no film or product claim |
