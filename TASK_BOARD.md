...
| 1ao | U5.R2D1 | Benchmark bounded statistics-conditioned operators on known synthetic truth | ready: freeze contract | CPU-only generated operators; operator-family/palette-support holdouts and explicit descriptor/content/difference/basic controls; no stock data or authenticity claim |
