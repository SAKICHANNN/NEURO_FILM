...
> FilmSet CT5/CT8 is an auxiliary digital-recipe control only.
...
| 3 | RF1.2 | Diagnose BlueNeg roll sign reversal without added capacity | executing | 43-query nested LOO contract frozen before rerun |
