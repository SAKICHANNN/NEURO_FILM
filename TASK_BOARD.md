...
| 1aw | U5.R2G1 | Apply one fixed RGB8 quantization-headroom adapter to immutable G0 operators | next ready: freeze contract | no refit/capacity; fixed interior map only; must retain G0 style and eliminate boundary/clipping failure |
