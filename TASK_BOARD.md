...
| Controlled paired chart source | AW0 bounded acquisition active | FilmMatch publishes 136 Ektachrome/Sony same-chart TIFFs plus four validation artifacts. A pilot confirms paired content, but both rails lack ICC and full pairing, transfer functions and independent grouping remain unresolved. Audit exactly 140 files / 4,255,132,151 bytes before fitting. |
