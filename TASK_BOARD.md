...
| Physical image formation | P5I measured MTF source pass; P5J ready | P3P/P5H visible-value routes remain closed. A separate exact Kodak 250D manufacturer MTF trace passes source and visual-overlay gates over 25-65 cycles/mm. Freeze and run a positive one/two-scale PSF compiler on development/held frequencies; no calibration or runtime integration yet. |
