...
| 1bp | U5.R2L0 | Measure a post-E1 per-image hard-strength Oracle | ready: contract frozen | immutable density-cyan s0.50/s0.65 only; clipping-limited hard selection must show material style gain and pass all-41 full-resolution severe veto before any inference-side policy research |
