...
| 1dp | U5.R2AJ0C | Freeze and run a synthetic per-Hald structural frontier | ready: contract design only | analytic identity, native N=144/256, controls-only threshold calibration, per-candidate safety/basic/novelty, strength collapse and cap-12 policy must be committed before primary metrics |
