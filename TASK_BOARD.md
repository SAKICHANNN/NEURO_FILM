...
| Scanner spectral boundary | P6D synthetic reference pass; P6E ready | A scanner-A metamer pair differs by `.25236` under scanner B, proving RGB-only scanner transforms have a `.12618` worst-member lower bound on this witness. P6A remains an approximation; P6E will measure population-level approximation without photographs or calibration claims. |
