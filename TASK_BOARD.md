...
| 1q11 | RF2.C0 | Isolated spektrafilm external spectral control | complete: one external control only | Ektar100/fixed-e0 passes style/non-basic/clipping and 3-round visual gates; auto exposure is unstable nuisance evidence; no integration, teacher, stock or calibration claim |
...
| 12k | U5.R1C3D | Minimal spatial cross-fit absorption diagnostic | frozen/ready | fixed 4x4 neighbour-exclusion affine only; no capacity/A1/recruitment/training expansion |
...
*Active parent: `ULT > RF stock-first real-film mainline` | SF1.3B is closed and LSM1 remains ineligible; U1.4C2/U1.5B are closed; R1C3 weak-passes with no candidate and opens only the minimal R1C3D cross-fit mechanism diagnostic; other explicit U1 gaps remain available; FSA/OWI remains sealed auxiliary | Integration owner: repository owner or explicitly assigned root agent*
