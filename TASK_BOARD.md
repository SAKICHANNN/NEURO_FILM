...
| 1da | U5.R2AD1 | Test spatial DIR on/off with the retained Ektar100 fixed-e0 control | ready | freeze exact external defaults, gold inputs, matched local-contrast control, replay and artifact gates before rendering |
