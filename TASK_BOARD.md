...
| Physical image formation | P3Q analytical base-return topology pass; P3R ready | Exact NIST mechanism evidence plus a no-fit annular kernel pass thickness/index/attenuation and numerical gates, and differ materially from equal-moment Gaussian. Next run a fixed-energy photographic topology A/B with severe-artifact-first review; no modern-stock calibration. |
