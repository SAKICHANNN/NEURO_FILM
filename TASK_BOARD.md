...
| 1ah | U2.6A | Expose existing profile evidence labels through validated read-only API/CLI | ready: contract frozen | exact deterministic declared fields only; no schema/render change, evidence inference or calibrated-profile promotion |
