...
| 1am | U5.R2C | Freeze B1 complete-policy empirical-ceiling and annotation budget | ready: contract/budget only | fixed bank, identity fallback, disjoint panels and all-scene tie-score; no recruitment or external annotation without separate authority |
