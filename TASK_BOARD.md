...
| 1al | U5.R2B | Freeze and evaluate the strongest eligible global operator frontier | ready: contract next | identical renderer/export, target-look and severe-artifact gates; do not fit unidentified stock pixels |
