...
| Parallel projection-curve operator | BN1 development pass; BN2 ready | Clean-room source-adaptive explicit curves improve mean 7.24-7.95% over the same-family global operator on all three seen FiveK populations; all P95/worst/style/dose/Jacobian/cube/boundary gates pass. Freeze and confirm unchanged on disjoint AY2 content only. |
