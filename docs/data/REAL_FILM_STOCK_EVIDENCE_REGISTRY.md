...
| NASA/JSC STS098 astronaut photography candidate | yes | official exact media codes `VELVI`, `5775`, `5776`; formal snapshot pending | mission-roll-frame and standardized geographic/features/focal metadata | `S0` metadata candidate under SF2.0B0; no pixels | exact support/overlap not yet frozen; mission/date/roll/content/camera/scan nuisance untested |
