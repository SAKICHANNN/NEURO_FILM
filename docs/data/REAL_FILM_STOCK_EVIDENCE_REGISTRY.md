...
| NASA/JSC STS098 astronaut photography | yes | official exact media codes `VELVI`, `5775`, `5776`; 168/329/10 target rows, zero ID overlap | Velvia 2 rolls; Portra 400NC 12; Portra 400VC 1 auxiliary | `S0` metadata negative control; SF2.0B0 insufficient-roll close | Velvia fails frozen four-roll primary minimum; no B1 or photo acquisition |
