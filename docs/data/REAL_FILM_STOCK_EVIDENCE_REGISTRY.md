...
| Wikimedia Commons stock categories | claimed physical film per file/category | exact community categories for Ektar100, Superia X-TRA400 and Gold200; Velvia family separate | SF0.5 true-author result: Ektar 26/8 passes; Superia 2/2 and Gold 8/4 fail | `S0`; Ektar provisional unpaired reference only | one passing stock; community labels and content/scanner nuisance block learning and `S1` |
