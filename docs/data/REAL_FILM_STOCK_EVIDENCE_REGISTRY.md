...
| Wikimedia Commons stock categories | claimed physical film per file/category | exact community categories for Ektar100, Superia X-TRA400 and Gold200; Velvia family separate | 19/13/8 uploaders for exact stocks; roll/process/scanner unknown | `S0` metadata pass; bounded permissive pixel pilot allowed | community labels and uploader/content/scanner nuisance require pixel/group audit before `S1` |
