...
| YFCC exact user text + live Flickr rights | claimed physical film per user metadata | YFCC15M pixels remain shortcut-negative; full YFCC adds Ektar100/Velvia50 shared-author connectivity | 37 clean SF1.3A pixels: 21/16 by stock, eight bilateral UIDs, zero exact/dHash<=4 pairs | `S0`; rights/pixel/connectivity feasibility only | UID is not person identity; content is unbalanced and SF1.3B identifiability remains pending |
