...
| YFCC15M exact user text + live Flickr rights | claimed physical film per user metadata | Velvia50 plus diagnostic Ektar100 source bridge; prospective process exclusions and live CC-BY-2.0 | Velvia 25/14 UIDs/16%; Ektar bridge 16/5/25%; zero duplicates/severe visual artifacts | `S0`; Velvia third candidate, Ektar diagnostic bridge | UID is not person identity; connected source/content/colour shortcuts untested; no learning or `S1` |
