...
| Wikimedia Commons stock categories | claimed physical film per file/category | exact community categories; Ektar100 and UltraMax400 currently pass source gates | Ektar pixels 26/8 authors; UltraMax metadata 84/15 authors/51 strict rows | `S0`; provisional unpaired reference candidates only | only two stocks; community labels and content/scanner nuisance block learning and `S1` |
