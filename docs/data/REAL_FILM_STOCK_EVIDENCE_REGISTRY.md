...
| Apollo flight-film archive | yes | NASA/JSC documents Apollo 7 SO-368/SO-121 magazine, filter and frame ranges | two SO-368 and five SO-121 colour magazines in one mission; 63-page SF2.0A scope frozen | `S0` metadata candidate; no pixels or learning | orbital content, exposure and filter association require explicit connectivity controls; raw versus ASU-derived rights remain separate |
