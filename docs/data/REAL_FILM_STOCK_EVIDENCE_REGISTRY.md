...
| Ektar 100 paired-colour lane | exact stock target, no qualifying observation | zero rights-cleared same-scene digital/film colour observations | none | data gap; first acquisition priority | unpaired pixels, external emulator controls, datasheets and uniform-grain scans cannot substitute |
