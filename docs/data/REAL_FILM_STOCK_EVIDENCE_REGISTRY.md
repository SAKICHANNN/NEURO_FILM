...
| Existing HP5 / Tri-X safe-Lab profiles | no controlled physical-film target | legacy directory statistics and heuristic profile labels only | same 16 CC0 digital inputs; no roll/developer/process/scanner evidence | BW2.D0 deterministic B&W Look Approximation negative control | 16/16 per-source median HP5--Tri-X Delta E76 values are exactly zero; retain one generic B&W Look Approximation recommendation until independent real-stock evidence exists |
