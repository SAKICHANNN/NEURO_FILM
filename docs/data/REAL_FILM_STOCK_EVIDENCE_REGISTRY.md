...
| YFCC exact user text + live Flickr rights | claimed physical film per user metadata | YFCC15M pixels remain shortcut-negative; full YFCC adds Ektar100/Velvia50 shared-author connectivity | 16 metadata-shared UIDs; SF1.2 confirms eight bilateral live-rights UIDs; SF1.3A pixels not yet acquired | `S0`; rights/connectivity feasibility only | UID is not person identity; current pixels fail identifiability; pixel/content/source controls remain |
