...
| YFCC exact user text + live Flickr rights | claimed physical film per user metadata | YFCC15M pixels remain shortcut-negative; full YFCC metadata adds Ektar100/Velvia50 shared-author feasibility | full index 780/240 rows, 122/62 UIDs, 16 shared; live shared-author rights not yet tested | `S0`; metadata connectivity only | UID is not person identity; current pixels fail identifiability; SF1.2 rights and later pixel/source controls remain |
