...
| Wikimedia Commons stock categories | claimed physical film per file/category | exact Ektar100, UltraMax400 and Kodachrome64 pass source gates | Ektar pixels 26/8 authors; UltraMax metadata 84/15/51 strict; Kodachrome64 51/22/15 strict | `S0`; provisional unpaired candidates only | only Ektar has passed pixels; community labels and content/scanner nuisance block learning and `S1` |
