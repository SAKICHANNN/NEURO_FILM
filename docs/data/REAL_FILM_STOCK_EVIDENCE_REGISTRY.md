...
| YFCC15M exact user text + live Flickr rights | claimed physical film per user metadata | Velvia50 exact phrase, prospective process exclusions, live CC-BY-2.0 page and pixel | 25 files/14 UIDs/16% largest; zero exact/dHash<=4 duplicate; no severe visual artifact | `S0`; third provisional unpaired candidate | UID is not person identity; scan/source/content/colour shortcuts untested; no learning or `S1` |
