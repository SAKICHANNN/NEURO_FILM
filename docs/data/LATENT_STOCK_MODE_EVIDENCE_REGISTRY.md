...
| SF1.1 full YFCC metadata index | metadata-only connectivity gate in progress; no image payloads permitted | `metadata only`; result pending frozen audit/decision | false |
