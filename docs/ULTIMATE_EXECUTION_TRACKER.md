...
| U5.R2AQ1 | ready | Build the exact 8,640-row recorder/measurement table and audit repeated-target-set identifiability before any fit | AQ0 source/semantics pass | freeze patch geometry and variability gates first; validate source sampling, IT8/spectral rows, six-set support and nuisance variance. No operator fitting/training/rendering; pass may open held-set proxy baselines only |
