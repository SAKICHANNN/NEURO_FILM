...
| U5.R2AM1 | ready: corrected v2 synthetic contract / implementation | Test a bounded SO(3)-conjugated monotone-curve operator against explicit global controls | AM0 prior-only decision | v1 `2f081922...7e59` remains immutable; executable v2 `5c7a77eb...c9be` additionally pins restart initialization, K3 restart count, Rodrigues zero math, scalar inverse and report identity before code or fit. Representation, targets/controls, budgets, geometry, gates and zero-photo/data boundary are unchanged; `docs/planning/U5_R2AM1_SO3_COORDINATE_CURVE_CAPACITY_CONTRACT.md` |
