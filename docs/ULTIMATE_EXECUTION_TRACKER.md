...
| U5.R2H0 | next ready: deep research | Film-specific spectral/sensitometric prior and obtainable-data feasibility audit | U5.R2G1 | Compare primary-source differentiable/non-generative explicit film models and exact obtainable inputs; no fitting/calibration claim before source and identifiability gates |
| U5.R2H1 | in progress: contract frozen | Hard content routing between anchor56 and density-cyan safe operators | U5.R2B, U5.R2E1 | A0 disclosed-development 41-row source descriptor; three metric Oracles, LOO majority/1NN/3NN/logistic, 1000 permutations and regret gate; no stock/preference/production claim; `docs/planning/U5_R2H1_SAFE_BANK_CONTENT_ROUTING_CONTRACT.md` |
