...
| U1.4A | contract frozen / implementation ready | Dependency-free D65 linear-sRGB/linear-Rec.2020 conversion primitive | U1.2B/C | official rational matrices, extended-range/no-clamp roundtrip, WorkingImage preservation; renderer integration/HDR/ACES/output remain closed; `docs/planning/U1_4A_LINEAR_REC2020_PRIMITIVE_CONTRACT.md` |
