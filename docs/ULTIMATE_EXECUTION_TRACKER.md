...
| U5.R2D1 | in progress: contract frozen | CPU known-operator recovery under operator-family and palette-support shift | U5.R2D | 384 generated matrix/tone/combined operators; operator-group splits, palette shift, mean/PCA-ridge/PCA-KNN and content/target/interaction/canonical-oracle controls; held-out probes and severe numerical veto remain independent |
