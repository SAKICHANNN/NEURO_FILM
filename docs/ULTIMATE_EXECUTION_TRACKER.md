...
| U5.R2H2 | in progress: contract frozen | Exact hard-1NN full-resolution and blind visual diagnostic | U5.R2H1 | Exact 37 predictions plus four density fallbacks; inspect all 41 routed outputs and all 10 interventions in three deterministic blind rounds; no model, bank, feature or label change |
