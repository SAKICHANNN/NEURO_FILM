...
| U5.R2M0 | frozen; implementation ready | Bounded interval-Möbius triangular coupling representation | U5.R2K1/K3 closes + ENNeLUT invertibility prior | six explicit analytic stages / 108 coefficients; development-only synthetic-control fit; frozen fidelity, inverse, Jacobian, replay and exact partition gates; no images/training/stock claim; `docs/planning/U5_R2M0_INTERVAL_MOBIUS_COUPLING_CONTRACT.md` |
