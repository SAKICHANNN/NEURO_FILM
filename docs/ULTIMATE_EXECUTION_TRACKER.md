...
| U5.R2S1C | ready: untouched confirmation frozen | Confirm query KDE .12 against hard Top-1 and global mean | U5.R2S1D | seed 27012 / 128 queries; accuracy, style/non-affine/separation, 45% hard and 50% global improvements, permutation/range/Jacobian/norm/inverse/replay/repeat must all pass; no alternate bandwidth or model rescue; `docs/planning/U5_R2S1_HISTOGRAM_SCORE_CONFIRMATION_CONTRACT.md` |
