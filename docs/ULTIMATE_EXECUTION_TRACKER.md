...
| U5.R2J1 | ready: freeze frontier | Bounded-strength real-image frontier for the fixed J0 bank | U5.R2J0 | inherited 9-gold/32-stress style/non-basic/clipping gates, then blind/full-res review only for survivors; compare safe-rich and R2E1 |
