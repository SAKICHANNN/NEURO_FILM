...
| U6.P3I | active: contract frozen | Measure direct versus FFT isolated backing return in fresh 1/12/24MP processes | P3H functional pass | two runs per algorithm/shape; require >=2x 12/24MP speedup, <=15s and <=3GiB at 24MP, exact per-algorithm replay and bounded RSS ratio |
