...
| U5.R1C3D | ready | Test whether spatial cross-fitting prevents same-pair sparse-failure absorption | U5.R1C3 weak-pass | affine only, fixed block assignment, unchanged members/scores/gates; no capacity expansion, A1, recruitment, training or promotion |
