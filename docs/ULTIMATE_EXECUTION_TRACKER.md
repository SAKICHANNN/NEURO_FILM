...
| U5.R2AE1 | ready: contract freeze | Test whether a source-bound subset forms a replay-stable, non-basic external operator bank on a fixed synthetic cube | AE0 limited pass | freeze chains, de-duplication, exact replay, folding/range/artifact and matched-basic diversity gates before metrics; synthetic external-comparator claim only |
