...
| U5.R2AO3 | ready | Factor the fixed chart operator into bounded tone and chroma residual strengths with a deterministic boundary guard | AO2 failure diagnosis | fixed operator/metrics; test a small predeclared factor bank, exact repeat and severe veto; no threshold or model refit |
