...
| U5.R1C3D | frozen: ready | Test whether spatial cross-fitting prevents same-pair sparse-failure absorption | U5.R1C3 weak-pass | affine only; fixed 4x4 tile/exclude-neighbourhood assignment and unchanged members/scores/gates; fail closes route, pass opens design only; no capacity expansion, A1, recruitment, training or promotion |
