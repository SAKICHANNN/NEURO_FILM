...
| U5.R2AD1 | ready | Test spatial DIR inhibitor diffusion against the exact RF2.C0 non-spatial control | AD0 external-ablation pass | freeze one source-bound Ektar100 fixed-e0 gold-set ablation, exact replay, matched local-contrast control and automatic artifact gates before vision; no search or post-result rescue |
