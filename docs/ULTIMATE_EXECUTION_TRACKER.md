...
| SF0.7 | ready: two-stock pixels | Freeze and audit derivative-only UltraMax400 and Kodachrome64 pixels | SF0.6B | each stock independently passes rights/hash/decode/duplicates/content/source/vision before any learning |
