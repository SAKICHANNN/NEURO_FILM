...
| SF0.5 | in progress: corrected derivative-only contract | Acquire author-and-uploader-capped permissive 1600px derivatives for the three exact Commons stocks | SF0.4 | expected 36 files (26/2/8), <=192/512MiB; original-URL responses excluded; Superia already fails support preflight |
