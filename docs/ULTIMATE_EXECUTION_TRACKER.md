...
| U6.P2G | ready | Stress the fixed generic reversal operator as direct slide on the 18-image/nine-make CC0 population | P2F pass + P3F source lineage | freeze reference gauge, scanner, dark/white/range/noise gates and fixed visual IDs before render; no photo fitting |
