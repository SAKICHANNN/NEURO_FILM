...
| U5.R2F1 | in progress: contract/reference bank frozen | Immutable CanonCGT E2E reference-condition and explicit-LUT safety pilot | U5.R2F0, U5.R2E1 | Exact 9 refs x 9 gold; no training; conditions never stock truth; require two-LUT replay, double pass, range/clamp audit, sensitivity, inherited frontier metrics and full severe veto; `docs/planning/U5_R2F1_CANONCGT_REFERENCE_CONDITION_CONTRACT.md` |
