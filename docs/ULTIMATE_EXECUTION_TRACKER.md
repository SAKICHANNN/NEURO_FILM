...
| RF1.4B0 | in progress: contract frozen | Gold100 official bbox/matrix alignment and support gate | RF1.4A | restricted-pickle loader; 47 pair/whole-roll/dimension gates; no colour fit; `docs/planning/RF1_4B_GOLD_PROXY_ALIGNMENT_CONTRACT.md` |
| RF1.4B1 | gated | Gold100 display-proxy paired-transform identifiability | RF1.4B0 | preregister whole-roll paired consistency/simple-global/wrong-roll controls; no inherited preview claim |
