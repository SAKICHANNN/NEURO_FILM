...
| U6.P2I | ready | Add an explicit endpoint-derived scan-signal black/white normalization before display interpretation | P2H localization | synthetic flat-field endpoints only; no photo fitting, clipping or scanner/calibration claim |
