...
| U5.R2AJ0B2 | ready: separately frozen lane-aware correction | Confirm exact path-family format/mode/bit-depth/Hald profiles in two new processes | AJ0B v1 closed + diagnostic metadata | exact SHA/profile/path/image-record identities; Color stays RGB, B&W stays L, root 16-bit controls remain integrity-only; no conversion, photograph render or aesthetic inspection; `docs/planning/U5_R2AJ0B2_HALDCLUT_LANE_AWARE_ACQUISITION_CONTRACT.md` |
