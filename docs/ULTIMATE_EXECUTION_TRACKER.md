...
| U1.6G4I | contract frozen / harness ready | Isolated-adapter 100MP process-tree resource/determinism audit | U1.6G4H | exact 10000x10000 workload; 4.0GB live-array floor, 8GiB RSS, 240s worker, repeat hashes, preflight/failure cleanup; no complete renderer or production integration; `docs/planning/U1_6G4I_100MP_ADAPTER_RESOURCE_CONTRACT.md` |
