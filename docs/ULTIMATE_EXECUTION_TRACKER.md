...
| U5.CT6 | acquisition ready; narrow single-film-string pilot | BlueNeg 8-bit preview/pseudo-GT correct-roll matched-control pilot | CT2/CT3 pass | Metadata/licence/whole-roll/storage gate passed. Download exactly 101 files / 118,929,719 bytes. Correct roll must beat pooled, shuffled, random and two development same-film wrong-roll controls on two held-out Kodak Gold 100-5 rolls; broader claims are unavailable |
