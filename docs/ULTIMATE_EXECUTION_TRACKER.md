...
| U5.R2AF1 | ready: frozen synthetic topology stress | Test whether the exact AceTone LUT tokenizer introduces folds into analytic orientation-preserving LUTs | AF0 tokenizer-only allowance | exact checkpoint/repeat/range/fidelity/Jacobian controls; no Qwen, photos, benchmark, training, decoder repair, film or product claim |
