...
| U5.R2AM1 | ready: frozen synthetic contract / implementation | Test a bounded SO(3)-conjugated monotone-curve operator against explicit global controls | AM0 prior-only decision | config `2f081922...7e59` freezes 21-raw/18-effective candidate, two external-family project targets, RGB-curve/positive-matrix/K3 controls, fit and exact cube/Jacobian/scalar-inverse/replay/neutral/hue/ramp/strength/two-process gates before code or fit; zero photographs/data; `docs/planning/U5_R2AM1_SO3_COORDINATE_CURVE_CAPACITY_CONTRACT.md` |
