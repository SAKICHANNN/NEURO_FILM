...
| U5.CT6 | evaluator frozen; development decode ready | BlueNeg 8-bit preview/pseudo-GT correct-roll matched-control pilot | CT2/CT3 pass | Exact acquisition and secure alignment metadata pass. Fixed-budget support/query access, operator ladder, controls and pass/ambiguous/fail rules are frozen before first pixel decode. Evidence: `docs/ROLL2FILM_BLUENEG_ACQUISITION_RESULTS.md`, `docs/data/ROLL2FILM_BLUENEG_EVALUATOR_CONTRACT.md` |
