...
| RF1.4B1 | ready | Gold100 display-proxy paired-transform identifiability | RF1.4B0 | preregister whole-roll paired consistency/simple-global/wrong-roll controls; no inherited preview claim |
