...
| SF0.8B | ready: Velvia50 pixel pilot | Reverify and audit at most 32 YFCC Velvia50 pixels, max four per UID | SF0.8A | live page/image/licence + process exclusions + decode/hash/duplicate/content/vision pass; stop below 8 files/5 UIDs; no training |
