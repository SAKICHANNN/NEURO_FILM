...
| U5.R2G0 | in progress: contract frozen | Constrained explicit distillation of immutable ML LUT controls | U5.R2F2 | Exact 81 synthetic-grid fits into 9-knot monotone curves + bounded positive row-stochastic matrix; unchanged frontier, F2 advantage and conditional visual gates; no photograph fitting/training/stock claim; `docs/planning/U5_R2G0_CONSTRAINED_EXPLICIT_DISTILLATION_CONTRACT.md` |
