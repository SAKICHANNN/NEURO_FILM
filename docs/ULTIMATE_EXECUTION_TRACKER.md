...
| U6.P5F | ready: contract frozen | Test a zero-sum cross-layer interimage/DIR-inspired developed-density adjacency operator without changing retained P5C | P5C/P5D pass; AD1 external spatial-DIR failure | Synthetic only: constant/neutral identity, analytic density/transmittance bounds, opponent-edge response, exact row partitions and finite impulse support. Pass opens a separate photographic severe/OOD audit; no stock/process/product claim |
