...
| ID | Status | Deliverable | Dependencies | Exit evidence |
|---|---|---|---|---|
| U1.1 | in progress | `render_film` consumes `WorkingImage` | U0.4 | JPEG/PNG/TIFF script E2Es pass; standard-sRGB and unprofiled TIFF16 preserve uint16 ingress, while unsupported 16-bit ICC fails closed. RAW E2E and removal of the explicit legacy sRGB8 adapter remain pending. |
