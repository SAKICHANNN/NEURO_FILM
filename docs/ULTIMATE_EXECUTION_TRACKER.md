...
| U1.6G4I | contract design ready | Isolated-adapter 100MP process-tree resource/determinism audit | U1.6G4H | freeze analytic workload, >=4GB live-array sanity floor, peak-RSS/time/hash/failure gates and local-only claim before execution; no complete renderer or production integration |
