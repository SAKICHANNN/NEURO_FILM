...
| U5.R2AG1 | ready: freeze compact representation contract | Test 16-anchor bounded convex-gradient map on the exact O0 synthetic controls | AG0 feasibility + O0 benchmark | same confirmation/affine/Jacobian/norm/inverse/replay gates; no images, unpaired fit, ICNN, capacity growth or stock claim |
