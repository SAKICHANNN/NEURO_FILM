...
| U5.R2H0A | in progress: contract frozen | Velvia 50 datasheet spectral witness numerical identifiability pilot | U5.R2H0 | Fixed status-density approximation, graph axes, 729-colour grid and metamer/effect gates frozen before curve data or code; synthetic only; `docs/U5_R2H0A_VELVIA_DATASHEET_WITNESS_CONTRACT.md` |
