...
| U5.R2D2 | in progress: contract frozen | Multiple imperfect canonicalizers and hard operator retrieval | U5.R2D1 | Six canonicalizers, independent 72-cloud neutral bank, ridge vs hard Top-1/sparse Top-3; at least three of four practical hypotheses must independently pass and agree, otherwise unidentified |
