...
| U6.P3D | contract frozen / implementation ready | Separate backing reflection from forward-scatter energy redistribution as bounded second-pass layer exposure | P1A/P3A retained + official anti-halation mechanism evidence | float64 synthetic reference only; positive finite PSF mixtures, per-source return-energy bounds, exact zero-return identity, impulse/edge/scale controls and old P1A comparator. No photo fitting, named-stock or product claim |
