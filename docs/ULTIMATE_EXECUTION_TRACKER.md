...
| U5.R2AN2 | ready | Challenge fixed soft-L1 with a preregistered deterministic two-stage sparse-outlier rejection paired fitter | AN1 absolute pass / one relative failure + AO4M close | synthetic paired-recovery witnesses only; freeze residual score, rejection fraction, minimum retained groups and refit before execution; no proxy/photo use until pass |
