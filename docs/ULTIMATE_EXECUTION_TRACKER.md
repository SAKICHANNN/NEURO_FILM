...
| GOV.GCP1 | complete: authorization and ownership namespace frozen / zero cloud mutation | Establish autonomous GCP budget, ownership, liveness, cost and cleanup governance | explicit user authorization | USD 2,000 hard ceiling; prefix `nfg019f4b76`; foreign resources read-only; exact ledger required before stop/delete; paid-idle forbidden; no resource created and accounted spend remains USD 0; `docs/ops/GCP_AUTONOMOUS_COMPUTE_GOVERNANCE_2026.md` |
