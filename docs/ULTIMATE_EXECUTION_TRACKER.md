...
| U5.R2AL1 | ready: freeze synthetic capacity contract | Compare clean-room analytic chroma-sector curves with global-curve and existing explicit-operator controls | AL0 prior-only decision | freeze colour space, sectors, chroma gate, curve/parameter budget, truths, split, optimiser and structural/relative-capacity gates before implementation; zero photograph, film-pixel or external asset access |
