...
| U6.P5D | ready | Stress the combined P5C spatial chain on held-out synthetic structures, partitions and rights-cleared photographic inputs | P5C pass | severe-artifact first; compare zero-adjacency and wrong-order controls, no product integration from charts alone |
