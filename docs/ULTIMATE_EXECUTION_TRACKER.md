...
| U5.R2F2 | in progress: contract frozen | Data-independent bounded projection frontier over immutable predicted LUTs | U5.R2F1 | Exact 9 refs x 3 policies x 9 gold; node-clip control plus two prefix-safe identity contractions; structure/Jacobian and unchanged frontier gates; no inference/training; `docs/planning/U5_R2F2_PROJECTED_LUT_FRONTIER_CONTRACT.md` |
