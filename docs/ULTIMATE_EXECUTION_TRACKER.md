...
| U5.R2H0C3 | contract frozen; implementation next | External measured-spectrum replication | U5.R2H0C2 | Official USGS splib07a 20.8MB public-domain measured ASCII passes hash/rights/overlap and pre-target support: 1,732 eligible queries, 184/10.62% within frozen CAVE-bank T=1 across seven chapters. Fixed cross-source CAVE-bank evaluator and performance gates are preregistered before target rendering; no USGS bank rows, retuning, neural rescue, film or visual claim; `docs/U5_R2H0C3_EXTERNAL_SPECTRUM_REPLICATION_CONTRACT.md` |
