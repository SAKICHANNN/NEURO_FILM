...
| U5.R2D | ready: freeze data-independent audit | StatLUT-style statistics-to-explicit-LUT shortcut and representation audit | U5.R2B, U5.R2C local tooling | Reproduce non-generative descriptor/operator ideas on synthetic known operators; prove shuffle invariance separately from content/palette shortcut; no stock pixels/fitting/training claim |
