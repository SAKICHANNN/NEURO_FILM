...
| U1.2A | frozen/ready | Reject embedded ICC conversion failure instead of discarding the profile and continuing | U1.2 | PNG/JPEG malformed ICC and renderer no-output fixtures; ordinary SDR/profile regressions and full CPU suite pass |
