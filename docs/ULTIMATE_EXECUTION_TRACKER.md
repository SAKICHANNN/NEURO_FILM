...
| U5.R2G0 | next ready: contract required | Constrained explicit distillation of immutable ML LUT controls | U5.R2F2 | Fit only a fixed synthetic colour grid into a bounded explicit family; compare raw target, uniform contraction and distillation; no real-film fitting/training/stock claim |
