...
| SF0.8 | in progress: YFCC15M metadata gate | Obtain a third rights-complete, source-diverse stock without weakening Commons gates | SF0.7 | Commons family/small-stock preflights fail; freeze and scan 1.738GB YFCC15M metadata under exact phrase + CC-BY + UID gates before any pixels; no 61GB full-index download if subset has no pass |
