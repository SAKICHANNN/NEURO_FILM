...
| U1.2C | contract frozen / implementation ready | Reject multi-frame/page raster inputs instead of silently taking frame zero | U1.2B | GIF/TIFF multi-frame rejection before decode, renderer no-output and single-frame regression; no animation/video/stack claim; `docs/planning/U1_2C_MULTIFRAME_FAIL_CLOSED_CONTRACT.md` |
