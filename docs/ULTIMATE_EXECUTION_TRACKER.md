...
| U1.3A | ready: contract frozen | Opt-in float safe-Lab path to true PNG/TIFF16 without changing default 8-bit compatibility | U1.1/U1.3 primitives | `docs/planning/U1_3_HIGH_PRECISION_RENDER_CONTRACT.md`; no uint8-to-uint16 shortcut or calibrated claim |
