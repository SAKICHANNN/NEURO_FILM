...
| SF0.6 | ready: source expansion | Obtain >=2 additional exact stocks with explicit derivative rights and independent author/content support | SF0.5 | each stock >=8 files, >=5 author groups, <=60% largest group, clean pixels; no training until >=3 total stocks pass |
