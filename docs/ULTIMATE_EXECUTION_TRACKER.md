...
| RF2.S0 | ready: Look-Approximation falsification only | Freeze all-roll Gold archive-display matrix and test bounded transplant on existing digital gold/stress images | RF1.4B1 | matched simple-enhancement controls, style floor, severe veto and explicit no-stock-authenticity ceiling |
