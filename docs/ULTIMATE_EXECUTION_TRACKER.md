...
| U5.R2B | ready: freeze contract | Strong global operator frontier | U5.R2A, U5.R1 | Freeze strongest eligible global policy under identical renderer/export, independent severe-artifact and target-look gates; current stock pixels remain closed to fitting |
