...
| U5.R2AQ2 | ready | Compare the simplest explicit recorder-to-measured-slide proxy baselines under complete held-target-set evaluation | AQ1 identifiability pass | freeze six leave-one-set-out folds, development-only normalization/fits and identity/basic/affine/positive-matrix/two-matrix baselines first; no camera/stock/calibration/photo claim |
