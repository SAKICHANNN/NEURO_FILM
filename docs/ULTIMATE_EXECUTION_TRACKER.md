...
| U5.R2AP0 | contract frozen / implementation ready | Test one bounded Ektachrome display-proxy operator on the unused 56-pair palette with complete-row holdouts and a Velvia direction control | AO8D/AO9 closure + AO4P exact source | Six immutable palette-row folds; pass requires one-matrix improvement over identity/full affine, structure/range, repeat and non-strength-duplicate direction gates. No photographs or stock claim before pass |
