...
| U5.R2AN0 | ready: paired fitter contract frozen | Recover the existing two-matrix positive-film operator from controlled paired observations and compare a one-matrix ablation | AM1 representation close + J0 primitive + 2025 real-paired method evidence | synthetic known-truth only: 96 patch groups, three illuminants, 11 exposure levels, complement-held groups; `.005` confirmation RMSE and 20% ablation gain frozen before implementation; no real-film or calibrated claim |
