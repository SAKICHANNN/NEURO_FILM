...
| U6.P3G | active: contract frozen | Prevent backing-return double counting inside a fixed exposure-development-interpretation chain | P3F pass + frozen P1/U2.2/P3D profiles | compare no-spatial, legacy P1-full, forward-only+additive and forbidden P1-full+additive on all 18 CC0 rows; no fitting or product promotion |
