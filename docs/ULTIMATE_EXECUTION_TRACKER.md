...
| U6.P4 | ready | Compile P1B dye-cloud/silver references to density-conditioned NPS/ACF-preserving runtime structure | P1B pass + U6.2B negative | Compare density means, NPS bands, ACF, resolution/partition determinism and salt-speckle negative; never add display-RGB noise |
