...
| U1.6 | in progress: safe-Lab/simple-halation passes | Halo-aware tile/cache renderer | U1.3 | U1.6A execution, U1.6B safe-Lab and U1.6C simple-halation are numerically proven; physical/grain/dust effects, integration, streaming/cache and bounded total memory remain pending |
