...
| U6.P3F | active: contract frozen | Stress P3E on the existing 18-image/nine-make CC0 population without fitting | P3E numerical pass + exact P5D source lineage | input/hash, nonnegative/direct-retention, analytic increment, 257/509-row parity, isolated-excursion and nine-image autonomous severe-veto gates |
