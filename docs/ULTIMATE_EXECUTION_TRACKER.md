...
| U6.P5C | ready | Challenge the closed linear-unsharp adjacency profile with a density-dependent, analytically bounded chemical-spread correction | P5B closure | separate preregistration; unchanged halo gates and zero-adjacency fallback, no clipping or profile relabel |
