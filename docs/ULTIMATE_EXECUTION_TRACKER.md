...
| U6.P2A | ready | Reuse-map U2.2 and freeze typed generic negative/slide/B&W exposure-development-interpretation contract | P0/P1 + U2.2/U2.4A | no duplicate tone curve; identity/domain/wrong-branch tests; unknown process remains generic/hypothesis-only |
