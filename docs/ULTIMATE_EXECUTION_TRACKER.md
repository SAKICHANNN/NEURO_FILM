...
| U5.R2AM1 | ready: freeze synthetic capacity contract | Test a bounded SO(3)-conjugated monotone-curve operator against explicit global controls | AM0 prior-only decision | preregister matrix/curve budget, synthetic truths, controls, split, fit and exact cube/Jacobian/analytic-inverse/replay/neutral/hue/ramp/strength/two-process gates before implementation; zero photograph, film-pixel, external code/checkpoint or learned content adaptation |
