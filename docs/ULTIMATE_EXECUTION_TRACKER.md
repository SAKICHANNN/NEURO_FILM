...
| U1.6 | in progress: integration/grain children pending | Halo-aware tile/cache renderer | U1.3 | U1.6A-D prove execution, safe-Lab, simple-halation and sparse dust numerical parity; physical/grain effects, ordered integration, streaming/cache and bounded total memory remain pending |
