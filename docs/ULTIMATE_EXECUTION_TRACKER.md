...
| U5.R2AI1S | contract frozen / acquisition ready | Establish an independent rights-cleared digital-photo/OOD population before confirmation | R2AI0 development pass | 18 exact CC0 raw.pixls rows / ~259MB / nine makes; hash/decode, >=16 rows/8 makes, zero exact+dHash overlap and autonomous content/severe source audit; no operator render or replacement; `docs/planning/U5_R2AI1S_RAWPIXLS_CONFIRMATION_SOURCE_PREFLIGHT.md` |
