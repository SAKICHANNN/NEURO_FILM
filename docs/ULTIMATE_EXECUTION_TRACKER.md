...
| U5.R2D | in progress: contract frozen | StatLUT-style statistics-to-explicit-LUT shortcut and representation audit | U5.R2B, U5.R2C local tooling | Paper-compatible 2,304-D Lab statistics; exact permutation property, explicit palette dependence and absent-colour two-LUT non-identifiability counterexample; no download/GPU/training/stock claim |
