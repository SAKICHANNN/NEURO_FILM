...
| SF0.6 | in progress: metadata sweep contract frozen | Audit ten new exact Commons stock categories for true-author and derivative-rights support | SF0.5 | >=2 new stocks must independently have >=8 strict derivatives, >=5 authors and <=60% dominance before any pixels |
