...
| U5.R2H0A | next ready: frozen contract | Velvia 50 datasheet spectral witness numerical identifiability pilot | U5.R2H0 | Versioned graph digitization/overlay plus clean-room smooth spectrum and D65-metamer stress; synthetic only. Stop as unidentified if canonicalizer dominates; no visual tuning, fitting, stock truth or product claim |
