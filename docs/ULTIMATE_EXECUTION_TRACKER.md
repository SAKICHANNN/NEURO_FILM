...
| U2.2 | in progress: U2.2A contract frozen | Monotone exposure/sensitometry curves | U1.4, U2.1 | U2.2A preregisters a clean-room linear-exposure-to-layer-density primitive with explicit black offset, neutral gauge, analytic inverse/Jacobian and descriptive toe/mid/shoulder witness; no stock fit or renderer integration; `docs/U2_2A_SENSITOMETRY_PRIMITIVE_CONTRACT.md` |
