...
| U5.R2AE1 | in progress: contract frozen | Test whether a source-bound subset forms a replay-stable, non-basic external operator bank on a fixed synthetic cube | AE0 limited pass | eight document-associated chains, exact runtime/pipeline, duplicate/strength controls and replay/folding/range/matched-basic family-diversity gates are frozen before formal metrics; implement isolated runner/evaluator next; `docs/U5_R2AE1_SPECTRAL_FILM_LUT_STRUCTURAL_BANK_CONTRACT.md` |
