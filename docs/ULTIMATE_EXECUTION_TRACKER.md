...
| U5.R2AL1 | ready: corrected v3 synthetic capacity contract / implementation | Compare clean-room analytic chroma-sector curves with global-curve and stationary K3 controls | AL0 prior-only decision | v1/v2 remain immutable pre-execution contract corrections; v3 `e4e8e812...6384` hash-binds both and additionally freezes every audit geometry before any fit/metric. Five-sector/16-curve representation, truths, fit, gates and zero photograph/film-pixel/external-asset boundary are unchanged; `docs/planning/U5_R2AL1_ANALYTIC_CHROMA_SECTOR_CURVE_CAPACITY_CONTRACT.md` |
