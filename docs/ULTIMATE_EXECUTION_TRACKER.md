...
| U5.R2G0 | in progress: implementation verified | Constrained explicit distillation of immutable ML LUT controls | U5.R2F2 | Isolated deterministic fitter/replay/structure/frontier path and 768 tests pass; exact 81x2 formal run next; no photograph fitting/training/stock claim; `docs/planning/U5_R2G0_CONSTRAINED_EXPLICIT_DISTILLATION_CONTRACT.md` |
