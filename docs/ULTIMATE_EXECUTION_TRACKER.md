...
| SF0.5 | ready: bounded pixels | Freeze uploader-capped permissive 1600px derivatives for the three exact Commons stocks | SF0.4 | <=192 files/512MiB; hashes/decode/duplicates/content/source groups before training |
