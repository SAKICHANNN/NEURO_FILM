...
| SF2.7R | in progress: acquisition frozen | ColorReference same-physical Velvia 100F slide scanner/software nuisance corpus | official test-data page + exact server headers | acquire at most 71,068,957 exact bytes across five source TIFFs, measured Set 3 references and four scan pipelines; internal nuisance research only; no stock fitting/training/LSM |
...
| U5.R2J1 | in progress: contract frozen | Bounded-strength real-image frontier for the fixed J0 bank | U5.R2J0 | 25 fixed candidates at s0.10..0.35; inherited 9-gold/32-stress gates; blind/full-res review only for survivors against safe-rich and R2E1 |
