...
| U1.6G4H | contract frozen / implementation ready | Research adapter/orchestration parity and lifetime contract | U1.6G4G | direct-module API only; reuse executor/compositor, exact parity, one returned ndarray, ndarray-free metadata, injected failure/no production imports; no CLI/default/100MP claim; `docs/planning/U1_6G4H_RESEARCH_ADAPTER_CONTRACT.md` |
