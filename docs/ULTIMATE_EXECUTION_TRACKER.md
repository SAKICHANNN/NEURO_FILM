...
| U1.6G4B | contract frozen / implementation ready | Row-reader construction of exact G1 global coarse stages | U1.6G1/G3/G4A | coarse-row chunks must request bounded full-width source spans and reproduce full G1 coarse/reconstruction bytes; finite-halo plans fail closed; no effect integration; `docs/planning/U1_6G4B_ROW_CHUNKED_GLOBAL_STAGE_CONTRACT.md` |
