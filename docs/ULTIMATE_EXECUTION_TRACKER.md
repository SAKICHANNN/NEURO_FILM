...
| U6.P2F | ready | Implement a separately typed generic reversal-development primitive rather than reusing increasing-density negative sensitometry | P2C1 slide-polarity close + P2E negative-route close | freeze decreasing-density/reversal semantics on synthetic ramps first; no stock/calibration claim or photo fitting |
