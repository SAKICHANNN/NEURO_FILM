...
| RF1.4 | in progress: contract frozen | Per-stock label/content/nuisance identifiability and leakage-safe holdouts | SF0.3 | `docs/planning/RF1_4_STOCK_IDENTIFIABILITY_CONTRACT.md`; shortcut/null gate first; post-negation preview and display-proxy domains separate; preview-only evidence cannot promote a colour expert |
