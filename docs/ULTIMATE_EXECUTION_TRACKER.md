...
| U5.CT6 | acquisition complete; evaluator freeze next | BlueNeg 8-bit preview/pseudo-GT correct-roll matched-control pilot | CT2/CT3 pass | Exactly 101 files / 118,929,719 bytes pass size/LFS hashes with zero extras; pixels remain undecoded. Correct roll must beat pooled, shuffled, random and two development same-film wrong-roll controls on two held-out Kodak Gold 100-5 rolls; broader claims are unavailable. Evidence: `docs/ROLL2FILM_BLUENEG_ACQUISITION_RESULTS.md` |
