...
| SF1.0A2 | ready: YFCC Ektar pixel bridge | Reverify and audit at most 20 YFCC Ektar100 pixels, max four per UID | SF1.0A | live rights/decode/duplicates/content/vision; if pass connects YFCC Ektar--Velvia and Commons Ektar--UltraMax |
| SF1.0B | data-gated: connected-design identifiability | Falsify Ektar100/UltraMax400/Velvia50 stock signal against source/content/colour shortcuts | SF1.0A2 | bridge-aware support matrix; author holdout; shuffled, grayscale, source, content, low-frequency colour and matched-strength controls; no operator fitting |
