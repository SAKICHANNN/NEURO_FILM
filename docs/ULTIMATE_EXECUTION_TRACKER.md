...
| U2.2 | in progress: U2.2A numerical pass, U2.2B next | Monotone exposure/sensitometry curves | U1.4, U2.1 | Clean-room linear-exposure-to-layer-density primitive passes at 3.73e-14 roundtrip, exact neutral anchor, positive Jacobian and three distinct toe/mid/shoulder curves. Layer density is not RGB; audit explicit interpretation composition next, no stock fit/integration; `docs/U2_2A_SENSITOMETRY_PRIMITIVE_RESULTS.md` |
