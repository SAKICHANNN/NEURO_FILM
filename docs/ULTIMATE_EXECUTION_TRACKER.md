...
| U5.R2AL1 | ready: frozen synthetic capacity contract / implementation | Compare clean-room analytic chroma-sector curves with global-curve and stationary K3 controls | AL0 prior-only decision | config `53fe4134...0559` freezes five continuous D65-Lab sectors, exact neutral gate, 16 degree-six monotone curves, two smooth noncommuting truths, development/confirmation split, deterministic fit, structural/strength/red-ramp and relative-capacity gates; zero photograph, film-pixel or external asset access; `docs/planning/U5_R2AL1_ANALYTIC_CHROMA_SECTOR_CURVE_CAPACITY_CONTRACT.md` |
