...
| U5.R2E0 | ready: source audit and contract | Original density/sensitometry-domain explicit film-inspired operator primitive | U5.R2D2 | Data-independent characteristic curves, dye crosstalk and print/display interpretation; must be strong, bounded and artifact-safe; no external teacher/profile copy or stock claim |
