...
| U5.R2AO1 | ready | Test explicit operators on the real Velvia chart display proxy with leave-one-row-out folds | AO0 pass + AN0 fitter | freeze source-sRGB linearization, six chart-row folds, simple controls and boundary/overfit diagnostics; no stock-response/calibration/product claim |
