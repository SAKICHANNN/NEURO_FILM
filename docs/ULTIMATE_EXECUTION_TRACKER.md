...
| U5.R2S0 | ready: oracle contract frozen | Analytic palette-score forcing through cube-preserving diffeomorphic flow | U5.R2O0 + U5.R2R1 | three fixed Gaussian-mixture palettes, bounded score coefficients and O0 integration must jointly pass density attraction, strength, non-affine distinction, pairwise reference sensitivity, range, Jacobian, inverse and exact replay before any score ML opens; `docs/planning/U5_R2S0_PALETTE_SCORE_DIFFEO_ORACLE_CONTRACT.md` |
