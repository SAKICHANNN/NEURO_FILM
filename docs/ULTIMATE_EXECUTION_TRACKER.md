...
| U1.6G4G | contract design ready | Measured 24MP memory/runtime and orchestration-readiness audit | U1.6G4F | freeze source/image construction, peak-RSS method, runtime budget, output hashes, failure cleanup and no-integration boundary before execution; no 100MP claim |
