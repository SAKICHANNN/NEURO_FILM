...
| U6.P5H | ready: value contract frozen | Decide whether P5F adds enough encoded and blind-visible edge value over P5C to justify later runtime work | P5G severe-clean/weak | Exact sRGB8 visibility, strong-edge opponent gain, edge/flat concentration, max code delta, then three unlabeled 9-pair one-to-one blind rounds. Tie is no preference; every round needs 6/9 and zero severe failures |
