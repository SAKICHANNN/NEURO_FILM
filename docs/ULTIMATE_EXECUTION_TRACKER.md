...
| U5.R2AJ0C0B | ready: corrected frozen controls-only implementation | Conform the strict Hald structural screen without reading an external CLUT body | C0 v1 close | legal N=4/36/144/256 Hald geometries, exact clip/staircase formulas, strict manifest/report/repeat schemas, post-collapse warm/cool novelty and zero-access enforcement are frozen; C1 selection remains deliberately deferred; `docs/planning/U5_R2AJ0C0B_HALD_STRUCTURAL_CONTROL_CALIBRATION_CONTRACT.md` |
| U5.R2AJ0C1 | blocked on C0B pass and separate contract commit | Screen the 194 licensed external Color Halds individually on synthetic structural, matched-basic and novelty evidence | exact C0B pass | use native N=144/256 streaming, per-candidate vetoes, fully frozen intra-component representative/safety/max-min cap-12 selection; no photograph/aesthetic review |
