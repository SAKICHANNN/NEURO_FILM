...
| SF0.6B | in progress: contract frozen | Audit exact Kodachrome25/64, Ektachrome Elite100/200 and Vision3 50D/250D | SF0.6A | metadata only; need >=1 further stock passing >=8 strict derivatives, >=5 authors and <=60% dominance before pixels |
