...
| U5.R2R1 | ready: contract frozen | Published D-LUT trajectory range/orientation audit | U5.R2R0 | hash and parse steps 0--40, audit project tetrahedral and published-compatible trilinear Jacobians twice; no nonidentity survivor closes before image rendering without clamp/projection/smoothing/retraining rescue; `docs/planning/U5_R2R1_D_LUT_PUBLISHED_ASSET_CONTRACT.md` |
