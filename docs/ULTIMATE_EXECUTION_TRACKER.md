...
| SF2.0B0 | ready: contract frozen | Snapshot keyless NASA/JSC STS098 metadata for exact VELVI/5775/5776 queries | SF2.0A close + broader database reconnaissance | max six POST/GET requests, parsed table metadata only; no photo pages/images/fitting/training/LSM; `docs/planning/SF2_0B0_NASA_STS098_STOCK_SNAPSHOT_CONTRACT.md` |
