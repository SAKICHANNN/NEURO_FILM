...
| U5.R2F1 | in progress: implementation verified, formal run ready | Immutable CanonCGT E2E reference-condition and explicit-LUT safety pilot | U5.R2F0, U5.R2E1 | Isolated weights-only adapter passes 760 tests and byte-identical CUDA smoke; two-LUT replay error 0; formal 9x9x2 range/sensitivity/severe audit next; `docs/planning/U5_R2F1_CANONCGT_REFERENCE_CONDITION_CONTRACT.md` |
