...
| U5.CT6 | Lab family frozen; confirmatory ready | BlueNeg 8-bit preview/pseudo-GT correct-roll matched-control pilot | CT2/CT3 pass | Development-only selection chooses Lab mean/std (`Delta-E=5.576`, style `5.184`) over stronger but unstable pooled L2; confirmatory pixels remain unopened. Run only the frozen matched controls next. Evidence: `docs/ROLL2FILM_BLUENEG_DEVELOPMENT_RESULTS.md` |
