...
| U1.6 | in progress: grain/global-context child next | Halo-aware tile/cache renderer | U1.3 | U1.6A-D prove execution, safe-Lab, simple-halation and sparse dust numerical parity; U1.6E closes because halation/dust order is not output-identifiable; physical/grain effects, full orchestration, streaming/cache and bounded total memory remain pending |
