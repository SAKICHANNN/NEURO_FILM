...
| U6.P3E | active: contract frozen | Compile the frozen P3D additive return into a deterministic float32 separable Standard kernel | P3D reference/decision exact identities pinned; no profile fitting or photographic gate | must pass float64-reference error, returned-energy, positivity, linearity, zero-return identity, repeat and exact row-partition gates before P3F |
