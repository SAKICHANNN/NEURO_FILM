...
| U2.2 | in progress: U2.2B contract frozen | Monotone exposure/sensitometry curves | U1.4, U2.1 | U2.2A passes. U2.2B freezes a non-duplicative composition with existing project-owned dye/print/paper parameters: U2.2A owns capture/negative curves exactly once; bounded/non-affine/Jacobian/parity gates precede evaluation; `docs/U2_2B_SENSITOMETRY_PRINT_COMPOSITION_CONTRACT.md` |
