...
| U5.R2S1D | ready: development contract frozen | Canonical-histogram hard case retrieval and query-density controls | U5.R2S0 | 384 synthetic bank cases and 96 development queries compare hard Hellinger/JS retrieval, Top-3 blend, four KDE bandwidths and global mean using only permutation-invariant colour counts; seed 27012 stays untouched until a confirmatory contract is committed; `docs/planning/U5_R2S1_HISTOGRAM_CASE_RETRIEVAL_DEVELOPMENT_CONTRACT.md` |
