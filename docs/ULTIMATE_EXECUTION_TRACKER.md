...
| U6.P2E | ready | Challenge scale-16 with the unchanged U2.2 reference gauge (`display-linear x1`, 0.18 remains reference) | P2D visual close + U2.2 encoder contract | freeze before render; unchanged routes/print/scanner/severe veto; no photo fitting |
