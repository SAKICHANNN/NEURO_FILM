...
| U5.R2S2D | ready: content-nuisance development frozen | Recover a shared style flow across independent content scenes with unpaired matched-neutral controls | U5.R2S1C + real scene-colour shortcut evidence | 384 train/96 dev styles, two independent dev content replicates; compare raw KDE, three density-ratio scales, three bounded ridge models and global mean. Seed 28105 untouched; no pixels/neural RGB; `docs/planning/U5_R2S2_CONTENT_PALETTE_NUISANCE_DEVELOPMENT_CONTRACT.md` |
