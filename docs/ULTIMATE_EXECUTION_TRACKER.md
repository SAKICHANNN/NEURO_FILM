...
| U6.P3K | active: contract frozen | Measure tile-512 streamed FFT at 24MP without a full output/memmap | P3J functional pass | two fresh runs; require <=1GiB peak, <=10s median stream, <=1.15 wall repeat ratio, exact source/output hashes and coverage |
