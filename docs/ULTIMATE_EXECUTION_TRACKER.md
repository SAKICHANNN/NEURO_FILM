...
| U5.R2H0C | next ready: data/source audit | Measured-natural-reflectance conditional spectral variability | U5.R2H0A negative evidence | Test whether rights-eligible measured natural/material spectra at similar D65 RGB have materially narrower Velvia-witness variation than theoretical extrema; preserve non-identifiability and no film-pixel fitting |
