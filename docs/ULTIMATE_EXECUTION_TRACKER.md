...
| U1.6G4E | contract frozen / implementation ready | `staged-density-halation-v1-defaults` executor | U1.6G3/G4D | fixed defaults only; G2 percentile, G4A gradients, G4C global contexts and bounded direct local fields; staged-v2/legacy/resource/full-res visual gates frozen on separate confirmatory cases; no renderer integration; `docs/planning/U1_6G4E_STAGED_DENSITY_EXECUTOR_CONTRACT.md` |
