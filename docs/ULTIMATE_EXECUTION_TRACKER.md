...
| U5.R2C | ready: contract/budget feasibility only | B1 complete fixed-bank cross-rater empirical-ceiling policy and annotation budget | U5.R2B | Freeze complete-policy selection/evaluation separation, identity fallback and feasible `N*K*r` budget; actual recruitment/external annotation remains separately authority-gated |
