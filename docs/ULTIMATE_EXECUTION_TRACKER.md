...
| U6.P2D | ready | Stress negative-neutral-scan, negative-print and slide routes on the fixed 18-image/nine-make CC0 population | P2C pass + P3F source lineage | display-derived pseudo-exposure only; severe veto, clipping, structure and fixed visual review before retention |
