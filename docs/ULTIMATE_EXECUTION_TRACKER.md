...
| SF0.4 | in progress: metadata contract frozen | Audit Commons exact Ektar100/Superia X-TRA400/Gold200 plus Velvia-family control | RF2.S0 close | per-file rights/source/SHA1, uploader dominance and permissive subset; metadata only; `docs/planning/SF0_4_COMMONS_STOCK_SOURCE_AUDIT_CONTRACT.md` |
