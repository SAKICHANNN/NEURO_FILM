...
| SF1.0B | ready: connected-design identifiability | Falsify Ektar100/UltraMax400/Velvia50 stock signal against source/content/colour shortcuts | SF1.0A2 | four-cell bridge matrix; author holdout; shuffled, grayscale, source, content, low-frequency colour and matched-strength controls; no operator fitting |
