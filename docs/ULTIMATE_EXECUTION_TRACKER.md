...
| U5.CT5 | in progress; evaluator contract frozen | Matched-strength deterministic/classical baselines plus Roll2Film solver on FilmSet internal dev | CT2/CT3/CT4 | Frozen v1 ladder/folds/metrics/promotion rules: `docs/data/ROLL2FILM_CT5_BASELINE_EVALUATOR_CONTRACT.md`; implement fail-closed loaders and CPU baselines before opening internal-dev targets; official 628 remains sealed |
