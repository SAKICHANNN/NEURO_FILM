...
| U1.6G4G | contract frozen / implementation ready | Measured 24MP memory/runtime and orchestration-readiness audit | U1.6G4F | analytic chunked source; child peak RSS <=4GiB, worker <=90s, executor <=75s, composite <=15s; repeat hashes and atomic failure cleanup; no integration/100MP claim; `docs/planning/U1_6G4G_24MP_RESOURCE_AUDIT_CONTRACT.md` |
