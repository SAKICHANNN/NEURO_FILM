...
| U6.P3H | active: contract frozen | Challenge the isolated P3E large-radius direct compiler with a fixed float32 2D FFT implementation | P3E numerical pass; P3G combined topology remains closed | must match P3D/P3E, retain positivity/identity, and meet 257/509-row seam tolerances before any separate performance claim |
