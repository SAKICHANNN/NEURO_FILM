...
| U5.R2H2 | next ready: contract required | Exact hard-1NN full-resolution and blind visual diagnostic | U5.R2H1 | Freeze existing predictions/renders; blind disagreement panel plus all-41 severe inspection; no model, bank, feature or label change |
