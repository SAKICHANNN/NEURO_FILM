...
| U5.R2G1 | in progress: contract frozen | Fixed output-quantization headroom over immutable G0 operators | U5.R2G0 | Exact `h=1/255` affine interior map only; immutable 81 operators; structural, retention, unchanged frontier and conditional visual gates; no refit/capacity/image data; `docs/planning/U5_R2G1_QUANTIZATION_HEADROOM_CONTRACT.md` |
