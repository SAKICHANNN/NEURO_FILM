...
| U5.R2H0C2 | active: contract frozen | Group-held-out simple measured-spectrum canonicalizer comparison | U5.R2H0C1 | Fixed leave-one-scene-out hard Top-1 vs smooth baseline, thresholds 0.5/1/2/3 with OOD fallback and scene-bootstrap gates; known witness targets only; `docs/U5_R2H0C2_HARD_SPECTRUM_CANONICALIZER_CONTRACT.md` |
