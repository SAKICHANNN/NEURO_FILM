...
| U1.6G3 | contract frozen / implementation ready | Physical/density field DAG, blur classification and lifetime/resource plan | U1.6G0/G1/G2 | preserve separate 8-blur/2-percentile colour and 6-blur/1-percentile density graphs; distinguish finite-halo from global-grid fields and fail readiness until row-chunked global staging exists; `docs/planning/U1_6G3_HALATION_FIELD_DAG_LIFETIME_CONTRACT.md` |
