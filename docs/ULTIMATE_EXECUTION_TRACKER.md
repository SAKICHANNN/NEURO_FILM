...
| U5.R2AI1 | ready: freeze confirmation contract | Confirm the one frozen R2AI0 composition on the independent population | R2AI0 + passed R2AI1S | bind exact 17-row source decision before render; unchanged order/s0.50/margin/comparators and preregistered automatic/blind/full-resolution severe gates; no retuning or stock/product claim |
