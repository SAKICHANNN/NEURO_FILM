...
| U6.P6L | ready: source contract frozen | Acquire and audit a minimal CC-BY-4.0 three-repeat scan of one historical plate, then test whether registered repeat residuals constrain P6A scanner noise | P6K nuisance result + new University of Chicago repeat-scan source | exact 88,475,062-byte acquisition; equal decode and registered correlation >=.995; only then residual NPS/ACF/row-column analysis. No stock, grain, scanner-calibration, colour or product claim |
