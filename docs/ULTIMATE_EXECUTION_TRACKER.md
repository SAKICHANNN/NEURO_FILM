...
| SF0.4 | ready: source refresh | Find obtainable multi-source named-stock positive scans for an unpaired retrieval/explicit-operator pilot | RF2.S0 close | primary-source label/rights/group/size audit; no purchase, no stock claim before nuisance controls |
