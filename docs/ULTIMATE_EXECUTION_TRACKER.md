...
| U5.R1A | contract frozen; implementation ready | ChromaticTail/FilmStyleSafe ontology, annotation schema, split and sampling/preregistration worksheet | U4 foundation | Frozen colour-vs-style-vs-structural ontology, conservative label escalation, A0/A1/B0-B4 barriers and non-binding power worksheet; current U4/RF2.C0 evidence is A0-only; `docs/planning/U5_R1A_FILMSTYLESAFE_ONTOLOGY_CONTRACT.md` |
