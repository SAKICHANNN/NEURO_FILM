...
| U5.R2AG1 | contract frozen / implementation ready | Test 16-anchor bounded convex-gradient map on the exact O0 synthetic controls | AG0 feasibility + O0 benchmark | fixed 65 scalars, tau .15, alpha<=.65, 8-cube development/11-cube confirmation and O0 gates; no images, unpaired fit, ICNN, capacity growth or stock claim; `docs/planning/U5_R2AG1_BOUNDED_CONVEX_GRADIENT_CONTRACT.md` |
