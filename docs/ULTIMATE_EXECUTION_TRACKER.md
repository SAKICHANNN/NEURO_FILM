...
| U1.6G4H | contract design ready | Research adapter/orchestration parity and lifetime contract | U1.6G4G | freeze isolated API, current-compositor parity, lifetime ownership, atomic failure and no-CLI/default boundary before implementation; 100MP remains later |
