...
| U1.6 | in progress: physical/orchestration children pending | Halo-aware tile/cache renderer | U1.3 | U1.6A-D/F prove execution, safe-Lab, simple-halation, sparse dust and disk-staged grain parity; U1.6E closes on order identifiability; physical halation, orchestration, streaming/cache and bounded total memory remain pending |
