...
| U5.R2F2 | ready: freeze contract | Data-independent bounded projection frontier over immutable predicted LUTs | U5.R2F1 | No new inference/training; freeze node gamut projection plus identity contraction, audit monotonicity/Jacobians and retain unchanged R2B style/non-basic/clipping gates |
