...
| RF1.4B | ready | Gold100 display-proxy paired-transform identifiability | RF1.4A | preregister whole-roll paired consistency/correct-pair/wrong-roll controls; no inherited preview claim |
