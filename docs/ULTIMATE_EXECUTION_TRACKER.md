...
| SF1.0B | in progress: frozen diagnostic | Falsify Ektar100/UltraMax400/Velvia50 stock signal against source/content/colour shortcuts | SF1.0A2 | four cells/104 files; group-centroid LOO; RGB primary versus luma/HOG/geometry controls, 499 group permutations and 4,000 paired bootstraps; no operator fitting |
