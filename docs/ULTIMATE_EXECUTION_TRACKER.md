...
| U1.6G4D | ready | Bind executable G4A/G4C capabilities to G3 and freeze the simplest staged density-family executor | U1.6G3/G4A/G4C | prove static readiness from real exported capabilities, preserve colour/density separation, then preregister effect parity/resource/visual gates before writing an executor |
