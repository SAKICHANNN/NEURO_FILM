...
| U5.CT5 | in progress; sampled confirmatory complete | Matched-strength deterministic/classical baselines plus Roll2Film solver on FilmSet internal dev | CT2/CT3/CT4 | Universal pooled L2 fails. Fixed recipe finalists: Lab for Cinema; pooled L2 for ClassNeg/Velvia. Cluster-bootstrap fidelity/style gates pass, but full-resolution severe/artifact adjudication remains. Official 628 remains sealed. Evidence: `docs/ROLL2FILM_CT5_CONFIRMATORY_RESULTS.md` |
