...
| U5.R2AC1 | frozen / ready | Test a new bounded shared-resource spatial representation | AC0 mechanism-only decision | dimensionless 24-step reaction + five-point diffusion system, fixed patterns/controls and identity/neutral/symmetry/range/effect/ringing gates. No Filmulator code/constants or photographs; `docs/U5_R2AC1_SHARED_RESOURCE_DIFFUSION_CONTRACT.md` |
