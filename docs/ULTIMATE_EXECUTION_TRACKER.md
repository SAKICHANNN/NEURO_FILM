...
| U1.6G4C | contract design ready | Separately versioned chunk-invariant deterministic area reducer | U1.6G4B | freeze one explicit reduction order shared by materialised and row-reader builders; fresh parity, cross-chunk, visual/severe and compatibility gates are required before G3 readiness or effect integration |
