...
| U5.R2E1 | in progress: contract frozen | Bounded-strength density-witness gold/stress frontier | U5.R2E0 | Exact 5x4 bank; unchanged R2B screen; one strength per witness and max-three shortlist; preserve ID11 and all-nine full-res veto; no fitting/stock/production claim |
...
| U5.R2F1 | conditional ready after E1 | Immutable CanonCGT E2E reference-bank and explicit-LUT safety pilot | U5.R2F0, U5.R2E1 adjudication | Freeze reference rights/hashes before inference; no training; test LUT range, clamp, reference sensitivity, style/non-basic value and full severe veto |
