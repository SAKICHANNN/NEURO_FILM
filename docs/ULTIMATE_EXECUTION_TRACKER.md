...
| SF1.3A | ready: bounded pixels | Acquire and integrity-audit at most 38 derivatives/512MiB across the eight SF1.2 UIDs and two stocks | SF1.2 pass | >=8 files/stock, >=5 bilateral pixel authors, duplicates/content/vision audited; no fitting/training |
