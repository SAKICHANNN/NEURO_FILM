...
| U5.R1C3 | frozen: ready | Conditioned style-control calibration protocol for SCIS without excluding 53/55/56 | U5.R1C2 | compare fixed robust affine/quadratic pairwise Lab canonicalizers; simplest 3/3-at-zero-FPR candidate only; no hidden A1, recruitment, training or gate promotion |
