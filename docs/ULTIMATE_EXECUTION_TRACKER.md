...
| U1.6G4D | contract frozen / implementation ready | Bind executable G4A/G4C providers to G3 capability vocabulary | U1.6G3/G4A/G4C | exact module/symbol/version/callability bindings must resolve the two required names and make both family plans statically ready without changing default fingerprints/resources; no graph execution; `docs/planning/U1_6G4D_HALATION_CAPABILITY_BINDING_CONTRACT.md` |
