...
| U5.R2AH1D | contract required | Development-test a small group-invariant reference-only O0-parameter predictor | AH0 feasibility | must beat identity/global/W1 controls, suppress held-out content/nuisance probes, preserve identity/53-55-56 and all O0 structure; failure closes without model/loss/seed rescue |
