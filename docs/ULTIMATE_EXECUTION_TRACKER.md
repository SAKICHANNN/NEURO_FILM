...
| U5.R2AJ0C1 | ready: separate contract design only | Screen the 194 licensed external Color Halds individually on synthetic structural, matched-basic and novelty evidence | exact C0B pass | freeze native N=144/256 streaming, per-candidate vetoes, fully specified intra-component representative/safety/max-min cap-12 selection and strict evidence before any primary member body or metric is read; no photograph/aesthetic review |
