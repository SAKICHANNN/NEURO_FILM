...
| U6.P6A | ready | Freeze an explicit scanner nuisance/output-profile boundary separate from film stock and development | P5D pass + P2 interpretation contract | generic synthetic profiles only; distinguish illuminant/spectral matrix, flare, Dmax, MTF and noise, with identity and wrong-profile controls |
