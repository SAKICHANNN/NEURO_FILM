...
| SF0.3 | ready | Decode integrity, duplicate/border/content and stock×roll×proxy support audits | SF0.2 | decide density-only vs display-operator eligibility per stock; no colour fit |
...
| RF1.4 | blocked on SF0.3 | Per-stock label/content/nuisance identifiability and leakage-safe holdouts | SF0.3 | correct stock must beat pooled, wrong-stock, generic historical, retrieval and nuisance controls |
