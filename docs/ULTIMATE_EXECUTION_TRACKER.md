...
| U1.4C1 | in progress: shared-kernel pass | Extract working-space-aware D65 Lab colour kernel with legacy parity | U1.4C0 | U1.4C1A/B pass conversion and pure-kernel/frozen-legacy gates; destination-space gamut and Rec.2020 styled witness remain open; six colour styles only, no effects/renderer/schema claim |
