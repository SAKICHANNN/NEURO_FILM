...
| U5.R2AO7 | ready | Confirm the one fixed AO6 champion on the independent raw.pixls.us OOD population | AO6 development pass + AI1S source pass | freeze exact 17 eligible rows and fixed B0 comparator; no refit, threshold change, development-image reuse or claim increase |
