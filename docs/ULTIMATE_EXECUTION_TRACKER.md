...
| U5.CT2 | in progress; FilmSet portion complete | FilmSet/BlueNeg eligibility, grouping, licence snapshot and pair-blinding contract | U0.3; FilmSet local, BlueNeg metadata-only | FilmSet manifests, hashes, zero cross-pool leakage and training-role enforcement pass; BlueNeg metadata/whole-roll contract remains. Evidence: `docs/ROLL2FILM_FILMSET_EVIDENCE_FREEZE.md` |
...
| U5.CT5 | pending on CT3 baseline freeze | Matched-strength deterministic/classical baselines plus Roll2Film solver on FilmSet internal dev | CT2/CT3/CT4 | FilmSet gate passed. Best-basic/style floor must be frozen before internal hidden-pair evaluation; official 628 remains sealed |
