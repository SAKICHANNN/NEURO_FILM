...
| U6.P2D | ready | Stress surviving negative-neutral-scan and negative-print routes on the fixed 18-image/nine-make CC0 population | P2C1 branch + P3F source lineage | display-derived pseudo-exposure only; severe veto, clipping, structure and fixed visual review. Slide closed; B&W remains neutral-silver data-gated |
