...
| SF2.0C0 | frozen/ready | Cross-mission NASA/JSC exact-code mission×stock×roll connectivity census | SF2.0B0 close + reusable keyless source client | six metadata requests max; aggregate-only output; no photos/pixels/fitting/training/LSM |
