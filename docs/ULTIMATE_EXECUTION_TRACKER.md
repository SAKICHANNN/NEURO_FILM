...
| U1.4C1 | in progress: Lab primitive pass | Extract working-space-aware D65 Lab colour kernel with legacy parity | U1.4C0 | U1.4C1A passes conversion/reference gates; shared kernel, Rec.2020 gamut/styled witness remain open; six colour styles only, no effects/renderer/schema claim |
