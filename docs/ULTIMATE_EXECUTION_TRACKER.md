...
| U5.R2AZ0/AZ1 | AZ0 development pass; AZ1 ready | Factor fixed AO5 proxy residual in optical-density neutral/opponent coordinates and compare at unchanged `.15/.35` strengths against AO6 | AO6 linear-RGB t15/c35 | automatic style/non-basic gain, zero new clipping, 2/3 blind rounds at >=6/9 and zero severe artifacts | retain development champion only; exact fresh-population confirmation before any product decision |
