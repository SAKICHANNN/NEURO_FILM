...
| U5.R2AI0 | contract frozen / implementation ready | Test a fixed sequential composition of the two severe-clean global B0 champions | R2B anchor56 margin-4 + R2E1 density-cyan | exactly two orders x three inherited density strengths, final margin-4, no fitting/routing; must materially beat E1 on style and non-basic views, repeat exactly and pass full ID11/severe visual veto; `docs/planning/U5_R2AI0_DUAL_CHAMPION_GLOBAL_COMPOSITION_CONTRACT.md` |
