...
| U5.R2C | in progress: contract frozen, local tooling only | B1 complete fixed-bank cross-rater empirical-ceiling policy and annotation budget | U5.R2B | `K=7`, identity fallback, disjoint panels, all-scene tie score and 54N--78N non-binding workload frozen; no B1 pixels/recruitment/outcomes or R3 |
