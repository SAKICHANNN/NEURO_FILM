...
| U1.6G4F | contract design ready | Explicit new-operator value/safety audit on fresh confirmatory cases | U1.6G4E | treat v2 as separate behavior rather than legacy replacement; preregister fresh cases, product-value/style, severe, resource/runtime and fallback gates; legacy drift remains reported; no renderer integration by implication |
