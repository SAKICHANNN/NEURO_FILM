...
| U2.4 | pending: interface child ready | Negative/slide/B&W interpretation plugin boundary | U2.1A | U2.4A may establish a synthetic-test-only fail-closed extension boundary; real operators/profiles remain evidence-gated |
| U2.4A | ready: contract frozen | Pure interpretation request/result/registry boundary with three synthetic witnesses | U2.1A/U2.5/U2.6 | negative/slide/B&W test-only plugins must pass determinism/domain/immutability gates and fail production eligibility; zero renderer/schema/profile integration |
