...
| U5.R2G1 | next ready: contract required | Fixed output-quantization headroom over immutable G0 operators | U5.R2G0 | One preregistered interior affine map; no refit/capacity/image data; must retain style and eliminate raw-range/RGB8 clipping failures |
