...
| U5.R2AI1S | contract + implementation ready / acquisition next | Establish an independent rights-cleared digital-photo/OOD population before confirmation | R2AI0 development pass | resumable exact 18-row CC0 download, neutral decode, explicit unknown lineage, >=16 rows/8 makes, zero exact+dHash overlap and autonomous content/severe source audit; no operator render or replacement; 1046 tests; `docs/planning/U5_R2AI1S_RAWPIXLS_CONFIRMATION_SOURCE_PREFLIGHT.md` |
| U5.R2AI1 | pending R2AI1S pass | Confirm the one frozen R2AI0 composition on the independent population | R2AI0 + R2AI1S | unchanged operator and no threshold retuning; require repeat, clipping/OOD and full-resolution severe evidence before any product consideration |
