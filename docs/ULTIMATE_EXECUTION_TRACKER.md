...
| SF2.7A | ready: freeze quantification | Same-slide scanner/software nuisance separability and canonicalization audit | SF2.7R | patch/alignment plus leave-one-slide-out raw-vs-bounded-canonicalizer evidence; nuisance control only, no stock fit |
