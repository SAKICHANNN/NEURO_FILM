...
| U5.R2G1 | in progress: implementation verified | Fixed output-quantization headroom over immutable G0 operators | U5.R2G0 | Exact `h=1/255` explicit replay/audit path and 770 tests pass; formal 81x2 next; no refit/capacity/image data; `docs/planning/U5_R2G1_QUANTIZATION_HEADROOM_CONTRACT.md` |
