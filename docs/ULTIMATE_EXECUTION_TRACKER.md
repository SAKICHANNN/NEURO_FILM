...
| U1.2B | contract frozen / implementation ready | Reject real raster transparency instead of falsely claiming discarded alpha is preserved | U1.2A | RGBA/LA/palette transparency fails before RGB conversion; fully opaque alpha strips with warning; no matte/alpha-output/HDR claim; `docs/planning/U1_2B_ALPHA_FAIL_CLOSED_CONTRACT.md` |
