...
| U1.4 | in progress: validated primitive pass | ACEScg or validated wide-gamut working contract | U1.2 | U1.4A supplies explicit linear Rec.2020 math; file ingress/output, operator compatibility and OCIO/ACES remain open |
...
| U1.4B | contract frozen / implementation ready | BT.2020 SDR 16-bit RGB PNG cICP ingress/egress | U1.4A | exact `09 0F 00 01`, CRC/order, deterministic bytes, uint16/linear roundtrip and fail-closed gates; no renderer/HDR/ACES/arbitrary-profile claim; `docs/planning/U1_4B_REC2020_SDR_PNG_CICP_CONTRACT.md` |
