...
| U6.P3J | active: contract frozen | Stream fixed-halo FFT row cores without a full output allocation | P3H functional + P3I performance pass | 1024x1536 forward/reverse, 257/509-row coverage/repeat and <=2e-6 full-frame parity before 24MP memory benchmark |
