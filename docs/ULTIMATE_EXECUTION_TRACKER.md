...
| U5.R2D2 | ready: freeze sensitivity study | Multiple imperfect canonicalizers and hard operator retrieval | U5.R2D1 | Replace unavailable exact delta with explicit neutralization hypotheses; vary neutral pool/matcher; compare hard retrieval vs regression; unstable result is unidentified |
