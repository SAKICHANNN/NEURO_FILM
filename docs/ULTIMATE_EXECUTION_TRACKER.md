...
| U5.CT5 | in progress; pilot complete | Matched-strength deterministic/classical baselines plus Roll2Film solver on FilmSet internal dev | CT2/CT3/CT4 | 227-identity pilot froze low/moderate/strong strata and per-domain best-basic adversaries; pooled L2 leads ClassNeg, Lab stats Cinema, quantile Velvia, with nonzero gamut risks. Run untouched 238-identity confirmatory next; official 628 remains sealed. Evidence: `docs/ROLL2FILM_CT5_PILOT_RESULTS.md` |
