...
| U5.R2AO5 | ready | Fit the same bounded one-matrix family on all 71 exact Velvia pairs and challenge the full-photo frontier | AO4C pass | exact combined fit, per-domain residuals, then fixed severe/style frontier; no capacity or claim increase |
