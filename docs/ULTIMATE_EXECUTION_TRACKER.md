...
| U5.R2H0C3 | next ready: external source audit | External measured-spectrum replication | U5.R2H0C2 | Freeze T=1 candidate before evaluating an independent rights-eligible spectrum source; source/group/coverage and overlap gates first, no threshold retuning, neural rescue, film or visual claim |
