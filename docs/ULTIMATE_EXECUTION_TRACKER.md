...
| U5.R2AO2 | ready | Fit the retained one-matrix operator on all 24 patches and test its bounded real-photo Look Approximation frontier | AO1 pass | exact operator identity, frozen strengths, existing gold/stress controls and severe veto; development look only, no stock/calibration/product claim |
