...
| U6.P5G | ready: contract frozen | Stress unchanged P5C versus P5C+P5F on the exact 18-image/nine-make P5D cohort | P5F synthetic pass + P5D photographic pass | Exact 257/509-row combined halo, `.006` output bound, flat/isolated/boundary gates, nine fixed overviews and one-to-one worst-difference crops. Pass opens value ablation only; fail closes P5F photographic use |
