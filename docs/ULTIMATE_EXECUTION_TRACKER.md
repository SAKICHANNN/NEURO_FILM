...
| U5.R2H0C1 | next ready: bounded acquisition | CAVE integrity and conditional-support feasibility | U5.R2H0C | Hash/inventory/decode the official 31-band archive, preserve scene groups, then freeze sampling/pair gates before reading witness outputs; no film fitting or RGB-to-spectrum training |
