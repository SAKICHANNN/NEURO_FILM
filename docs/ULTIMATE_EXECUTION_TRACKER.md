...
| U5.R2AO4S | ready | Seek additional independently sourced exact positive-film chart correspondences before increasing operator capacity | AO3 underidentification diagnosis | bounded source reconnaissance first; freeze rights/lineage/pair semantics before payload acquisition; no stock/calibration claim |
...
| U6.P2J | ready | Stress reversal + scanner + endpoint normalization on the fixed 18-image population | P2I pass + P2G baseline | freeze photo gates and visual IDs before render; fail any endpoint escape, no fitting or clipping |
