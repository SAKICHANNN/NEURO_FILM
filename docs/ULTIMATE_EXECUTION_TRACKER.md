...
| U5.R2A | in progress: contract frozen | Versioned numerically constrained operator contract | U1/U2 renderer foundation | Frozen affine + monotone spline + tetrahedral LUT order, exact domain/fail-closed policy, property/golden gates and a smooth blue-to-purple non-safety counterexample; no fitting/integration; `docs/planning/U5_R2A_CONSTRAINED_GLOBAL_OPERATOR_CONTRACT.md` |
