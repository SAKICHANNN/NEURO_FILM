...
| U5.R2E0 | in progress: contract frozen | Clean-room density/sensitometry-domain explicit film-inspired operator primitive | U5.R2D2 | Linear RGB -> negative density/transmission -> print density/reflectance, fixed endpoint normalization and strength; five descriptive witnesses; no external teacher/profile copy or stock claim |
