...
| U5.R2AO4M | ready | Clean-room the FILM2PAINT monotone per-channel curve plus bounded positive-matrix baseline on the frozen 71 Velvia proxy pairs | AO4S1 data close + AO4C/AO9 controls | preregister cross-domain and held-row comparison against the retained one-matrix control; no photo fitting, figure pixels, stock response or calibration |
