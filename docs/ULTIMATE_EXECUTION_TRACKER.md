...
| U5.R2BH1 | ready | Confirm the global colour policy on the BH1S population with fixed B0 and fixed AO6 t15/c35 | BH1S pass | freeze two-arm automatic, repeat-exact and three-round anonymous comparison gates before rendering | no selector, router, dense blend, strength search or production-default claim |
