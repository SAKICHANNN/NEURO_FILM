...
| RF1.4 | ready | Per-stock label/content/nuisance identifiability and leakage-safe holdouts | SF0.3 | shortcut/null gate first; correct stock must beat pooled, wrong-stock, generic historical, retrieval and nuisance controls; post-negation preview and display-proxy domains separate; preview-only evidence cannot promote a colour expert |
