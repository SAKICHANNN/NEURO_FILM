...
| U5.R2AI1 | ready: contract required before any render | Confirm the one frozen R2AI0 composition on an independent digital-photo/OOD population | R2AI0 development pass | freeze new rights/lineage manifest, zero overlap, camera/content/display-state strata, unchanged operator and no threshold retuning; require repeat, clipping/OOD and full-resolution severe evidence before any product consideration |
