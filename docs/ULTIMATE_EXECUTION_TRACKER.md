...
| U1.4 | in progress: math/file-boundary pass | ACEScg or validated wide-gamut working contract | U1.2 | U1.4A supplies explicit linear Rec.2020 math and U1.4B adds isolated BT.2020 SDR PNG I/O; operator compatibility, user-facing integration and OCIO/ACES remain open |
...
| U1.4C1 | contract frozen / implementation ready | Extract working-space-aware D65 Lab colour kernel with legacy parity | U1.4C0 | exact frozen sRGB hashes, Rec.2020 Lab/gamut/styled-witness gates; six colour styles only, no effects/renderer/schema claim; `docs/planning/U1_4C1_WORKING_SPACE_LAB_KERNEL_CONTRACT.md` |
