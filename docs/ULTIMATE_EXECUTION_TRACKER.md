...
| U5.R2AJ0B | ready: frozen bounded acquisition | Acquire, hash, inventory and decode the exact HaldCLUT archive twice | AJ0A limited pass | exact byte/MD5 ceiling, safe ZIP paths/CRC, README, 295 image decodes, 194-member universe and byte-identical evidence; no photograph render or aesthetic inspection; `docs/planning/U5_R2AJ0B_HALDCLUT_ACQUISITION_CONTRACT.md` |
