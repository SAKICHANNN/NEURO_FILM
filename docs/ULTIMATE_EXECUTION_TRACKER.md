...
| U5.R2D1 | ready: freeze synthetic benchmark | CPU known-operator recovery under operator-family and palette-support shift | U5.R2D | Generated bounded truth only; compare descriptor-only, content-only, source+target/difference, best-basic and identity; held-out probes and constraints remain independent |
