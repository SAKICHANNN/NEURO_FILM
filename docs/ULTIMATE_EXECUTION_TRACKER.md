...
| U5.R2AF1 | implementation verified / formal run ready | Test whether the exact AceTone LUT tokenizer introduces folds into analytic orientation-preserving LUTs | AF0 tokenizer-only allowance | isolated hash-pinned runner + manifest evaluator; 6 focused and 1025 full tests pass, including direct CLI import regression. Formal checkpoint metrics remain unread; no Qwen, photos, benchmark, training, repair, film or product claim |
