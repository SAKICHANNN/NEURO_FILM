...
| U5.R2AM1 | ready: corrected v3 contract / runner implementation | Test a bounded SO(3)-conjugated monotone-curve operator against explicit global controls | AM0 prior-only decision | v1/v2 remain immutable; v3 `2ea192df...746c` additionally pins hue offsets, partition slices, confirmation deduplication and aggregate reconstruction after seven operator tests but before any exact AM1 fit. Representation, targets/controls, budgets, optimizer, gates and zero-photo/data boundary are unchanged; `docs/planning/U5_R2AM1_SO3_COORDINATE_CURVE_CAPACITY_CONTRACT.md` |
