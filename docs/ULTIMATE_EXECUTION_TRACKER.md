...
| U5.CT8 | ready for one-shot non-human recipe-bank confirmation | Final 628 transfer plus style/artifact evaluation | CT5–CT7 decisions frozen | Open official 628 once under frozen Lab-Cinema/pooled-L2-ClassNeg/Velvia policy; report recipe fidelity, style and severe visual evidence without population or physical-film claims |
