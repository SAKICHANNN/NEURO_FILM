...
| U5.R2AO6 | ready | Test low-strength bounded composition of the retained combined-film residual with the vivid B0 density path | AO5 direction pass / champion fail | predeclare small residual bank; compare both parents; unchanged severe/style gates; no refit or claim increase |
