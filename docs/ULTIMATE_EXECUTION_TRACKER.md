...
| U5.R2AL1 | ready: corrected v2 synthetic capacity contract / implementation | Compare clean-room analytic chroma-sector curves with global-curve and stationary K3 controls | AL0 prior-only decision | v1 `53fe4134...0559` closed before implementation because execution constants were incomplete; v2 `6adaba33...f00f` hash-binds v1 and freezes exact colour math, restart/control/inverse semantics without changing five-sector/16-curve representation, truths or gates. Zero photograph, film-pixel or external asset access; `docs/planning/U5_R2AL1_ANALYTIC_CHROMA_SECTOR_CURVE_CAPACITY_CONTRACT.md` |
