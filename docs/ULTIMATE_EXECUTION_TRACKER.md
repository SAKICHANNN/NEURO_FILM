...
| U5.R2AH1D | contract frozen / implementation ready | Development-test a small group-invariant reference-only O0-parameter predictor | AH0 feasibility | fixed hierarchical Deep Sets <=150K params, new 64/16 direction split, crossed content/nuisance, 5K deterministic local-GPU steps; must beat identity/global/W1 controls, suppress probes, preserve identity/53-55-56 and all O0 structure; `docs/planning/U5_R2AH1_GROUP_INVARIANT_REFERENCE_OPERATOR_CONTRACT.md` |
