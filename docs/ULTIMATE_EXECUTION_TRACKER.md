...
| U1.6G4E | contract design ready | Simplest staged `density-v1` executor | U1.6G3/G4D | preregister exact legacy/new-operator comparison, percentile/global/local field scheduling, resource accounting, full-resolution visual/severe and failure gates before effect code; no renderer integration |
