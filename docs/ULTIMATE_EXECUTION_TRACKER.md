...
| SF2.0A | ready: contract frozen | Audit 63 deterministic Apollo 7 NASA/JSC HTML pages for SO-368/SO-121 stock-magazine-filter-content metadata connectivity | SF1.3B close + Apollo source/rights reconnaissance | metadata-only decision; no images, fitting, training or LSM; `docs/planning/SF2_0A_APOLLO7_METADATA_FEASIBILITY_CONTRACT.md` |
