...
| U6.P2B | ready | Compile distinct film-transmittance and print-reflectance media with explicit post-scan polarity | P2A pass + U2.2B print primitive | negative/slide polarity separated; non-neutral B&W density rejects; no scanner or calibrated process claim |
