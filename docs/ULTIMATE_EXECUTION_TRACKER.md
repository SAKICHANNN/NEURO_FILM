...
| U5.R2AO0 | ready: bounded real-pixel source gate frozen | Acquire and extract the CC-BY-4.0 Figure 8 Velvia 50/reference ColorChecker pairs | AN0 paired fitter + 2026 controlled-film paper | two exact 291,706-byte CDN downloads; 24 film/reference sRGB display-proxy patches must extract with exact uniform centres and hashes. Pass opens only leave-one-row-out display-proxy explainability |
