...
| U5.R2AF1 | contract frozen / implementation ready | Test whether the exact AceTone LUT tokenizer introduces folds into analytic orientation-preserving LUTs | AF0 tokenizer-only allowance | exact checkpoint + eight analytic safe LUTs + repeat/range/fidelity/Jacobian controls frozen; no Qwen, photos, benchmark, training, decoder repair, film or product claim; `docs/planning/U5_R2AF1_ACETONE_TOKENIZER_TOPOLOGY_CONTRACT.md` |
