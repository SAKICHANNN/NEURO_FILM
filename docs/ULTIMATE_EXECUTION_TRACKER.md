...
| U6.P2C | ready | Run a fixed synthetic route ablation through the independent scanner boundary and post-scan polarity | P2B + P6A generic scanner representation | route order/domain/replay/wrong-order gates; no measured scanner or product integration |
