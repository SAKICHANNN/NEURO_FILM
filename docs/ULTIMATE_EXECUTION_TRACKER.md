...
| RF2.S0 | in progress: contract frozen | Freeze all-roll Gold archive-display matrix and test bounded transplant on existing digital gold/stress images | RF1.4B1 | fixed 1/.75/.5 path; archive-only OOD threshold; anchor-derived style/residual floors; severe veto; `docs/planning/RF2_S0_GOLD_MATRIX_TRANSPLANT_CONTRACT.md` |
