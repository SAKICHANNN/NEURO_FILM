...
| U5.R2AI1 | contract frozen / implementation next | Confirm the one frozen R2AI0 composition on the independent population | R2AI0 + passed R2AI1S | exact 17 rows and three fixed outputs; >=80% development style/non-basic retention, <=125% style envelope, >=.25 median gain over best parent, >=10/17 row and >=6/9 make wins, repeat + three blind rounds + 0/17 severe; no rescue; `docs/planning/U5_R2AI1_DUAL_CHAMPION_INDEPENDENT_CONFIRMATION_CONTRACT.md` |
