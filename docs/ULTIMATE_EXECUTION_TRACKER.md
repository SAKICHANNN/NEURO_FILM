...
| RF1.4B1 | in progress: contract frozen | Gold100 display-proxy paired-transform identifiability | RF1.4B0 | identity/affine/SepLUT plus wrong-roll and roll-cluster gates; visual veto only after metric pass; `docs/planning/RF1_4B1_GOLD_TRANSFORM_CONSISTENCY_CONTRACT.md` |
