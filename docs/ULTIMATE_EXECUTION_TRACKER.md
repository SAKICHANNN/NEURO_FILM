...
| U5.CT7 | blocked on CT6 and MAP gate; CT5 complete | Optional permutation-invariant amortised set inference and complete ablation | MAP known-truth + CT5/CT6 pass | Simplest survivor; no gain from shortcut, kitchen-sink or unsupported spatial branch |
