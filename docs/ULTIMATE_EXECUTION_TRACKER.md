...
| U5.R2F1 | ready: freeze contract/reference manifest | Immutable CanonCGT E2E reference-condition and explicit-LUT safety pilot | U5.R2F0, U5.R2E1 | Freeze reference rights/hashes before inference; no training; references are conditions, never stock truth; test LUT range, clamp, reference sensitivity, style/non-basic value and full severe veto |
