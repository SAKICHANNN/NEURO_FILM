...
| U5.R2AB1 | frozen / ready | Test strict DoRF RGB triplets against shared-curve, power/basic and structural controls | AB0 limited pass | 1,331-colour/65-neutral/2,049-derivative population; candidate and bank gates frozen before metrics. No photographs, source repair, retune or failing-curve rescue; `docs/U5_R2AB1_DORF_RESPONSE_DIVERSITY_CONTRACT.md` |
