...
| P26B | IN_PROGRESS | implement prepared output, strict receipt schema/roundtrip and binding validation | 11 dedicated and 68 combined core tests; finite dense float32, same-profile/shape v1, mutation and swap tests | receipt commit | revert additive receipt commit |
