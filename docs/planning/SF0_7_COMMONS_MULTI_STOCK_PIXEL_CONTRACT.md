# SF0.7 UltraMax400 and Kodachrome64 pixel contract

Merge only the frozen UltraMax400 and Kodachrome64 category rows from the two
hashed SF0.6 snapshots. Select derivative-only, explicit-licence candidates by
the same stable dual author/uploader-capped round robin as SF0.5. The frozen
...
authorize training or authenticity claims.

Machine contract: `configs/real_film_commons_multi_stock_pixel_pilot_v1.json`.
