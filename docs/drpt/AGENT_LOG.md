...
## 2026-08-10 - U6.P8BY exact row sink passes
...
## 2026-08-13 — U5.R2BU10 four-stock source-profile robustness

- Added VISION3 200T to the frozen BU4 MTF+granularity source classifier without changing distance weights, grids, five trace perturbations, four channel subsets or thresholds. The 200T raster is deterministically re-traced from the exact Kodak PDF; all four stocks receive the same plus/minus two source-pixel uncertainty family.
