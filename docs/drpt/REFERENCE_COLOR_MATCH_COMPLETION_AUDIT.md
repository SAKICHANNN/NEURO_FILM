...
- Consumer reviewed payload: `codex/reference-color-match` through P80 at
  `c87d366`; P81 v10 review evidence is committed at `40b4768`.
- Main Neuro-Film latest read-only verification snapshot: `21a877f`; its untracked
...
| Main-integration evidence | Earlier manifests remain immutable; P81 v10 binds P1-P80 `c87d366`, 333 payload blobs, 47 exports, 20 schemas, exact v9 identity and zero overlap against main `21a877f`; P74's CRLF checkout protection remains transitive | COMPLETE AS REVIEW MANIFEST, NOT MERGED | Repository owner verifies v10, reviews and merges / main task or owner |
