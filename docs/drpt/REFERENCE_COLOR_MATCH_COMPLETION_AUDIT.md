...
| High-resolution image lifetime | P151-P153 release obsolete image lifetimes; P154 retains its failed outer-lifetime gate. P156 bounds gamut/output conversion, then P157 bounds RGB-to-Lab ingress and reuses validated Lab. P157's four fresh 6 MP runs preserve output/recipe/report bytes and identity fallback; median peak falls 1,095,663,616→929,300,480 bytes (158.66 MiB, ratio 0.8482) and wall ratio is 0.8605, passing frozen 64 MiB / 0.94 / 1.05 gates. Full reference-match suite: 1343 pass/5 skip | EXACT RENDER + LAB-INGRESS MEMORY PASSES; FULL-FRAME STYLE PHASE REMAINS | Design exact halo-aware or equivalent full-image-context style execution before claiming a lower total peak; never generalize local Windows/Python evidence to main/native/device/RAW/HDR / Neuro-Film |
