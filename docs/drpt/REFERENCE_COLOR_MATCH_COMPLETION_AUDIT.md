...
| High-resolution image lifetime | P151-P153 release obsolete image lifetimes; P154 retains its failed outer-lifetime gate. P156 bounds gamut/output conversion, P157 bounds Lab ingress, and P158 applies the unchanged safe-Lab operator over exact 128-row cores plus a five-row halo. Four fresh 6 MP P158 runs preserve output/recipe/report bytes and identity fallback; median peak falls 999,702,528→533,960,704 bytes (444.17 MiB, ratio 0.5341), wall ratio 0.9389, passing frozen 256 MiB / 0.70 / 1.10 gates. Full reference-match suite: 1348 pass/5 skip | EXACT LOCAL 6 MP COLOUR-KERNEL MEMORY PASSES; LOAD/ENCODE AND TARGET-SCALE EVIDENCE OPEN | Attribute remaining file-path peak and measure larger realistic inputs before any total high-resolution claim; never generalize local Windows/Python evidence to main/native/device/RAW/HDR / Neuro-Film |
