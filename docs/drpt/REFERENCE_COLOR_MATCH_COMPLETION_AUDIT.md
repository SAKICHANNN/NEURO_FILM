...
| High-resolution image lifetime | P151 releases decoded reference/source/rejected-candidate objects and P154 honestly retains its failed outer-lifetime gate. P156 then replaces the three dominant full-frame reference-render stages with exact 128-row kernels. Four fresh 6 MP file runs preserve output/recipe/report bytes and identity fallback; median peak RSS falls from 1,326,962,688 to 1,104,449,536 bytes (212.21 MiB, ratio 0.8323) with wall ratio 0.9948, passing the frozen 128 MiB / 0.88 / 1.10 gates | EXACT ROW-CHUNKED RENDER MEMORY PASS; TOTAL FILE-PATH PEAK STILL 1.10 GB | Attribute and reduce the remaining fit/persistent-array peak under a new frozen leaf; do not generalize this local Windows/Python result to main/native/device/RAW/HDR / Neuro-Film |
