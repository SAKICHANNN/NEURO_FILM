...
DEFAULT_CONTRACT = ROOT / "configs/u6_p4bc_aperture_cell_reference_sampler_v1.json"
DEFAULT_OUTPUT = ROOT / "outputs/experiments/u6_p4bc_aperture_cell_reference_sampler_v1"
