#!/usr/bin/env python3
"""Run the U6.P8CP parallel-output 12MP RGB16 audit."""
...
from src.eval.native_thomas_rgb16_parallel_output_android_scale import evaluate
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p8cp_parallel_output_thomas_rgb16_v1.json",
    )
