#!/usr/bin/env python3
"""Run the U6.P8CQ parallel Thomas 12MP PNG audit."""
...
from src.eval.native_thomas_rgb16_png_parallel_android_scale import evaluate
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p8cq_parallel_thomas_rgb16_png_v1.json",
    )
