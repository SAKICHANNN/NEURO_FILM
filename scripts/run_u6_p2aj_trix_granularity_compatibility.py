"""Run U6.P2AJ TRI-X granularity compatibility."""
...
from src.eval.trix_granularity_compatibility import (
    load_contract,
    run_audit,
    write_report,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p2aj_trix_granularity_compatibility_v1.json",
    )
