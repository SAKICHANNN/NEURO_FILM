...
from src.eval.monotone_fraction_transport_confirmation import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2cb28_monotone_fraction_transport_confirmation_v1.json",
    )
