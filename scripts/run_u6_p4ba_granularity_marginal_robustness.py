...
DEFAULT_CONTRACT = ROOT / "configs/u6_p4ba_granularity_marginal_robustness_v1.json"
DEFAULT_OUTPUT = ROOT / "outputs/experiments/u6_p4ba_granularity_marginal_robustness_v1"
