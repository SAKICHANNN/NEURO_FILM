#!/usr/bin/env python3
"""Run the frozen Gelatin C2PA physical-film source admission."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/sf3_a3o_gelatin_c2pa_film_scan_source_v1.json",
    )
        ...
        json.dumps(
            {
                ...
                "observed_target_stock_ids": report["admission"][
                    "observed_target_stock_ids"
                ],
            },
            sort_keys=True,
        )
