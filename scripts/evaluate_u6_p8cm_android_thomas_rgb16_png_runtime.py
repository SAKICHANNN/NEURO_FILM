#!/usr/bin/env python3
"""Run U6.P8CM Android virtual-device runtime evidence."""
...
from src.eval.native_thomas_rgb16_png_android_runtime import evaluate
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p8cm_android_thomas_rgb16_png_runtime_v1.json",
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "outputs/experiments/u6_p8cm_android_thomas_rgb16_png_runtime_v1",
    )
    ...
    report = evaluate(
        ...
        host_clang=args.host_clang.resolve(),
