#!/usr/bin/env python3
"""Acquire and audit the frozen U5.R2BK6S fresh RAW population."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2bk6s_bounded_opponent_fresh_source_v1.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT
        / "outputs/u5_r2bk6s_bounded_opponent_fresh_source_v1/run_a",
    )
