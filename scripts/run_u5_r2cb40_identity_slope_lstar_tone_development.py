...
from src.eval.identity_slope_lstar_tone_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb40_identity_slope_lstar_tone_development_v1.json",
    )
