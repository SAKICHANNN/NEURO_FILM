...
from src.eval.analytic_y_chromaticity_face_stress import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb56_analytic_y_chromaticity_face_stress_v1.json",
    )
