#!/usr/bin/env python
"""Render and evaluate the frozen recorder-proxy code-reuse frontier."""
...
from src.eval.recorder_proxy_code_reuse_frontier import (  # noqa: E402
    evaluate_bank,
    render_bank,
)


CONFIG_SHA256 = "5cb5f11701eca5a3071b27dba2951db307652af78c664fad3996b62108de7393"
...
def main() -> int:
    ...
    if (
        ...
        raise ValueError("AQ4C config hash mismatch")
