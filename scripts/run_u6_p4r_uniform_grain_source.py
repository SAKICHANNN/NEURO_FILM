#!/usr/bin/env python3
"""Freeze metadata or acquire the exact U6.P4R uniform-grain TIFF source."""
...
from src.eval.real_uniform_grain_source import (  # noqa: E402
    acquire_files,
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u6_p4r_uniform_grain_source_v1.json",
    )
    parser.add_argument(
        "--mode",
