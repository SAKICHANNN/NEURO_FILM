#!/usr/bin/env python3
"""Run the frozen P4CU spatial scanner-glare experiment."""
...
from src.eval.spatial_scanner_glare_correlation import evaluate


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--contract", type=Path, default=ROOT / "configs/u6_p4cu_spatial_scanner_glare_correlation_v1.json")
