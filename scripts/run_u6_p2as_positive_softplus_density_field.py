"""Run U6.P2AS positive softplus density-field audit."""
...
from src.eval.positive_softplus_density_field import (
    load_contract,
    run_audit,
    write_report,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p2as_positive_softplus_density_field_v1.json",
    )
