#!/usr/bin/env python3
"""Run the frozen P4CT scanner-flare correlation experiment."""
...
from src.eval.scanner_flare_layer_correlation import evaluate
from src.eval.scanner_unmixing_layer_correlation import canonical_json


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--contract", type=Path, default=ROOT / "configs/u6_p4ct_scanner_flare_layer_correlation_v1.json")
