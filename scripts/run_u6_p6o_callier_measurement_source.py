#!/usr/bin/env python
"""Acquire and audit the frozen U6.P6O Callier measurement source."""
...
from src.eval.physical_callier_measurement_source import (  # noqa: E402
    acquire_source,
    audit_source,
    load_contract,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u6_p6o_callier_measurement_source_v1.json",
    )
