#!/usr/bin/env python3
"""Run file-backed SF3.A2B through the verified A1 sampling chain."""
...
from src.real_film.three_stock_pooled_global_file_runner import evaluate_files
...
def main() -> int:
    ...
    report = evaluate_files(
        ...
        pooled_contract_path=args.pooled_contract,
