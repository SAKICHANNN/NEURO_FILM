"""Run domain-balanced factorized FilmMatch capacity."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u5_r2ax5_filmmatch_domain_balanced_v1.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
    ...
    if (
        ...
        raise ValueError("AX4 parent identity drift")
