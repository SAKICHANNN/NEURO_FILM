...
from src.eval.constrained_affine_tone_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb44_constrained_affine_tone_development_v1.json",
    )
