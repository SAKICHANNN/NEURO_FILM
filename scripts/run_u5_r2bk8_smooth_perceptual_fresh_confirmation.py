#!/usr/bin/env python3
"""Run the frozen U5.R2BK8 three-arm fresh confirmation."""
...
from src.eval.smooth_perceptual_fresh_confirmation import (  # noqa: E402
    run_confirmation,
)
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2bk8_smooth_perceptual_fresh_confirmation_v1.json",
    )
