"""Build the non-mutating P66 reference-match integration manifest."""
...
SCHEMA_ID = "neuro-film.reference-match-main-integration-manifest.v3"
CLAIM_CEILING = "review-ready-not-merged"
PAYLOAD_SCOPE = "P1-P65"
PRIOR_MANIFEST_PATH = (
    "configs/reference_match_main_integration_manifest_v2.json"
)
PRIOR_MANIFEST_SCHEMA_ID = (
    "neuro-film.reference-match-main-integration-manifest.v2"
)
DEFAULT_SCHEMA_PATH = (
