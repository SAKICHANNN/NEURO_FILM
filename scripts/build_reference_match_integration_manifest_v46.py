"""Build the corrected post-main-merge P173-P175 integration manifest."""
...
if __package__:
    ...
    from build_reference_match_integration_manifest_v45 import (
        V45_REQUIRED_CONTRACT_SCHEMA_PATHS,
        V45_REQUIRED_PUBLIC_EXPORTS,
    )
...
SCHEMA_ID = "neuro-film.reference-match-main-integration-manifest.v46"
CLAIM_CEILING = "review-ready-corrected-post-main-merge-not-merged"
PAYLOAD_SCOPE = "P173-P175-corrected-post-main-merge"
PRIOR_MANIFEST_PATH = "configs/reference_match_main_integration_manifest_v45.json"
PRIOR_MANIFEST_SCHEMA_ID = (
    "neuro-film.reference-match-main-integration-manifest.v45"
)
...
V46_REQUIRED_PUBLIC_EXPORTS = V45_REQUIRED_PUBLIC_EXPORTS
V46_REQUIRED_CONTRACT_SCHEMA_PATHS = V45_REQUIRED_CONTRACT_SCHEMA_PATHS
...
def build_schema(
    *,
    v45_schema_path: Path = V45_SCHEMA_PATH,
) -> dict[str, Any]:
    try:
        result = deepcopy(
            json.loads(v45_schema_path.read_text(encoding="utf-8"))
        )
    except (OSError, json.JSONDecodeError) as exc:
        raise IntegrationManifestError(
            "v45 integration schema unavailable"
        ) from exc
    result["$id"] = (
        "https://neuro-film.local/schemas/"
        "reference-match-main-integration-manifest-v46"
    )
    result["title"] = "Neuro-Film Reference Match Main Integration Manifest V46"
...
def build_manifest(
    *,
    ...
    return build_versioned_manifest(
        ...
        required_public_exports=V46_REQUIRED_PUBLIC_EXPORTS,
        required_contract_schema_paths=V46_REQUIRED_CONTRACT_SCHEMA_PATHS,
