#!/usr/bin/env python
"""Run the frozen U6.P4K exact-area streaming audit."""
...
CONFIG_SHA256 = "8498358206a37a32aebb1df5c877fd25d894063c9c7fe05fd1674fdc745bc8c3"
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u6_p4k_exact_area_streaming_v1.json",
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "outputs/experiments/u6_p4k_exact_area_streaming_v1/report.json",
    )
    ...
    report = evaluate_exact_area_streaming(
        contract, parent, include_stream_scale=True
    )
