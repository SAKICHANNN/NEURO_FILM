#!/usr/bin/env python3
"""Run the frozen P4CX cross-layer Poisson experiment."""
...
from src.eval.cross_layer_compound_poisson import evaluate
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p4cx_cross_layer_compound_poisson_v1.json",
    )
