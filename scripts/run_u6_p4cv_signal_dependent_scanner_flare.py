#!/usr/bin/env python3
"""Run the frozen P4CV signal-dependent scanner-flare experiment."""
...
from src.eval.signal_dependent_scanner_flare import evaluate


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--contract", type=Path, default=ROOT / "configs/u6_p4cv_signal_dependent_scanner_flare_v1.json")
