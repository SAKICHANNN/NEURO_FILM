#!/usr/bin/env python3
"""Adjudicate the frozen BN7 triangular-transport versus AO6 evidence."""
...
from src.eval.fivek_triangular_logit_transport_vs_ao6_adjudication import (  # noqa: E402
    adjudicate_files,
)
...
def main() -> int:
    ...
    payload = adjudicate_files(
        root=ROOT,
        config_path=ROOT
        / "configs/u5_r2bn7_triangular_logit_transport_vs_ao6_v1.json",
