#!/usr/bin/env python3
"""Run the frozen U5.R2G0 constrained explicit-distillation frontier."""
...
from src.eval.constrained_explicit_distillation import (  # noqa: E402
    evaluate_bank,
    render_bank,
)
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=ROOT
        / "configs"
        / "u5_r2g0_constrained_explicit_distillation_v1.json",
    )
