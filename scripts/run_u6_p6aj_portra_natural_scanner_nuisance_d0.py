"""Run P6AJ Portra natural scanner/print nuisance diagnostic."""
...
from src.eval.portra_natural_scanner_nuisance_d0 import (
    evaluate,
    load_contract,
    write_report,
)
...
def main() -> int:
    ...
    parser.add_argument("--config", type=Path, default=ROOT / "configs/u6_p6aj_portra_natural_scanner_nuisance_d0_v1.json")
