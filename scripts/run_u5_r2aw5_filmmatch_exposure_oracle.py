"""Run the frozen FilmMatch controlled-exposure operator Oracle."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u5_r2aw5_filmmatch_exposure_oracle_v1.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
    ...
    if (
        ...
        raise ValueError("AW4 Oracle parent identity drift")
    report = evaluate_exposure_oracle(
        ...
        json.dumps(
            {
                ...
                "exposure_proxy_retrieval_research_opened": report[
                    "exposure_proxy_retrieval_research_opened"
                ],
