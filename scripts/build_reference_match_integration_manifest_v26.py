"""Build the P134 integration manifest."""
...
SCHEMA_ID="neuro-film.reference-match-main-integration-manifest.v26"
CLAIM_CEILING="review-ready-not-merged"
PAYLOAD_SCOPE="P1-P133"
PRIOR_MANIFEST_PATH="configs/reference_match_main_integration_manifest_v25.json"
PRIOR_MANIFEST_SCHEMA_ID="neuro-film.reference-match-main-integration-manifest.v25"
ROOT=Path(__file__).resolve().parents[1]
V25_SCHEMA_PATH=ROOT/"configs/schemas/reference_match_main_integration_manifest_v25.schema.json"
DEFAULT_SCHEMA_PATH=ROOT/"configs/schemas/reference_match_main_integration_manifest_v26.schema.json"
...
def build_schema(*,v25_schema_path:Path=V25_SCHEMA_PATH)->dict[str,Any]:
    try: result=deepcopy(json.loads(v25_schema_path.read_text(encoding="utf-8")))
    except (OSError,json.JSONDecodeError) as exc: raise IntegrationManifestError("v25 integration schema unavailable") from exc
    result["$id"]="https://neuro-film.local/schemas/reference-match-main-integration-manifest-v26"
    result["title"]="Neuro-Film Reference Match Main Integration Manifest V26"
