...
from src.eval.origin_anchored_luminance_linear_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb48_origin_anchored_luminance_linear_development_v1.json",
    )
