#!/usr/bin/env python
"""Run the frozen U6.P3A compiled scatter challenger."""
...
from src.eval.physical_compiled_scatter import (  # noqa: E402
    P1_SCHEMA,
    P3_SCHEMA,
...
def main() -> None:
    ...
    report = evaluate_compiled_scatter(
        load_json(args.parent, P1_SCHEMA), load_json(args.contract, P3_SCHEMA)
    )
