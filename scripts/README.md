...
| `audit_u7_21a_strict_sdr_heic_ingress.py` | Verify the strict single-image 8-bit colour-identified SDR HEIC product subset, rejection controls, render/replay and bounded three-look preview. |
...
| `run_u5_r2s0_palette_score_diffeomorphic_oracle.py` | Test fixed analytic reference-palette score fields through the cube-preserving diffeomorphic operator before any score ML or image research opens. |
