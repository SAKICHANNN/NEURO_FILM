#!/usr/bin/env python3
"""Run the frozen U6.P8AL native AO6 display conformance."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u6_p8al_native_ao6_display_v1.json",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "outputs/u6_p8al_native_ao6_display",
    )
