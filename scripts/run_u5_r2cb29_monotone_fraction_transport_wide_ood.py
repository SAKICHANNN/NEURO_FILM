...
from src.eval.monotone_fraction_transport_wide_ood import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb29_monotone_fraction_transport_wide_ood_v1.json",
    )
