...
from src.eval.monotone_fraction_quantile_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb27_monotone_fraction_quantile_transport_v1.json",
    )
