...
from src.eval.analytic_y_chromaticity_third_confirmation import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2cb74_analytic_y_chromaticity_third_confirmation_v1.json",
    )
