#!/usr/bin/env python
"""Render and evaluate the frozen AO6 B0 plus real-film residual frontier."""
...
CONFIG_SHA256 = "631b6e92377319a8b961fe190d6955add03b1c9f8546c443d9bc2d02778bbe0b"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=(
            ROOT
            / "configs/u5_r2ao6_b0_real_film_residual_frontier_v1.json"
        ),
    )
    ...
    if (
        ...
        raise ValueError("AO6 config hash mismatch")
