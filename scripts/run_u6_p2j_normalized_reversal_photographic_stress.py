#!/usr/bin/env python
"""Run frozen U6.P2J normalized reversal photographic stress."""
...
from src.eval.normalized_reversal_photographic_stress import (  # noqa: E402
    evaluate,
    write_report,
)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u6_p2j_normalized_reversal_photographic_stress_v1.json",
    )
