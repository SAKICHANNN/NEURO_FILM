#!/usr/bin/env python3
"""Run the frozen U5.R2BK3 three-arm fresh comparison."""
...
from src.eval.encoded_log_chroma_fresh_comparison import (  # noqa: E402
    run_comparison,
)
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2bk3_encoded_log_chroma_fresh_comparison_v1.json",
    )
