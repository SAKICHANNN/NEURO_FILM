...
from src.eval.analytic_y_chromaticity_confirmation import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb51_analytic_y_chromaticity_confirmation_v1.json",
    )
