"""Run U6.P2AI B&W characteristic-to-silver evaluation."""
...
from src.eval.bw_characteristic_silver_chain import (
    load_contract,
    run_audit,
    write_report,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p2ai_bw_characteristic_silver_chain_v1.json",
    )
