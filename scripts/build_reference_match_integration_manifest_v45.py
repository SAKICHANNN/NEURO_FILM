"""Build the post-main-merge P173 integration manifest."""
...
if __package__:
    ...
    from build_reference_match_integration_manifest_v44 import (
        V44_REQUIRED_CONTRACT_SCHEMA_PATHS,
        V44_REQUIRED_PUBLIC_EXPORTS,
    )
...
SCHEMA_ID = "neuro-film.reference-match-main-integration-manifest.v45"
CLAIM_CEILING = "review-ready-post-main-merge-not-merged"
PAYLOAD_SCOPE = "P173-post-main-merge"
PRIOR_MANIFEST_PATH = "configs/reference_match_main_integration_manifest_v44.json"
PRIOR_MANIFEST_SCHEMA_ID = (
    "neuro-film.reference-match-main-integration-manifest.v44"
)
...
V45_REQUIRED_PUBLIC_EXPORTS = V44_REQUIRED_PUBLIC_EXPORTS
V45_REQUIRED_CONTRACT_SCHEMA_PATHS = V44_REQUIRED_CONTRACT_SCHEMA_PATHS
...
def build_schema(
    *,
    v44_schema_path: Path = V44_SCHEMA_PATH,
) -> dict[str, Any]:
    try:
        result = deepcopy(
            json.loads(v44_schema_path.read_text(encoding="utf-8"))
        )
    except (OSError, json.JSONDecodeError) as exc:
        raise IntegrationManifestError(
            "v44 integration schema unavailable"
        ) from exc
    result["$id"] = (
        "https://neuro-film.local/schemas/"
        "reference-match-main-integration-manifest-v45"
    )
    result["title"] = "Neuro-Film Reference Match Main Integration Manifest V45"
...
def build_manifest(
    *,
    ...
    return build_versioned_manifest(
        ...
        required_public_exports=V45_REQUIRED_PUBLIC_EXPORTS,
        required_contract_schema_paths=V45_REQUIRED_CONTRACT_SCHEMA_PATHS,
