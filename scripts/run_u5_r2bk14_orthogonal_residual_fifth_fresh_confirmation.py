#!/usr/bin/env python3
"""Run the frozen U5.R2BK14 four-arm fifth-fresh confirmation."""
...
from src.eval.orthogonal_residual_fifth_fresh_confirmation import (  # noqa: E402
    run_confirmation,
)
        ...
        json.dumps(
            {
                ...
                "bk10_population_median_increment_vs_safe_delta_e76": report[
                    "bk10_population_median_increment_vs_safe_delta_e76"
                ],
