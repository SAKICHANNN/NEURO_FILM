"""Run one development-only P4IA photographic probe."""
...
def main() -> int:
    ...
    config = ROOT / "configs/u6_p4ibd_analytical_opponent_development_probe_v1.json"
    ...
    result = evaluate_with_runtime(
        ...
        result_schema="neuro-film.u6-p4ibd-analytical-opponent-development-probe-result.v1",
    )
