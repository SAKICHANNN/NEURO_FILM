#!/usr/bin/env python
"""Run the frozen U6.P6AB 4000-dpi circular-aperture evaluator."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u6_p6ab_circular_scanner_aperture_4000dpi_v1.json",
    )
    parser.add_argument("--report", type=Path, required=True)
    args = parser.parse_args()
    report = evaluate_circular_scanner_aperture_4000dpi(
