#!/usr/bin/env python3
"""Run the frozen P4CS scanner-matrix error-envelope experiment."""
...
from src.eval.scanner_matrix_error_envelope import evaluate
from src.eval.scanner_unmixing_layer_correlation import canonical_json


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--contract", type=Path, default=ROOT / "configs/u6_p4cs_scanner_matrix_error_envelope_v1.json")
