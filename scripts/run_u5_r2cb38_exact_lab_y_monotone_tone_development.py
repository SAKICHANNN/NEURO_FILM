...
from src.eval.exact_lab_y_monotone_tone_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb38_exact_lab_y_monotone_tone_development_v1.json",
    )
