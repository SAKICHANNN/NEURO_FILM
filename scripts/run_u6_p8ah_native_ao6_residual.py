...
from src.eval.physical_native_ao6_residual_conformance import (  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/u6_p8ah_native_ao6_residual_v1.json",
    )
    parser.add_argument(
        "--output-dir",
        default="outputs/u6_p8ah_native_ao6_residual_v1",
    )
