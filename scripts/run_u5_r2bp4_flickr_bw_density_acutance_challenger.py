#!/usr/bin/env python
"""Run the frozen BP4 B&W density-acutance challenger."""
...
from src.eval.flickr_bw_density_acutance_challenger import evaluate, render_contact_sheet
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs/u5_r2bp4_flickr_bw_density_acutance_challenger_v1.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "outputs/u5_r2bp4_flickr_bw_density_acutance_challenger_v1/report.json",
    )
