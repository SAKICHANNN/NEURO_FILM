#!/usr/bin/env python
"""Render and evaluate fixed B0 plus recorder-proxy residual candidates."""
...
from src.eval.recorder_proxy_b0_residual_frontier import (  # noqa: E402
    evaluate_bank,
    render_bank,
)


CONFIG_SHA256 = "f668a3de564c6484bb893036f999812b94e3ebc05492547e51983c5419d7c361"
...
def main() -> int:
    ...
    if (
        ...
        raise ValueError("AQ4G config hash mismatch")
