#!/usr/bin/env python3
"""Run the U6.P8CN 12MP Android virtual-runtime confirmation."""
...
from src.eval.native_thomas_rgb16_png_android_scale import evaluate
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p8cn_android_thomas_rgb16_png_scale_v1.json",
    )
