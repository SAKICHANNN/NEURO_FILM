#!/usr/bin/env python
"""Render and evaluate the frozen AO5F combined Velvia photo frontier."""
...
CONFIG_SHA256 = "bcfdcb5011cf4190353411593babb5bb6bf7b6d2f802de71c72a2b39da975a3f"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=(
            ROOT
            / "configs/u5_r2ao5f_combined_velvia_factorized_frontier_v1.json"
        ),
    )
    ...
    if (
        ...
        raise ValueError("AO5F config hash mismatch")
