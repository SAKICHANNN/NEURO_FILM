...
from src.eval.analytic_y_chromaticity_transport import evaluate, load_contract
...
def main() -> None:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u5_r2cb50_analytic_y_chromaticity_development_v1.json",
    )
