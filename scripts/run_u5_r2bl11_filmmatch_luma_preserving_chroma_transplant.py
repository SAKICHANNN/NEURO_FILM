#!/usr/bin/env python3
"""Run the frozen BL11 luma-preserving chroma transplant."""
...
CONFIG = ROOT / "configs/u5_r2bl11_filmmatch_luma_preserving_chroma_transplant_v1.json"
...
def main() -> int:
    ...
    report = run_luma_preserving_chroma_transplant(
        root=ROOT,
