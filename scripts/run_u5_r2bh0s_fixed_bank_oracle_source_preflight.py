#!/usr/bin/env python3
"""Run the frozen source-only U5.R2BH0S fixed-bank Oracle preflight."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2bh0s_fixed_bank_oracle_source_preflight_v1.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT
        / "outputs/u5_r2bh0s_fixed_bank_oracle_source_preflight_v1",
    )
