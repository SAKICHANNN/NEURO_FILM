#!/usr/bin/env python3
"""Run the frozen U5.R2BK1 three-arm fresh comparison."""
...
from src.eval.log_chroma_fresh_comparison import run_comparison  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "configs/u5_r2bk1_log_chroma_fresh_comparison_v1.json",
    )
