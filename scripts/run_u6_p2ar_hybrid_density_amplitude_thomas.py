"""Run U6.P2AR hybrid density-amplitude Thomas audit."""
...
from src.eval.hybrid_density_amplitude_thomas import (
    load_contract,
    run_audit,
    write_report,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--contract",
        type=Path,
        default=ROOT / "configs/u6_p2ar_hybrid_density_amplitude_thomas_v1.json",
    )
