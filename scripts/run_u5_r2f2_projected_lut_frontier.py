#!/usr/bin/env python3
"""Render and evaluate the frozen U5.R2F2 projected-LUT frontier."""
...
from src.eval.projected_lut_frontier import evaluate_bank, render_bank  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "configs" / "u5_r2f2_projected_lut_frontier_v1.json",
    )
