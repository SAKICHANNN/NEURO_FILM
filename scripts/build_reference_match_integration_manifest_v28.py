"""Build the P139 integration manifest."""
...
SCHEMA_ID="neuro-film.reference-match-main-integration-manifest.v28"
CLAIM_CEILING="review-ready-not-merged"
PAYLOAD_SCOPE="P1-P138"
PRIOR_MANIFEST_PATH="configs/reference_match_main_integration_manifest_v27.json"
PRIOR_MANIFEST_SCHEMA_ID="neuro-film.reference-match-main-integration-manifest.v27"
ROOT=Path(__file__).resolve().parents[1]
V27_SCHEMA_PATH=ROOT/"configs/schemas/reference_match_main_integration_manifest_v27.schema.json"
DEFAULT_SCHEMA_PATH=ROOT/"configs/schemas/reference_match_main_integration_manifest_v28.schema.json"
...
def build_schema(*,v27_schema_path:Path=V27_SCHEMA_PATH)->dict[str,Any]:
    try: result=deepcopy(json.loads(v27_schema_path.read_text(encoding="utf-8")))
    except (OSError,json.JSONDecodeError) as exc: raise IntegrationManifestError("v27 integration schema unavailable") from exc
    result["$id"]="https://neuro-film.local/schemas/reference-match-main-integration-manifest-v28"
    result["title"]="Neuro-Film Reference Match Main Integration Manifest V28"
