...
DECISION = ROOT / "configs/u5_r2cb50_analytic_y_chromaticity_source_decision_v1.json"


def test_cb50_source_role_binds_exact_disjoint_population() -> None:
    ...
    assert payload["exact_decoded_sha_overlap_with_cb49"] == 0
