...
DECISION = ROOT / "configs/u6_p8n_current_phase_rss_decision_v1.json"
REPORT = ROOT / "outputs/u6_p8n_current_phase_rss_v1/run_a/report.json"


def test_p8n_decision_binds_current_production_attribution() -> None:
    ...
    assert decision["dominant_phase"] == "roundtrip-linear"


def test_p8n_opens_only_targeted_roundtrip_linear_work() -> None:
    decision = json.loads(DECISION.read_text(encoding="utf-8"))
    ...
    assert decision["next_leaf"].startswith("U6.P8O")
