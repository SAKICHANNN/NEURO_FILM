...
from scripts.benchmark_u6_p8v_current_phase_rss import validate_contract


ROOT = Path(__file__).resolve().parents[1]
CONTRACT = ROOT / "configs/u6_p8v_current_phase_rss_v1.json"


def test_p8v_contract_requires_current_entry_and_exact_repeats() -> None:
