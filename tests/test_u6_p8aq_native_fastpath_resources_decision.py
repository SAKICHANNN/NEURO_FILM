...
DECISION = (
    ROOT / "configs/u6_p8aq_native_fastpath_resources_decision_v1.json"
)
...
def test_p8aq_decision_preserves_failed_latency_gate() -> None:
    ...
    assert decision["next_leaf"].startswith("U6.P8AR")
