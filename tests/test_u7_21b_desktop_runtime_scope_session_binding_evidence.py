...
EVIDENCE = (
    ROOT / "docs/evidence/U7_21B_DESKTOP_RUNTIME_SCOPE_SESSION_BINDING_RESULT.json"
)
...
def test_evidence_binds_formal_reports_runtime_and_claim() -> None:
    ...
    assert (
        payload["repository_binding"]["runtime_scope"]
        == evidence["observations"]["authoritative_scope"]
    )
