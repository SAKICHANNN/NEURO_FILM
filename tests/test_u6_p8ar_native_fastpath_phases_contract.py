...
from scripts.profile_u6_p8ar_native_fastpath_phases import (
    validate_contract,
)


ROOT = Path(__file__).resolve().parents[1]
CONFIG = ROOT / "configs/u6_p8ar_native_fastpath_phases_v1.json"
...
def test_p8ar_contract_binds_failed_resource_decision() -> None:
