...
EVIDENCE = ROOT / "docs/evidence/U7_21E_DESKTOP_BATCH_AGGREGATE_PUBLICATION_SCOPE_RESULT.json"
...
def test_evidence_binds_reports_runtime_and_claim() -> None:
    ...
    assert evidence["status"] == "PASS_PRIVATE_U7_21E_DESKTOP_BATCH_AGGREGATE_PUBLICATION_SCOPE"
