...
from scripts.build_u6_p4ew_native_cloud_scale_window_portable_v1 import build
...
def test_p4ew_repeat_portable_build(tmp_path: Path) -> None:
    contract = ROOT / "configs/u6_p4ew_native_cloud_scale_window_portable_v1.json"
