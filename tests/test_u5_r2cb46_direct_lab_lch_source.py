...
DECISION = ROOT / "configs/u5_r2cb46_direct_lab_lch_source_decision_v1.json"


def test_cb46_source_role_binds_exact_disjoint_population() -> None:
    ...
    assert payload["exact_decoded_sha_overlap_with_cb45"] == 0
