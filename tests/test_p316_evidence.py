...
EVIDENCE = ROOT / "docs/evidence/P316_R1GN_FUJIFILM_RAF_NO_COPY_INTAKE_RESULT.json"
...
def test_p316_evidence_binds_reports_and_identity_correction() -> None:
    evidence = json.loads(EVIDENCE.read_text(encoding="utf-8"))
    assert evidence["status"] == "PASS_PRIVATE_R1GN_FUJIFILM_RAF_NO_COPY_INTAKE"
    ...
    assert result["identity_correction"]["corrected_commit_resolves"] is True
    assert result["identity_correction"]["superseded_commit_rejects"] is True
