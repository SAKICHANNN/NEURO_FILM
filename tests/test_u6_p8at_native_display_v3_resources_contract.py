...
from scripts.benchmark_u6_p8at_native_display_v3_resources import (
    validate_contract,
)
...
CONFIG = (
    ROOT / "configs/u6_p8at_native_display_v3_resources_v1.json"
)
...
def test_p8at_contract_reuses_frozen_resource_gates() -> None:
    ...
    assert config["execution"]["ao6_display_abi"] == "v3"
