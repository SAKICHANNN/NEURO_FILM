...
DECISION = ROOT / "configs/u6_p8p_current_phase_rss_decision_v1.json"
REPORT = ROOT / "outputs/u6_p8p_current_phase_rss_v1/run_a/report.json"


def test_p8p_decision_binds_current_production_attribution() -> None:
...
def test_p8p_opens_combined_context_and_physical_buffer_work() -> None:
    decision = json.loads(DECISION.read_text(encoding="utf-8"))
    ...
    assert decision["next_leaf"].startswith("U6.P8Q")
