...
from scripts.build_u6_p4eo_native_cloud_row_chain_portable_v1 import build
...
def test_p4eo_repeat_portable_build(tmp_path: Path) -> None:
    contract=ROOT/"configs/u6_p4eo_native_cloud_row_chain_portable_v1.json"
