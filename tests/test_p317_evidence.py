...
EVIDENCE = ROOT / "docs/evidence/P317_R1GO_SIGMA_X3F_NO_COPY_INTAKE_RESULT.json"
...
def test_p317_evidence_binds_reports_and_claim_boundary() -> None:
    evidence = json.loads(EVIDENCE.read_text(encoding="utf-8"))
    assert evidence["status"] == "PASS_PRIVATE_R1GO_SIGMA_X3F_NO_COPY_INTAKE"
