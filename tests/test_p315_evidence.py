...
EVIDENCE = ROOT / "docs/evidence/P315_R1GL_NIKON_NEF_NO_COPY_INTAKE_RESULT.json"
...
def test_p315_evidence_binds_reports_and_preserves_claim_boundary() -> None:
    evidence = json.loads(EVIDENCE.read_text(encoding="utf-8"))
    assert evidence["status"] == "PASS_PRIVATE_R1GL_NIKON_NEF_NO_COPY_INTAKE"
