...
from src.eval.native_cloud_row_chain_android_runtime import evaluate
...
def test_p4ep_android_runtime(tmp_path: Path) -> None:
    result=evaluate(ROOT,ROOT/"configs/u6_p4ep_native_cloud_row_chain_android_runtime_v1.json",NDK,LLVM/"bin/clang.exe",SDK,AVD,tmp_path)
