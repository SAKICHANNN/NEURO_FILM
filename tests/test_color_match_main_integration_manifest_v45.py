...
from scripts.build_reference_match_integration_manifest_v45 import (
    PAYLOAD_SCOPE,
    SCHEMA_ID,
    V45_REQUIRED_CONTRACT_SCHEMA_PATHS,
    V45_REQUIRED_PUBLIC_EXPORTS,
    build_manifest,
    build_schema,
    encode_json,
    validate_manifest,
...
MANIFEST = ROOT / "configs/reference_match_main_integration_manifest_v45.json"
SCHEMA = (
    ROOT
    / "configs/schemas/reference_match_main_integration_manifest_v45.schema.json"
)
PRIOR = ROOT / "configs/reference_match_main_integration_manifest_v44.json"
...
def test_v45_rebuilds_minimal_post_merge_p173_payload() -> None:
    value = frozen()
    ...
    assert "configs/reference_match_main_integration_manifest_v44.json" in paths
...
def test_v45_tamper(mutation) -> None:
