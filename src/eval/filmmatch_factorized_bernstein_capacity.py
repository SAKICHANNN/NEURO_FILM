"""Grouped FilmMatch capacity for monotone-base plus safe-LUT residual."""
...
def _fit(
    ...
    return fit_factorized_monotone_bernstein(
        ...
        seed=int(fit["seed"]),
        residual_degree=int(variant["residual_degree"]),
        residual_identity_ridge=float(variant["residual_identity_ridge"]),
    ...
    *,
    ...
    for variant in config["candidate"]["variants"]:
        ...
        rows[str(variant["id"])] = {
            ...
            "base_development_rgb_rmse": fit.base_development_rgb_rmse,
            "residual_unconstrained_development_rgb_rmse": (
                fit.residual_unconstrained_development_rgb_rmse
            ),
            "safe_residual_strength": fit.operator.residual.strength,
            "minimum_residual_audit_jacobian_determinant": (
                fit.minimum_residual_audit_jacobian_determinant
            ),
        }
...
def evaluate_factorized_bernstein_capacity(
    ...
    report = {
        "schema": "neuro_film.u5_r2ax4_filmmatch_factorized_bernstein.v1",
        ...
        "final_fit": {
            ...
            "base_development_rgb_rmse": final.base_development_rgb_rmse,
...
__all__ = ["evaluate_factorized_bernstein_capacity"]
