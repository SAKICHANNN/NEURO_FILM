"""Output-exact analytic renderer with ordered parallel target construction."""
...
def render_analytic_y_chromaticity_parallel_target_candidate(
    ...
    *,
    ...
    """Render CB69 semantics with ordered parallel AO6 and target row kernels."""
    if (
        ...
        raise AnalyticYChromaticityProfileError("CB70 runtime input drift")
...
__all__ = ["render_analytic_y_chromaticity_parallel_target_candidate"]
