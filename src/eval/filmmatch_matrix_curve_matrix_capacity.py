"""Grouped FilmMatch capacity for a positive matrix-curve-matrix operator."""
...
def _fit(
    ...
    return fit_positive_matrix_curve_matrix(
        source,
        target,
        ...
        input_matrix_identity_mixture=float(
            fit["input_matrix_identity_mixture"]
        ),
        output_matrix_identity_mixture=float(
            fit["output_matrix_identity_mixture"]
        ),
...
def evaluate_matrix_curve_matrix_capacity(
    ...
    report = {
        "schema": "neuro_film.u5_r2ax1_filmmatch_matrix_curve_matrix.v1",
...
__all__ = ["evaluate_matrix_curve_matrix_capacity"]
