"""Exact analytic renderer with bounded shared-slice target workers."""
...
def render_analytic_y_chromaticity_shared_parallel_candidate(
    ...
    *,
    ...
    """Render CB69 semantics with bounded shared target-worker output."""
    if (
        ...
        raise AnalyticYChromaticityProfileError("CB72 runtime input drift")
    ...
    config = runtime.cb52
    target = nonexpansive_fraction_transport_target_shared_parallel(
        safe_base,
        ao6,
        weights=weights,
...
__all__ = ["render_analytic_y_chromaticity_shared_parallel_candidate"]
