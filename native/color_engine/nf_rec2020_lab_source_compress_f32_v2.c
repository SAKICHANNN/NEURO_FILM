#include "nf_rec2020_lab_source_compress_f32_v2.h"
...
static const double NF_D65_WHITE[3] = {0.950469970703125, 1.0, 1.0888299942016602};
...
int nf_rec2020_lab_source_compress_f32_v2(
    const float *source_lab,
    const float *target_lab,
    float *output_lab,
    float *output_rgb,
