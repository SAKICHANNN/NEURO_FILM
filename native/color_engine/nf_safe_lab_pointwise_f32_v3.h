#ifndef NF_SAFE_LAB_POINTWISE_F32_V3_H
#define NF_SAFE_LAB_POINTWISE_F32_V3_H
...
enum {
    NF_SAFE_LAB_V3_OK = 0,
    NF_SAFE_LAB_V3_INVALID_ARGUMENT = 1,
    NF_SAFE_LAB_V3_NONFINITE_INPUT = 2,
    NF_SAFE_LAB_V3_NONFINITE_OUTPUT = 3
};

NF_COLOR_API int nf_safe_lab_pointwise_f32_v3(
