...
/* Keep the frozen v1/v2 display ABI and transfer helpers in this DLL. */
#include "nf_ao6_display_f32_v2.c"

nf_ao6_display_f32_status_v1 nf_ao6_display_f32_apply_v3(
