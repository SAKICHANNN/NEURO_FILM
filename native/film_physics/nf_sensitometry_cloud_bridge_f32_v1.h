#ifndef NF_SENSITOMETRY_CLOUD_BRIDGE_F32_V1_H
#define NF_SENSITOMETRY_CLOUD_BRIDGE_F32_V1_H

#include "nf_conditioned_cloud_row_chain_f32_v2.h"
#include "nf_physical_domains_f32_v1.h"

#if defined(_WIN32)
# if defined(NF_SENSITOMETRY_CLOUD_BRIDGE_F32_BUILD)
#  define NF_SENSITOMETRY_CLOUD_BRIDGE_F32_API __declspec(dllexport)
# else
#  define NF_SENSITOMETRY_CLOUD_BRIDGE_F32_API __declspec(dllimport)
# endif
#else
# define NF_SENSITOMETRY_CLOUD_BRIDGE_F32_API
#endif

#define NF_SENSITOMETRY_CLOUD_BRIDGE_F32_ABI_VERSION_V1 1u

NF_SENSITOMETRY_CLOUD_BRIDGE_F32_API uint32_t
nf_sensitometry_cloud_bridge_f32_abi_version_v1(void);

NF_SENSITOMETRY_CLOUD_BRIDGE_F32_API int
nf_sensitometry_cloud_bridge_f32_apply_window_v1(
