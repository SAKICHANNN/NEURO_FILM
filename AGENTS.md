...
| Latest algorithm evidence | 813 local tests pass. U5.R2E1 retains the cyan-shadow/warm-highlight density challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). U2.2/U2.3A provide clean-room sensitometry-print and exact identity residual representations. I0 finds the ungauged U2.2B path strong but uniformly green and 0/3 against safe-rich. I1 numerically removes that neutral cast, but I1B then has no real-image survivor: even s1.0 reaches only style 5.66/non-basic .72. The exact clean-room sensitometry/gauge route closes without rescue. No named-stock, preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
