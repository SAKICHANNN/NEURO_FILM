...
| Latest algorithm evidence | 878 local tests pass. U6.2A adds a clean-room deterministic Boolean/Poisson grain representation based only on published IPOL equations: maximum flat mean error .0133, midtone variance ratios 2.15/2.25, large-minus-small lag-1 correlation .1416, and exact repeat/serialization/row-partition replay. The GPL reference code was not copied. This opens only a fixed-policy existing-image crop visual frontier; no measured NPS, stock/process/scanner calibration or integration. U5.R2M0 remains closed: positive-warm RMSE .01170 passes but density-cyan .03089 and identity max error 5.97e-5 fail. The retained B0 global colour challenger remains U5.R2E1 density-cyan s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). Film fitting, training and LSM remain closed. |
