...
| Latest algorithm evidence | 1149 full CPU tests pass. AO4C upgrades the real-film operator evidence beyond chart self-consistency: chart-fit Velvia one-matrix transfers to 47 independent stable pigment pairs at `.03812` RMSE, 62.16%/40.53% below identity/full-affine, while pigment-fit transfers back to the 24 chart patches at `.05874`, 63.79%/47.20% below controls; both remain in-cube and two reports are exact. A content-confounded wrong-stock diagnostic is directionally supportive but cannot establish stock specificity. AO3 remains severe-clean but loses 0/3 to the vivid B0 comparator. All evidence is author-rendered display proxy from one paper, not RAW, same-time pairs, independent process/scanner confirmation, transferable stock response or calibrated/product evidence. |
