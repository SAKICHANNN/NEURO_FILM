...
| Latest algorithm evidence | 818 local tests pass. U5.R2J0 retains a clean-room two-matrix/three-sigmoid positive-film response representation: all five original witnesses are bounded, replay/partition exact, orientation-preserving, pairwise distinct and strongly non-affine. J1 must determine real-image value/safety before any challenger exists. U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). I1B and the exact sensitometry/gauge rescue remain closed. No named-stock, preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
| Latest source evidence | SF2.7R acquires an exact 71,068,957-byte internal nuisance lane: five source grids, measured Set 3 IT8/CGATS references and four complete scanner/software pipelines observing the same five physical Velvia 100F slides, with zero CRC/decode/duplicate failures. This opens scanner-nuisance quantification only; recorder-space sources are not digital scene-linear pairs, one target set is not independent rolls, rights do not permit redistribution, and no stock fitting/training/LSM opens. |
