...
| Latest algorithm evidence | 1086 local tests pass. U5.R2AI1 still closes the independent promotion of the R2AI0 composition: style/non-basic remains `13.1756/12.6753`, but style gain is `-.5261`, wins are `7/17` and maximum style `32.2442` exceeds the frozen envelope. No rescue opens. U5.R2AJ0B v1 remains closed on its false all-RGB assumption and AJ0B2 passes exact lane-aware integrity. AJ0C0 v1 remains preserved as a pre-execution contract failure. Corrected AJ0C0B passes its two-process, independently reconstructed controls-only conformance at commit `d8fdcb1`: legal Hald parser/interpolation, analytic Jacobian, RGB16 TIFF, all exact positive/negative/basic/strength/novelty controls and the zero-access ledger pass. AJ0C1 is now frozen before primary access: it must attempt the exact 194-member RGB8 universe, retain individual vetoes, collapse exact/strength components, choose the strongest safe representative and apply a deterministic residual max-min cap-12 frontier. No external CLUT has yet been measured, applied to a photograph or inspected aesthetically. The production default, stock/calibration claims, current-pixel fitting/training and LSM remain unchanged. |
| Latest source evidence | 1071 local tests pass. U5.R2AI1S's final 17 RAW rows are consumed development evidence. The licensed RawTherapee archive is retained at exactly 421,602,289 bytes, published MD5 `4742e362...85e1` and SHA-256 `0ffca81f...9dc2`. AJ0B2 reproduces 295 decode records, 194 unchanged primary paths and byte-identical manifest/report evidence twice: 226 Color RGB8 level-12, one exact Ektar RGB8 level-16, 66 B&W L8, and two RGB16 root controls, all without ICC. The RGB16 controls remain integrity-only; future identity must be analytic. Preset names remain informational Look Approximation labels, not real-film or stock truth. |
...
| Ready/implementation | U5.R2AJ0C1 | Execute the frozen 194-member native-grid structural frontier twice; no photograph/aesthetic review, smoothing, threshold rescue or filename feature |
