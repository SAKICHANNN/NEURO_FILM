...
| Latest algorithm evidence | 1123 full-suite tests plus 17 focused AO1/AO0/AN1/AN0/J0 tests pass. AO0 exactly extracts 24 paired author-rendered sRGB ColorChecker values from a CC-BY-4.0 real Velvia 50 figure. AO1's six leave-one-chart-row-out folds select the simpler one-matrix positive-film response: mean RGB RMSE `.04404`, 72.51% lower than identity and 46.62% lower than full affine; the two-matrix model is slightly worse at `.04497`. This is one small development display proxy, not RAW, independent confirmation, a transferable stock response or calibrated/product evidence. |
