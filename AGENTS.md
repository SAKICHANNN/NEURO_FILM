...
| Latest algorithm evidence | U5.R2BE0 registers the fit-forbidden FilmMatch same-scene validation pair (706/779 inliers, 0.519px median error) and finds descriptive explicit-case Oracle value: positive-regime and EV+2 operators improve registered RMSE 11.15%/10.09% over global with zero new boundaries. The frozen combined bank still closes because zero-regime=EV0 exactly and EV-5/EV-4 collapse to `3.20e-10` output RMSE. No target-blind retrieval, stock/calibration claim or promotion opens. |
