...
| Latest algorithm evidence | 882 local tests pass. U6.2B closes both fixed Boolean-grain crop policies under the severe veto: aggregate automatic gates pass, but the small `.22/.12` policy has 4/5 severe visual failures and the large `.38/.12` policy has 5/5 because sparse bright salt-like points contaminate saturated red, sky, skin and fine detail. Legacy `.018` remains 0/5 severe as a comparator. U6.2A stays synthetic representation evidence only; no strength/radius/sample-count rescue or integration opens. U5.R2M0 remains closed. The retained B0 global colour challenger remains U5.R2E1 density-cyan s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). Film fitting, training and LSM remain closed. |
