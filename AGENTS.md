...
| Latest algorithm evidence | 1149 full CPU tests pass before the latest AO5 additions. AO5's same-capacity one-matrix fit on 71 exact Velvia chart+stable-pigment pairs reaches `.02941` combined RMSE, 76.47%/40.51% below identity/full-affine and in-cube. Its fixed factorized photo survivor reaches style/non-basic `8.47/5.02`, zero new gold/stress clipping and 0/9 severe. Three distinct blind layouts rank it above the chart-only proxy 3/3, confirming a less cool/grey direction, but below the vivid B0 comparator 0/3. Retain it as the strongest real-film display-proxy algorithm evidence, not the aesthetic champion. The red midpoint remains bound and all data share one paper/rendering pipeline; no RAW, same-time, independent process/scanner, stock-response, calibration or product claim opens. |
