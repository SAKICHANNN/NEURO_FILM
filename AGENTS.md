...
| Latest algorithm evidence | 831 local tests pass. U5.R2J1 finds seven automatic positive-film survivors and 27/27 shortlisted gold renders are severe-clean, including ID11, but all three blind rounds choose the retained R2E1 density challenger first and safe-rich second; no J1 candidate enters the top two. J0 remains a valid clean-room representation/negative control, while U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
