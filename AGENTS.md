...
| Latest algorithm evidence | 853 local tests pass. U5.R2K3 introduces an analytic gamut-polar palette factorization with exact RGB-cube boundary, neutral axis, endpoints, inverse, replay and positive orientation. Five fixed witnesses are strongly non-affine (residual .0521--.0741; minimum pairwise RMSE .0450), but cyan-shadow/warm-highlight reaches Jacobian norm 11.198 above the frozen 8 while other looks remain 6.13--7.70. The whole bank closes before real-image rendering and cannot be retuned; it proves visible palette capacity can coexist with structural gamut safety while local derivative control remains an independent severe-risk gate. U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
