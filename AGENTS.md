...
| Latest algorithm evidence | 868 local tests pass. U5.R2L1 regenerates both immutable density-cyan s0.50/s0.65 banks RGB8-exactly on all 41 images, but the frozen full-frame preflight matches only 40/41 sampled-Oracle assignments. Stress 20 moves from sampled clipping .49247% to full-frame .50015%, just above the .5% gate, so exact hard-policy replay closes without threshold/epsilon/sampling rescue. U5.R2L0 remains only a post-output Oracle feasibility result: s0.65 was selected 36/41 with mean/median style gains 3.07/3.56 and 41/41 reviewed outputs severe-clean, but no deployable strength router exists. The explicit preflight primitive remains isolated research infrastructure. U5.R2K3 remains closed on its 11.198 Jacobian-norm failure. No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
