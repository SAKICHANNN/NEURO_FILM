...
| Latest algorithm evidence | 849 local tests pass. U5.R2K2 independently implements finite monotonic rational-quadratic spline coupling: exact range/identity/replay/partition, analytic inverse and positive orientation pass. It materially advances beyond K1: density-cyan s0.50 reaches .01435 confirmation RMSE and 79.55% gain over affine, but maximum Jacobian norm 9.457 exceeds 8; positive-warm s0.35 fits at .00067 yet confirms at .01965 above the .015 gate. The fixed candidate closes without bin/stage/optimizer rescue or real-image rendering. U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
