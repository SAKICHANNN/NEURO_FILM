...
| Latest algorithm evidence | 837 local tests pass. U5.R2K0 independently audits the May-2026 GLUT idea and closes its safety-adapted fixed-Gaussian residual candidate: 27 primitives fit the two frozen nonlinear controls at RGB RMSE .00990/.00344 and improve 85.98%/87.65% over global affine, but density/positive targets reach minimum Jacobian determinants -3.31/-1.87, negative diagonal derivatives, and one coefficient 7.09 above the frozen 4.0 limit. Analytic range, replay and identity pass do not override colour-space folding; no clamp, capacity or neural rescue opens. U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
| Latest source evidence | SF2.7A quantifies the exact ColorReference nuisance lane. Across four scanner/software pipelines and five same physical slides, raw held-out device-RGB median distance is .06055; bounded 3x3+bias reduces it 76.11% to .01446. The universal material-nuisance gate fails because two LS50/NikonScan devices are only .01464 apart, while VueScan-vs-LS9000 reaches .09865. Scanner clusters are therefore neither uniformly large nor film modes; raw and canonicalized controls are required. No stock fitting/training/LSM opens. |
