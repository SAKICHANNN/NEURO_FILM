...
| Latest algorithm evidence | 861 local tests pass. U5.R2L0 proves a material B0 per-image strength Oracle gap for the retained U5.R2E1 density-cyan Look Approximation: immutable s0.65 is clipping-eligible on 36/41 images, with mean/median style gains 3.07/3.56 Delta E76 over fixed s0.50 and worst selected clipping 0.4925%. All 41 selected full-resolution outputs, five 1:1 crops each, ID11 and the face regression are severe-clean; inherited noise on 14/15 and mild gradient/JPEG layering on 37 are amplified but not new severe artifacts. This opens only a simplest inference-time hard-policy contract: the Oracle is post-output, clipping is not a universal safety detector, and no deployable router or general-safety claim exists. U5.R2K3 remains closed on its 11.198 Jacobian-norm failure. No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
