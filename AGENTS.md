...
| Latest algorithm evidence | 808 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure. H0C3 closes the broad cross-source hard-spectrum prior. CT1C validates analytic L0/gauge/shaper but fixed HDR 33/65 bake parity fails. U2.2 provides a clean-room exposure-to-density-to-print representation and U2.3A adds exact identity tetrahedral composition while rejecting one insufficiently smooth nontrivial residual. U5.R2I0 proves the ungauged U2.2B path is strong and non-basic (full strength style 19.28/residual 14.40) and severe-clean on 18 full-resolution gold renders, but a uniform green cast loses all three blind rounds to safe-rich; no challenger is retained. A separately frozen data-independent neutral-axis gauge is the next hypothesis. No named-stock, preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
