...
| Latest algorithm evidence | 845 local tests pass. U5.R2K0 shows that compact fixed-Gaussian residuals fit frozen nonlinear controls accurately but fold colour space. U5.R2K1 then makes boundedness, positive orientation and analytic inversion structural with 12 triangular coupling stages: min det(J) .168/.359 and inverse errors below 5.6e-16 pass, but confirmation RMSE .0623/.0282 misses the .015 gate, gains are only 11.17%/-2.34% vs global affine, and exact partition parity misses by 1.11e-16. K1 closes without capacity/optimizer rescue. U5.R2E1 remains the strongest retained B0 challenger at s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
