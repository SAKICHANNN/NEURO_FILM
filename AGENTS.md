...
| Latest algorithm evidence | 798 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure in 27 full-resolution renders. H0C3 closes the broad cross-source hard-spectrum prior at only 6.52% external wins. CT1C validates analytic L0 exposure/WB, roll-gauge and log1p HDR shaper primitives near machine precision, but fixed `[0,16]` shaped 33/65 cubes miss frozen max-error gates at .0351/.00899. U2.2A now adds an explicit uncalibrated linear-exposure-to-layer-density sensitometry primitive: 3.73e-14 roundtrip error, exact neutral anchor, positive Jacobian and distinct three-layer toe/mid/shoulder curves. Layer density is not display RGB; composition/interpretation, stock fitting and integration remain open/closed respectively. RGB spectral recovery, Velvia response, film fitting, visual/product value, training and LSM remain unproved/closed. |
