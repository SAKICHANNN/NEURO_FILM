...
| P0 named-stock | SF0.2/RF1.4 | Download/hash-verify the frozen 189-file four-stock manifest, then freeze per-stock label/content/nuisance gates; no colour fit yet |
