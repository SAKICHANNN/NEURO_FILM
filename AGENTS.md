...
| Latest source evidence | 999 local tests pass. U5.R2AB0 retains the exact official CAVE DoRF archive only as an internal-research historical response prior: 201 monotone normalized records with 1,024 actual samples and 46 strict source-name RGB triplets. The official page says 1,000 points, duplicate names/spellings remain, and no explicit licence was located. It opens only a preregistered synthetic response-diversity/safety pilot; no image fitting, training, stock/calibration or product claim. U5.R2AA0 separately verifies Kodak 250D/2383 graph families but AA1 closes their chain as nuisance-unidentified. SF2.9R retains five ColorReference archives only as physical nuisance evidence; SF2.10R remains a metadata lead with pixel DoR failed. |
