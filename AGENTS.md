...
| Latest algorithm evidence | 873 local tests pass. U5.R2M0 adds a six-stage/108-coefficient bounded interval-Möbius coupling: bounds, positive orientation, analytic inverse, exact partition and local-gain gates pass (maximum Jacobian norm 2.842); positive-warm confirmation RMSE .01170 passes. Density-cyan RMSE .03089 misses the frozen .015 ceiling and fitted identity max error 5.97e-5 misses exactness, so the branch closes without capacity, optimizer, identity-special-case or visual rescue. U5.R2L1 remains closed at 40/41 exact hard-policy replay; U5.R2L0 remains post-output Oracle feasibility only. The retained B0 global challenger remains U5.R2E1 density-cyan s0.50 (style 13.49, non-basic 7.39, zero new clipping, severe-clean). No named-stock, owner/population preference, calibration or production evidence opens; film fitting, training and LSM remain closed. |
