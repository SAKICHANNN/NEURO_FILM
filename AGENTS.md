...
| Latest algorithm evidence | 803 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure. H0C3 closes the broad cross-source hard-spectrum prior. CT1C validates analytic L0/gauge/shaper but fixed HDR 33/65 bake parity fails. U2.2 provides a clean-room exposure-to-density-to-print representation: U2.2A roundtrip is 3.73e-14; U2.2B stays in `[0,1]`, has minimum Jacobian .0470, identity RMSE .1596 and affine residual .1015. U2.3A preserves this base exactly through an identity tetrahedral LUT, but rejects its frozen cyclic nontrivial residual because first/second smoothness differences exceed the preregistered gates. The generic fail-closed wrapper remains; no nontrivial U2.3 residual, named-stock, visual-safety, preference, calibration or production evidence opens. Film fitting, training and LSM remain closed. |
