...
| Latest algorithm evidence | 743 local tests pass. U5.R2B retains `anchor56_chroma_margin4_challenger` as one B0 fixed global Look Approximation challenger; U5.R2C actual B1 remains human/data gated. U5.R2D-D2 close direct unpaired statistics-to-LUT recovery: exact canonical deltas contain information, but zero of four practical canonicalizers pass, their median rendered disagreement is 0.1567 versus the 0.03 gate, and hard Top-1/Top-3 retrieval has no value on a qualified lane. Raw “similar photo” retrieval is therefore unidentified, not a larger-model opportunity. U5.R2E0 may build an original data-independent density/sensitometry-domain explicit Look Approximation primitive; real-film fitting, training and LSM remain closed. |
