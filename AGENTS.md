...
| Ready/frozen | U1.6D | Reproduce current procedural dust/scratch through a compact exact event context and zero-halo tiles; byte parity required, no CLI/default/grain/100MP claim |
