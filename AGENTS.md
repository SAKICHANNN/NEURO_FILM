...
| Latest algorithm evidence | 1562 local CPU tests pass after the clean-worktree rerun. U5.R2AP0 establishes one independent, repeat-exact Ektachrome author-rendered display-proxy direction, and AP2 retains an analytical no-clipping residual executor. The fixed AP3 B0+t10/c25 composition then passes AP4 automatic and severe gates on a fresh 16-image/nine-make CC0 population: style/non-basic/residual `12.0378/11.8382/2.2024`, 16/16 images and 9/9 makes material, zero new clipping and 0/16 confirmed full-resolution severe failures. Fixed vivid B0 nevertheless wins all three frozen autonomous blind rounds, so the Ektachrome photo challenger closes without retuning or added capacity. AP0/AP2 remain research primitives only; production, stock, calibration and independent-preference promotion remain closed. |
