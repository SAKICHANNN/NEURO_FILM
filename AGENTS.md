...
| Latest algorithm evidence | 1123 full-suite tests plus 17 focused AO1/AO0/AN1/AN0/J0 tests pass. AO1's real Velvia chart proxy selects the simpler one-matrix response at `.04404` held-row RMSE, 72.51%/46.62% below identity/full affine. AO2 then closes a single-strength photo transfer: s0.50 is clipping-clean but non-basic residual is only 3.09; s0.75 reaches style/non-basic `13.24/5.35` but creates 1.336% new gold clipping. This motivates a separately frozen tone/chroma-factorized boundary guard; no gate is relaxed. All evidence is one small development display proxy, not RAW, independent confirmation, transferable stock response or calibrated/product evidence. |
