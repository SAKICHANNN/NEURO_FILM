...
| Latest algorithm evidence | 800 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure. H0C3 closes the broad cross-source hard-spectrum prior. CT1C validates analytic L0/gauge/shaper but fixed HDR 33/65 bake parity fails. U2.2 now has a complete clean-room numerical exposure-to-density-to-print representation: U2.2A roundtrip is 3.73e-14 with exact neutral anchor; U2.2B runs sensitometry exactly once, stays in `[0,1]`, has minimum Jacobian .0470, identity RMSE .1596 and affine residual .1015. This is a strong explicit nonlinear algorithm witness, not named-stock, visual-safety, preference, calibration or production evidence. U2.3 residual evaluation opens; film fitting, training and LSM remain closed. |
