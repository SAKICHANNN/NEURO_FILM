...
| Latest algorithm evidence | 786 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure in 27 full-resolution renders. U5.R2F1-G1 show external ML conditioning can be strongly reference-sensitive and constrained distillation preserves style, but every frozen safety route yields zero automatic survivor. U5.R2H1 finds A0 source-content routing signal, but H2 closes the exact hard 1-NN at 6/10 routed wins. H0A remains theoretically unidentified under arbitrary D65 metamers; H0C1 shows the CAVE measured-material conditional population is much narrower. H0C2 now retains cross-scene hard Top-1 measured-spectrum retrieval at DE<=1 with smooth OOD fallback: 36.13% coverage, 76.60% selected wins, hard error 0.339/2.975 vs smooth 0.894/3.939 median/p95, and group-bootstrap gates pass. Wider thresholds fail stability. This is synthetic-witness mechanism evidence only; external spectrum replication, RGB spectral recovery, Velvia response, film fitting, visual/product value, training and LSM remain unproved/closed. |
| Latest source evidence | SF2.5R finds a promising institutional linkage between 6,716 digital PROV VPRS 17684 negatives and VPRS 17690, described as tracking film stock, but 30/30 register catalogue items are physical-only with zero digital/IIIF fields. No pixels were requested; the source is closed until an official transcription/digitisation/export or separately approved physical workflow exists. |
