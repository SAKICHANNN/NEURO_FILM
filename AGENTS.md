...
| Latest algorithm evidence | 811 local tests pass. U5.R2E1 retains one cyan-shadow/warm-highlight density challenger at strength 0.50 with style 13.49, non-basic residual 7.39, zero new clipping and no confirmed severe failure. U2.2/U2.3A provide the clean-room sensitometry-print and exact identity residual representation. U5.R2I0 finds its ungauged path strong/non-basic and severe-clean but uniformly green and 0/3 against safe-rich. U5.R2I1 now numerically passes a data-independent inverse-neutral gauge: neutral spread falls from .1630 to 6.41e-6, min Jacobian is .0148 and affine residual remains .0549. Real-image visual validation opens separately; no named-stock, preference, calibration or production evidence opens, and film fitting, training and LSM remain closed. |
